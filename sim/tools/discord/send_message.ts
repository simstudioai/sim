...
export const discordSendMessageTool: ToolConfig<DiscordSendMessageParams, DiscordSendMessageResponse> = {
    ...
    body: (params) => {
      ...
      if (params.embed) {
        body.embeds = [{
          ...
          color: params.embed.color ? parseInt(params.embed.color.replace('#', ''), 16) : undefined,
        }]
      }
