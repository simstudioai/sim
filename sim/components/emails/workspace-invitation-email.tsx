  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join the "{workspaceName}" workspace on SimStudio!</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              {inviterName} has invited you to join the "{workspaceName}" workspace on SimStudio!
            </Text>
            <Text style={baseStyles.paragraph}>
              SimStudio is a powerful platform for building, testing, and optimizing AI workflows.
