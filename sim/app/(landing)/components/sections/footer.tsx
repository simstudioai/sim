          ...
          <div className='md:flex-row flex-col flex gap-8 md:gap-16'>
            ...
            >
              ...
              <div className='flex gap-4'>
                <Link href={"https://github.com/simstudioai/sim"} target='_blank' className='flex md:hidden text-2xl transition-all duration-500'>
                ...
                <Link href={"https://x.com/simstudioai"} target='_blank' className='text-2xl transition-all duration-500'>
