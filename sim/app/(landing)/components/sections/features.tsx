...
const features: FeaturesArray = [
  {
    ...
    nodes: [
      { id: 'agent1', type: 'heroBlock', position: { x: 75, y: 100 }, data: { type: 'agent' }, sourcePosition: Position.Right, targetPosition: Position.Left },
      { id: 'slack1', type: 'heroBlock', position: { x: 500, y: -50 }, data: { type: 'slack' }, sourcePosition: Position.Left, targetPosition: Position.Right },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'start', type: 'heroBlock', position: { x: 75, y: 150 }, data: { type: 'start' }, sourcePosition: Position.Right, targetPosition: Position.Left },
      { id: 'function1', type: 'heroBlock', position: { x: 500, y: -20 }, data: { type: 'function' }, sourcePosition: Position.Right, targetPosition: Position.Left },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'function1', type: 'heroBlock', position: { x: 75, y: 125 }, data: { type: 'function' }, sourcePosition: Position.Right, targetPosition: Position.Left },
      { id: 'agent1', type: 'heroBlock', position: { x: 500, y: -50 }, data: { type: 'agent' }, sourcePosition: Position.Right, targetPosition: Position.Left },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'router1', type: 'heroBlock', position: { x: 75, y: 100 }, data: { type: 'router' }, sourcePosition: Position.Right, targetPosition: Position.Left },
      { id: 'agent1', type: 'heroBlock', position: { x: 500, y: -20 }, data: { type: 'agent' }, sourcePosition: Position.Right, targetPosition: Position.Left },
    ],
    edges: [
      { id: 'router1-agent1', source: 'router1', target: 'agent1', type: 'smoothstep', style: { stroke: '#404040', strokeWidth: 1.5, strokeDasharray: '4 4' }, animated: true },
    ]
  }
]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
        Unlock the full potential of your agents with intuitive features designed to simplify development and maximize impact.
        </motion.p>
      </motion.div>
                          ...
                          {f.feature.bullets.length > 0 && (
                            <ul className="flex flex-col gap-5 mt-2">
                              {f.feature.bullets.map((b, j) => (
                                ...
                                >
                                  <span className={`w-2 h-2 ${bulletColors[i]} inline-block mt-2 mr-2`} />
                                  <span className='text-base leading-[1.4] text-white/70 font-light'>{b}</span>
                                </li>
                              ))}
                            </ul>
                          )}
