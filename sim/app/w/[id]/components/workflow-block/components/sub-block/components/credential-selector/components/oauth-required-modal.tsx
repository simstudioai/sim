...
const SCOPE_DESCRIPTIONS: Record<string, string> = {
  ...
  'crm.objects.contacts.write': 'Create and update your contacts',
  'crm.objects.deals.read': 'Read your deals',
  'crm.objects.deals.write': 'Create and update your deals',
  'marketing.campaigns.read': 'Read your marketing campaigns',
  'marketing.forms.read': 'Read your marketing forms',
  'marketing-emails.read': 'Read your marketing emails',
