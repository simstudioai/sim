...
export { ChartFileIcon } from './chart-file-icon'
...
export { DefaultFileIcon } from './default-file-icon'
export { DocumentAttachment } from './document-attachment'
export { DocxIcon } from './docx-icon'
...
export { PptxIcon } from './pptx-icon'
...
export { X } from './x'
export { XlsxIcon } from './xlsx-icon'
export { Zap } from './zap'
