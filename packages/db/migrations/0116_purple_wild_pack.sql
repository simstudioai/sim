...
CREATE INDEX "superagent_chats_updated_at_idx" ON "superagent_chats" USING btree ("updated_at");--> statement-breakpoint
...
ALTER TABLE "settings" DROP COLUMN "show_floating_controls";