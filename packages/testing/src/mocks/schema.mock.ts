...
export const schemaMock = {
  ...
  knowledgeConnectorGoogleUser: {
    connectorId: 'knowledgeConnectorGoogleUser.connectorId',
    userId: 'knowledgeConnectorGoogleUser.userId',
    generationId: 'knowledgeConnectorGoogleUser.generationId',
    email: 'knowledgeConnectorGoogleUser.email',
    customerId: 'knowledgeConnectorGoogleUser.customerId',
    cursor: 'knowledgeConnectorGoogleUser.cursor',
    status: 'knowledgeConnectorGoogleUser.status',
    attempts: 'knowledgeConnectorGoogleUser.attempts',
    retryAt: 'knowledgeConnectorGoogleUser.retryAt',
    lastServedAt: 'knowledgeConnectorGoogleUser.lastServedAt',
    failure: 'knowledgeConnectorGoogleUser.failure',
    permissionCursor: 'knowledgeConnectorGoogleUser.permissionCursor',
    permissionAttempts: 'knowledgeConnectorGoogleUser.permissionAttempts',
    permissionRetryAt: 'knowledgeConnectorGoogleUser.permissionRetryAt',
    permissionLastServedAt: 'knowledgeConnectorGoogleUser.permissionLastServedAt',
    permissionStartedAt: 'knowledgeConnectorGoogleUser.permissionStartedAt',
    permissionFailure: 'knowledgeConnectorGoogleUser.permissionFailure',
  },
