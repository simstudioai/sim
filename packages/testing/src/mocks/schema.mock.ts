...
export const schemaMock = {
  ...
  newsletterAudienceRuns: {
    ...
    excludedBanned: 'excludedBanned',
    excludedUnverified: 'excludedUnverified',
    excludedUnsubscribed: 'excludedUnsubscribed',
    excludedSuppressed: 'excludedSuppressed',
    finalRecipientCount: 'finalRecipientCount',
    sampleRecipients: 'sampleRecipients',
    resendSegmentId: 'resendSegmentId',
    resendSegmentName: 'resendSegmentName',
    resendSyncedAt: 'resendSyncedAt',
    snapshotVersion: 'snapshotVersion',
    resendSyncAttempt: 'resendSyncAttempt',
    resendSyncJobId: 'resendSyncJobId',
    error: 'error',
