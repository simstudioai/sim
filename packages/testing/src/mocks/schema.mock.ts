...
export const schemaMock = {
  ...
  usageDailyCost: {
    billingEntityType: 'usageDailyCost.billingEntityType',
    billingEntityId: 'usageDailyCost.billingEntityId',
    billingPeriodStart: 'usageDailyCost.billingPeriodStart',
    billingPeriodEnd: 'usageDailyCost.billingPeriodEnd',
    userId: 'usageDailyCost.userId',
    source: 'usageDailyCost.source',
    usageDate: 'usageDailyCost.usageDate',
    shard: 'usageDailyCost.shard',
    cost: 'usageDailyCost.cost',
    entryCount: 'usageDailyCost.entryCount',
  },
  usageLog: {
    id: 'usageLog.id',
    ...
    cost: 'usageLog.cost',
    costProjected: 'usageLog.costProjected',
