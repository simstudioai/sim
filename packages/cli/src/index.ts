 ...
 * leave that data permanently unreadable. Any value that is not a 32-byte hex key —
 * including the shared placeholder shipped by earlier versions — is replaced.
 */
