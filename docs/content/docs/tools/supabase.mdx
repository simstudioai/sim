...
<div className="not-prose my-6 flex justify-center"><svg {...props} width="24" height="24" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
      <path
...
```typescript
// Example of using the Supabase block
{
  type: "supabase",
  operation: "example"
}
