...
<div className="not-prose my-6 flex justify-center"><svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24" height="24">
    <path
      fill="#fbc02d"
...
```typescript
// Example of using the Google Search block
{
  type: "google_search",
