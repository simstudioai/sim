...
import { GitHubMemberIntegration } from '@/app/o/[organizationId]/integrations/indexed/github-member-integration'
import { MemberIntegrationRow } from '@/app/o/[organizationId]/integrations/indexed/member-integration-row'
  ...
  return (
    <>
      <MemberIntegrationRow
        ...
        onCreate={
          canCreate && connector
            ? () => enrollment.connectSearchSource(scope, connector)
            : undefined
        }
        addLabel={
