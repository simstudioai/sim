...
export function useMemberEnrollment({
  ...
  /**
   * One click on a new Sim Search source: ask for its setup fields when it
   * needs them, and otherwise create it and enroll in one step.
   */
  const connectSearchSource = (owner: string | ResourceScope, connector: SearchConnector) => {
