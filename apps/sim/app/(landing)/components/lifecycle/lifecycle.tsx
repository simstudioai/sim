 ...
 * this section carries no vertical padding. Horizontal padding matches
 * the navbar and hero so the headline starts on the wordmark's line, and the
 * section is capped and centered at the shared `max-w-[1728px]`. First
...
export function Lifecycle() {
  return (
    <section
      ...
      className='mx-auto w-full max-w-[1728px] px-10 max-md:px-7 max-lg:px-8 max-xl:px-9'
    >
