  ...
  return (
    <div className='relative flex w-full flex-col overflow-hidden border-border border-b py-10 will-change-[opacity,transform] sm:py-12 md:py-16 gap-16 px-8 sm:px-8 md:px-12 lg:px-40'>
        <div className='flex flex-col gap-5'>
            ...
            <p className='text-[#515151] text-lg font-normal max-w-xl'>
                Extend workflows with your own code, APIs, or functions. Use our visual builder when it helps—drop into code when it matters.        
            </p>
        </div>
        <div className='relative w-full flex border-b border-t border-border h-[24rem] sm:h-[32rem] md:h-[40rem] overflow-hidden'>
