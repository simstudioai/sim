 ...
 * (`SOLUTIONS_SPACING.gutter`, matching the navbar and landing hero) and the
 * inter-section vertical rhythm (`SOLUTIONS_SPACING.sectionRhythm`, the `<main>`
...
export function SolutionsPage({ config }: SolutionsPageProps) {
  return (
    <>
      ...
      <main
        id='main-content'
        className={cn('flex flex-col', SOLUTIONS_SPACING.sectionRhythm, SOLUTIONS_SPACING.gutter)}
      >
