 ...
 */
const CARD = 'absolute w-[184px] rounded-[8px] border border-[#e6e6e6] bg-[#ffffff]'
const TILE = 'flex size-[24px] flex-shrink-0 items-center justify-center rounded-[6px] bg-[#2C2C2C]'
...
function AgentCard({ className, name, status, model }: AgentCardProps) {
  return (
    <div className={cn(CARD, className)}>
      <div className={cn('flex items-center gap-2.5 p-2', model && 'border-[#e6e6e6] border-b')}>
        <div className={TILE}>
      ...
      {model && (
        <div className='flex items-center gap-2 p-2'>
          ...
          <span className='flex min-w-0 flex-1 items-center justify-end gap-2 text-[#121212] text-[14px]'>
            <AnthropicIcon className='inline-block size-[14px] flex-shrink-0 text-[#121212]' />
  ...
  return (
    <div aria-hidden='true' className='relative h-[300px] w-[520px]'>
      ...
      <svg className='absolute inset-0 h-full w-full' fill='none' aria-hidden='true'>
        <path d='M184,28 C260,28 256,140 332,140' stroke='#c9c9c9' strokeWidth='1.5' />
        <path d='M184,140 C260,140 256,140 332,140' stroke='#c9c9c9' strokeWidth='1.5' />
        <path d='M184,252 C260,252 256,140 332,140' stroke='#c9c9c9' strokeWidth='1.5' />
      </svg>
