            ...
            <div className="space-y-8 text-white/80">
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  the exclusive property of Sim Studio, Inc and its licensors. The Service is protected
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  certain information, text, graphics, videos, or other material ("User Content"). You
                  are responsible for the User Content that you post on or through the Service,
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  <li>
                    The User Content is yours (you own it) or you have the right to use it and grant us
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    ...
                    of the Service, or which, as determined by us, may harm Sim Studio, Inc or users of
              ...
              <section>
                ...
                <p>
                  Sim Studio, Inc, its subsidiaries, affiliates, and its licensors do not warrant that:
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                  <li>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  affiliates, successors and assigns and all of their respective officers, directors,
                  employees, agents, and representatives (collectively, the <span className="text-[#B5A1D4]">"Company Parties"</span>) and
                ...
                <p className="mb-4">
                  ...
                  Site, the Service or these Terms will be resolved by binding arbitration, rather than
                  in court, except that (1) you and the Company Parties may assert individualized claims
                ...
                <p className="mb-4 bg-[#701ffc]/10 p-3 border-l-4 border-[#701ffc]">
                  ...
                  INDIVIDUAL BASIS AND NOT ON A CLASS, REPRESENTATIVE, OR COLLECTIVE BASIS. ONLY
                  INDIVIDUAL RELIEF IS AVAILABLE, AND DISPUTES OF MORE THAN ONE CUSTOMER OR USER CANNOT
                ...
                <p className="mb-4">
                  ...
                  sending a timely written notice of your decision to opt out to: <Link href="mailto:legal@simstudio.ai" className="text-[#B5A1D4] hover:text-[#701ffc]">legal@simstudio.ai </Link>
              ...
              <section>
                ...
                <p className="mb-4">
                  We respect the intellectual property of others and ask that users of our Service do
                  the same. If you believe that one of our users is, through the use of our Service,
                  unlawfully infringing the copyright(s) in a work, please send a notice to our
                  designated Copyright Agent, including the following information:
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-4 marker:text-[#B5A1D4]">
                ...
                <p>
                  Our Copyright Agent can be reached at: <Link href="mailto:copyright@simstudio.ai" className="text-[#B5A1D4] hover:text-[#701ffc]">copyright@simstudio.ai</Link>
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  <Link href="mailto:legal@simstudio.ai" className="text-[#B5A1D4] hover:text-[#701ffc]">
                    legal@simstudio.ai
                  </Link>
                </p>
              </section>
