...
export const BUBBLE_MENU_CLASS =
  'scrollbar-none fade-in-0 z-[var(--z-popover)] flex max-w-[calc(100vw_-_1rem)] animate-in items-center gap-0.5 overflow-x-auto rounded-lg border border-[var(--border)] bg-[var(--bg)] p-1 shadow-xs duration-150 ease-out motion-reduce:animate-none'
