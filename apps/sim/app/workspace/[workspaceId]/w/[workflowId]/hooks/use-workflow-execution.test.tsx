...
vi.mock('@/app/workspace/[workspaceId]/w/[workflowId]/utils/workflow-execution-utils', () => ({
  ...
  /* The dependency gate is a pure predicate over edges and the last snapshot;
     these cases all start from a satisfied block, so it stands in as `true`
     rather than requiring each fixture to build a runnable graph. */
  areRunFromBlockDependenciesSatisfied: () => true,
