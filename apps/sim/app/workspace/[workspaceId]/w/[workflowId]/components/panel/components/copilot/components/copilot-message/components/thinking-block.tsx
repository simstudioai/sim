  ...
  return (
    <div className='mt-1 mb-0'>
      <button
        ...
        className={cn(
          'mb-1 inline-flex items-center gap-1 text-gray-400 text-[11px] transition-colors hover:text-gray-500',
          'font-normal italic'
        )}
        type='button'
      >
      ...
      {isExpanded && (
        <div className='ml-1 border-gray-200 border-l-2 pl-2 dark:border-gray-700'>
          <pre className='whitespace-pre-wrap font-mono text-gray-400 text-[11px] dark:text-gray-500'>
            {content}
            {isStreaming && (
