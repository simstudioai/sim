...
import { ConfigSection } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/panel-new/components/design/components/sub-block/components/webhook/components'
