            ...
            return (
              <>
                <Input
                  ...
                  className='allow-scroll w-full overflow-auto text-transparent selection:text-transparent cursor-default caret-foreground [-ms-overflow-style:none] [scrollbar-width:none] placeholder:text-muted-foreground/50 [&::-webkit-scrollbar]:hidden'
                  readOnly={readOnly}
