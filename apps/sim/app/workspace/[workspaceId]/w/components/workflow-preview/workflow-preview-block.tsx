...
function WorkflowPreviewBlockInner({ data }: NodeProps<WorkflowPreviewBlockData>) {
  ...
  const horizontalHandleClass = '!border-none !bg-[var(--surface-6)] !h-5 !w-[7px] !rounded-[2px]'
  const verticalHandleClass = '!border-none !bg-[var(--surface-6)] !h-[7px] !w-5 !rounded-[2px]'
