          ...
          <div className='flex min-w-0 items-center gap-2'>
            {isEditing ? (
              <input
                ...
                className='w-full min-w-0 border-0 bg-transparent p-0 font-base text-sm text-[var(--text-body)] outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0'
                maxLength={100}
                disabled={isRenaming}
                onClick={(e) => {
                  e.preventDefault()
