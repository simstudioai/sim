        ...
        {connectors.map((connector) => {
          ...
          return (
            <button
              ...
              className='flex shrink-0 cursor-pointer items-center gap-1.5 rounded-md px-2 py-1 text-caption text-[var(--text-secondary)] shadow-[inset_0_0_0_1px_var(--border)] transition-colors hover-hover:bg-[var(--surface-3)]'
            >
            ...
            : {
                content: (
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
                      <span
                        className='block max-w-full truncate text-caption text-[var(--text-secondary)]'
  ...
  return (
    <div className='border-[var(--border-1)] border-t'>
      <div className='flex items-center justify-between px-3 py-2'>
        <span className='font-medium text-caption text-[var(--text-secondary)]'>Filter by tags</span>
        <div className='flex items-center gap-1'>
          {activeCount > 0 && (
            <Button
              variant='ghost'
              className='h-auto px-1.5 py-0.5 text-xs text-[var(--text-muted)]'
              onClick={() => onChange([])}
            >
              Clear all
            </Button>
          ...
          return (
            ...
            >
              <div className='flex items-center justify-between'>
                <Label className='text-xs text-[var(--text-muted)]'>Tag</Label>
                <button
                  type='button'
                ...
                <>
                  ...
                  {entry.fieldType === 'date' ? (
                    ...
                    <div className='flex items-center gap-1.5'>
                      ...
                      />
                      <span className='flex-shrink-0 text-xs text-[var(--text-muted)]'>to</span>
                      <Input
                        value={entry.valueTo}
