            ...
            <div className='px-6 pb-6'>
              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <Button
                  ...
                  size='sm'
                  className='47, 255, 0.15)] flex items-center gap-1 bg-[var(--brand-primary-hex)] font-[480] text-white shadow-[0_0_0_0_var(--brand-primary-hex)] transition-all duration-200 hover:bg-[var(--brand-primary-hover-hex)] hover:shadow-[0_0_0_4px_rgba(128, disabled:cursor-not-allowed disabled:opacity-50'
                >
