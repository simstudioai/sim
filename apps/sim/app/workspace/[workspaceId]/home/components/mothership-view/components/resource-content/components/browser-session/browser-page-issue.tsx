    ...
    >
      <div className='-translate-y-8 w-full max-w-[360px]'>
        ...
        <h2
          ...
          className='rounded-sm font-medium text-[var(--text-primary)] text-base outline-hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--border-1)]'
          tabIndex={-1}
        >
          {copy.headline}
        </h2>
