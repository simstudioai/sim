...
export function Skills() {
  ...
  const addButton = (
    <button
      ...
      disabled={isLoading}
      className='group mx-0.5 inline-flex h-[30px] items-center gap-1.5 rounded-lg bg-[var(--text-primary)] px-2 text-[var(--text-inverse)] transition-colors hover-hover:bg-[var(--text-body)] hover-hover:text-[var(--text-inverse)] disabled:opacity-60 dark:bg-white dark:text-[var(--bg)] dark:hover-hover:bg-[var(--text-secondary)] dark:hover-hover:text-[var(--bg)]'
    >
