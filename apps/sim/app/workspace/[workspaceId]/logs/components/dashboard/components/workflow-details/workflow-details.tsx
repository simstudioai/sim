...
import { LogMarkdownRenderer } from '@/app/workspace/[workspaceId]/logs/components'
import { formatDate } from '@/app/workspace/[workspaceId]/logs/utils'
import { useWorkflowRegistry } from '@/stores/workflows/registry/store'
import { LineChart, type LineChartPoint } from '..'
                            ...
                            <div>
                              {log.trigger ? (
                                <div
                                  ...
                                  style={{
                                    backgroundColor: getIntegrationMetadata(log.trigger).color,
                                  }}
                                >
                                  {log.trigger}
                                </div>
