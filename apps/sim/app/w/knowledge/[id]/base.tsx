...
export function KnowledgeBase({ id }: KnowledgeBaseProps) {
  ...
  const isIndeterminate =
    selectedDocuments.size > 0 && selectedDocuments.size < filteredDocuments.length
    ...
    return (
      ...
      >
        <div className='flex flex-1 items-center justify-center'>
          <div className='text-muted-foreground text-sm'>Loading knowledge base...</div>
        </div>
      </div>
    )
  }
    ...
    return (
      ...
      >
        <div className='flex items-center gap-2 px-6 pt-[14px] pb-6'>
          ...
          <span className='text-muted-foreground'>/</span>
          <span className='font-medium text-sm'>Not Found</span>
        </div>
        <div className='flex flex-1 items-center justify-center'>
          <div className='text-center'>
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center gap-2 px-6 pt-[14px] pb-6'>
        ...
        <span className='text-muted-foreground'>/</span>
        <span className='font-medium text-sm'>{knowledgeBase.name}</span>
      </div>
