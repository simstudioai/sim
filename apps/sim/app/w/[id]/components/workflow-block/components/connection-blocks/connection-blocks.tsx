  ...
  const renderConnectionCard = (connection: ConnectedBlock, field?: ResponseField) => {
    ...
    return (
      <Card
        ...
        className='group flex w-max cursor-grab items-center gap-2 rounded-lg border bg-card p-2 shadow-sm transition-colors hover:bg-accent/50 active:cursor-grabbing'
      >
