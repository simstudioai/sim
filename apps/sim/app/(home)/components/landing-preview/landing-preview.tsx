...
export function LandingPreview() {
  ...
  return (
    <motion.div
      className='dark flex aspect-[1116/549] w-full overflow-hidden rounded bg-[var(--surface-1)] antialiased'
      initial='hidden'
      animate='visible'
    ...
    >
      ...
      <div className='flex min-w-0 flex-1 flex-col py-2 pr-2 pl-2 lg:pl-0'>
        <div className='flex flex-1 overflow-hidden rounded-lg border border-[var(--surface-active)] bg-[var(--bg)]'>
          <div
            className={
              isWorkflowView
