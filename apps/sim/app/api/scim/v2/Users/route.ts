...
import { provisionScimUser } from '@/lib/scim/application/users/provision-user'
import { listScimUsers } from '@/lib/scim/application/users/read-users'
 ...
 * access lives in `lib/scim/application`.
 */
