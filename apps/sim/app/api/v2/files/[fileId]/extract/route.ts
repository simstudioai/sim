import { v2ExtractFileContract } from '@/lib/api/contracts/v2/files'
...
/**
 * Matches the internal extract route. Extraction downloads the archive and
...
/**
 * POST /api/v2/files/[fileId]/extract — unzip an archive into a new folder
 * beside it.
 *
 * Answers counts plus the destination `folderPath` rather than the extracted
 ...
 * Concurrent extraction of the same archive answers `409`.
 */
export const POST = defineV2JsonRoute({
  contract: v2ExtractFileContract,
  auth: v2ApiKeyAuth,
