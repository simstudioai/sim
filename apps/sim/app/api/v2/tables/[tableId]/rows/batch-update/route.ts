...
import { v2BatchUpdateTableRowsContract } from '@/lib/api/contracts/v2/tables'
 ...
 *
 * An explicit body ceiling because a full batch is up to a thousand rows of
...
export const POST = defineV2JsonRoute({
  contract: v2BatchUpdateTableRowsContract,
