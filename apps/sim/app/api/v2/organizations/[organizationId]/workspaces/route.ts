import { v2ListOrganizationWorkspacesContract } from '@/lib/api/contracts/v2/organizations'
...
import { listOrganizationWorkspaces } from '@/lib/organizations/application/reads'
...
export const GET = defineV2JsonRoute({
  ...
  mapInput: ({ params, query }) => ({
    ...
    cursorKeys: readSortedCursor(
      ...
      query.sortBy,
      query.sortOrder,
      cursorScopeKey(cursorRoute(v2ListOrganizationWorkspacesContract, params), {
        search: query.search,
      })
    ),
  }),
  useCase: listOrganizationWorkspaces,
