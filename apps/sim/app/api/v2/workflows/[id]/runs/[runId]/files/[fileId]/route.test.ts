...
import { GET } from '@/app/api/v2/workflows/[id]/runs/[runId]/files/[fileId]/route'
...
const context = {
  params: Promise.resolve({ id: WORKFLOW_ID, runId: RUN_ID, fileId: FILE_ID }),
}
...
describe('GET /api/v2/workflows/[id]/runs/[runId]/files/[fileId]', () => {
  beforeEach(() => {
    vi.clearAllMocks()
