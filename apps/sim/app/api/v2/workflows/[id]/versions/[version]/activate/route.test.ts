...
import { POST } from '@/app/api/v2/workflows/[id]/versions/[version]/activate/route'
...
async function post(version = '3', body?: unknown) {
  ...
  return POST(request, { params: Promise.resolve({ id: 'workflow-1', version }) })
}

describe('POST /api/v2/workflows/[id]/versions/[version]/activate', () => {
  beforeEach(() => {
    vi.clearAllMocks()
