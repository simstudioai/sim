...
import {
  ...
  GET,
  PATCH,
} from '@/app/api/v2/knowledge/[id]/documents/[documentId]/chunks/[chunkId]/route'

const WORKSPACE_ID = 'workspace-1'
const context = {
  params: Promise.resolve({ id: 'kb-1', documentId: 'doc-1', chunkId: 'chunk-1' }),
}
...
describe('GET /api/v2/knowledge/[id]/documents/[documentId]/chunks/[chunkId]', () => {
...
describe('PATCH /api/v2/knowledge/[id]/documents/[documentId]/chunks/[chunkId]', () => {
...
describe('DELETE /api/v2/knowledge/[id]/documents/[documentId]/chunks/[chunkId]', () => {
