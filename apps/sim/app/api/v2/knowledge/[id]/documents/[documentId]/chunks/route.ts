...
/**
 * GET /api/v2/knowledge/[id]/documents/[documentId]/chunks — List a document's chunks.
 *
...
export const GET = defineV2JsonRoute({
  ...
  mapInput: ({ params, query }) => ({
    ...
    cursorKeys: readSortedCursor(
      ...
      query.sortBy,
      query.sortOrder,
      chunkCursorFilters(params.id, params.documentId, query)
    ),
  }),
...
/**
 * POST /api/v2/knowledge/[id]/documents/[documentId]/chunks — Append a chunk.
 *
...
/**
 * PATCH /api/v2/knowledge/[id]/documents/[documentId]/chunks — Enable, disable,
