...
import { DELETE, PATCH } from '@/app/api/v2/knowledge/[id]/tags/[tagId]/route'

const WORKSPACE_ID = 'workspace-1'
const context = { params: Promise.resolve({ id: 'kb-1', tagId: 'tag-def-1' }) }
...
describe('PATCH /api/v2/knowledge/[id]/tags/[tagId]', () => {
  /**
...
describe('DELETE /api/v2/knowledge/[id]/tags/[tagId]', () => {
