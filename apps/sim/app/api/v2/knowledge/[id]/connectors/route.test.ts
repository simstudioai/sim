...
} from '@/app/api/v2/knowledge/[id]/connectors/[connectorId]/documents/route'
import {
  DELETE as deleteConnector,
  GET as getConnector,
  PATCH as updateConnector,
} from '@/app/api/v2/knowledge/[id]/connectors/[connectorId]/route'
import { POST as syncConnector } from '@/app/api/v2/knowledge/[id]/connectors/[connectorId]/sync/route'
import {
  POST as createConnector,
  GET as listConnectors,
} from '@/app/api/v2/knowledge/[id]/connectors/route'
...
const collectionContext = { params: Promise.resolve({ id: KNOWLEDGE_BASE_ID }) }
