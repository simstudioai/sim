...
export const POST = withRouteHandler(async (request: NextRequest, { params }: ColumnsRouteParams) => {
...
export const PATCH = withRouteHandler(async (request: NextRequest, { params }: ColumnsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
...
export const DELETE = withRouteHandler(async (request: NextRequest, { params }: ColumnsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
