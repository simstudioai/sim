 ...
 */
export const GET = withRouteHandler(async (request: NextRequest, { params }: { params: Promise<RouteParams> }) => {
 ...
 * PUT - Update an agent
 */
export const PUT = withRouteHandler(async (request: NextRequest, { params }: { params: Promise<RouteParams> }) => {
  const { agentId } = await params
 ...
 */
export const DELETE = withRouteHandler(async (request: NextRequest, { params }: { params: Promise<RouteParams> }) => {
  const { agentId } = await params
 ...
 */
export const POST = withRouteHandler(async (request: NextRequest, { params }: { params: Promise<RouteParams> }) => {
  const { agentId } = await params
