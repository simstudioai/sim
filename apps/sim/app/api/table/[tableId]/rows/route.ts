...
export const POST = withRouteHandler(async (request: NextRequest, { params }: TableRowsRouteParams) => {
...
export const GET = withRouteHandler(async (request: NextRequest, { params }: TableRowsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
...
export const PUT = withRouteHandler(async (request: NextRequest, { params }: TableRowsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
...
export const DELETE = withRouteHandler(async (request: NextRequest, { params }: TableRowsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
...
export const PATCH = withRouteHandler(async (request: NextRequest, { params }: TableRowsRouteParams) => {
  const requestId = generateRequestId()
  const { tableId } = await params
