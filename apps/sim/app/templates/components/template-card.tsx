...
export function TemplateCardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('h-[268px] w-full rounded-lg bg-[var(--surface-3)] p-2', className)}>
      <div className='h-[180px] w-full animate-pulse rounded-md bg-[var(--surface-5)]' />
...
function TemplateCardInner({
  ...
  return (
    ...
    >
      <div
        ref={previewRef}
        className='pointer-events-none h-[180px] w-full cursor-pointer overflow-hidden rounded-md'
      >
      ...
      <div className='mt-2.5 flex items-center justify-between'>
        <div className='flex min-w-0 items-center gap-2'>
          ...
          <div className='flex min-w-0 items-center gap-1'>
            <span className='truncate font-medium text-caption text-[var(--text-muted)]'>
              {author}
            </span>
        ...
        <div className='flex flex-shrink-0 items-center gap-1.5 font-medium text-caption text-[var(--text-muted)]'>
