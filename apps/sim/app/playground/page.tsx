  ...
  return (
    <Tooltip.Provider>
      <div className='min-h-screen bg-[var(--bg)]'>
        <div className='mx-auto max-w-screen-2xl px-[16px] py-[24px] sm:px-[24px] md:px-[32px]'>
          {/* Header */}
          <div className='mb-[24px] flex items-center justify-between border-[var(--border)] border-b pb-[16px]'>
