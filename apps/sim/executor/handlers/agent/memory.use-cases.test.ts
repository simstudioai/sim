...
vi.mock('@/lib/memory/application/agent-turns', () => ({
  readAgentMemoryPrefixUseCase: { execute: hoisted.prefix },
  readAgentMemoryItemsUseCase: { execute: hoisted.items },
  appendAgentMemoryMessageUseCase: { execute: hoisted.append },
}))
...
tokenizationAccurateMockFns.mockGetAccurateTokenCount.mockReturnValue(1)
