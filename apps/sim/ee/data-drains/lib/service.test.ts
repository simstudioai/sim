...
vi.mock('@/ee/data-drains/lib/sources/registry', () => ({ getSource: mockGetSource }))
vi.mock('@/ee/data-drains/lib/destinations/registry', () => ({
  getDestination: mockGetDestination,
}))
vi.mock('@/ee/data-drains/lib/encryption', () => ({ decryptCredentials: mockDecryptCredentials }))
