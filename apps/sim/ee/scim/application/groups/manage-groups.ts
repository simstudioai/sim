...
} from '@/ee/scim/application/authorized-scim-use-case'
import { scimOperations } from '@/ee/scim/application/operations'
import { autoMapPermissionGroupByName } from '@/ee/scim/projection/auto-map'
import { reconcileUsersProjection } from '@/ee/scim/projection/reconcile-user'
import type { CanonicalScimGroup } from '@/ee/scim/protocol/canonical'
import { SCIM_MAX_GROUP_MEMBERS } from '@/ee/scim/protocol/constants'
import { invalidValue, notFound, ScimError, uniqueness } from '@/ee/scim/protocol/errors'
import { parseGroupFilter } from '@/ee/scim/protocol/filter'
import { parseGroupPatch } from '@/ee/scim/protocol/group-patch'
import {
  projectionWants,
  projectResource,
  resolvePage,
  ...
  toGroupResource,
} from '@/ee/scim/protocol/resources'
import {
  addGroupMember,
  countGroupMembers,
  deleteScimGroupRow,
  ...
  touchScimGroup,
  updateScimGroup,
} from '@/ee/scim/repository/groups'
