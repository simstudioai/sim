...
import type { ScimAuditEntry } from '@/ee/scim/application/audit'
import {
...
import { syncAccountIdentityTx } from '@/ee/scim/identity/account-identity'
import { assertDomainOwned } from '@/ee/scim/identity/resolve-user'
import { reconcileUserProjection } from '@/ee/scim/projection/reconcile-user'
import { primaryEmail } from '@/ee/scim/protocol/canonical'
import { notFound, ScimError } from '@/ee/scim/protocol/errors'
import { toUserResource } from '@/ee/scim/protocol/resources'
import { applyUserPatch, userAttributesEqual } from '@/ee/scim/protocol/user-patch'
import {
