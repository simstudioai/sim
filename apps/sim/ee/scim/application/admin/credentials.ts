...
import { requireConnection, toCredentialView } from '@/ee/scim/application/admin/connection-view'
import {
  defineAuthorizedScimAdminUseCase,
  type ScimAdminUseCaseArgs,
} from '@/ee/scim/application/authorized-scim-admin-use-case'
import { scimAdminOperations } from '@/ee/scim/application/operations'
import { generateScimToken } from '@/ee/scim/authenticate'
import { activeCredentialCondition } from '@/ee/scim/repository/credentials'
