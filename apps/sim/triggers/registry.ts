...
export const TRIGGER_REGISTRY: TriggerRegistry = {
  ...
  quickbooks_account_events: quickBooksAccountEventsTrigger,
  quickbooks_bill_events: quickBooksBillEventsTrigger,
  quickbooks_bill_payment_events: quickBooksBillPaymentEventsTrigger,
  quickbooks_budget_events: quickBooksBudgetEventsTrigger,
  quickbooks_class_events: quickBooksClassEventsTrigger,
  quickbooks_credit_memo_events: quickBooksCreditMemoEventsTrigger,
  quickbooks_currency_events: quickBooksCurrencyEventsTrigger,
  quickbooks_customer_events: quickBooksCustomerEventsTrigger,
  quickbooks_department_events: quickBooksDepartmentEventsTrigger,
  quickbooks_deposit_events: quickBooksDepositEventsTrigger,
  quickbooks_employee_events: quickBooksEmployeeEventsTrigger,
  quickbooks_estimate_events: quickBooksEstimateEventsTrigger,
  quickbooks_invoice_events: quickBooksInvoiceEventsTrigger,
  quickbooks_item_events: quickBooksItemEventsTrigger,
  quickbooks_journal_code_events: quickBooksJournalCodeEventsTrigger,
  quickbooks_journal_entry_events: quickBooksJournalEntryEventsTrigger,
  quickbooks_payment_events: quickBooksPaymentEventsTrigger,
  quickbooks_payment_method_events: quickBooksPaymentMethodEventsTrigger,
  quickbooks_preferences_updated: quickBooksPreferencesUpdatedTrigger,
  quickbooks_purchase_events: quickBooksPurchaseEventsTrigger,
  quickbooks_purchase_order_events: quickBooksPurchaseOrderEventsTrigger,
  quickbooks_refund_receipt_events: quickBooksRefundReceiptEventsTrigger,
  quickbooks_sales_receipt_events: quickBooksSalesReceiptEventsTrigger,
  quickbooks_tax_agency_events: quickBooksTaxAgencyEventsTrigger,
  quickbooks_term_events: quickBooksTermEventsTrigger,
  quickbooks_time_activity_events: quickBooksTimeActivityEventsTrigger,
  quickbooks_transfer_events: quickBooksTransferEventsTrigger,
  quickbooks_vendor_credit_events: quickBooksVendorCreditEventsTrigger,
