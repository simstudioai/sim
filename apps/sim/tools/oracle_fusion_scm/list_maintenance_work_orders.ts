...
export const oracleFusionScmListMaintenanceWorkOrdersTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_maintenance_work_orders',
  name: 'Oracle Fusion SCM List Maintenance Work Orders',
  description: 'List one bounded page of maintenance work orders.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Maintenance Work Orders in this bounded page',
      items: { type: 'object', properties: oracleFusionScmMaintenanceWorkOrderOutputProperties },
    },
