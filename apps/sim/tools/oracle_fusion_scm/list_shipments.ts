...
export const oracleFusionScmListShipmentsTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_shipments',
  name: 'Oracle Fusion SCM List Shipments',
  description: 'List one bounded page of shipments using a fixed safe projection.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Shipments in this bounded page',
      items: { type: 'object', properties: oracleFusionScmShipmentOutputProperties },
    },
