...
export const oracleFusionScmListSalesOrderLinesTool: InternalToolConfig<
  OracleFusionScmParentListParams<'salesOrderKey'>,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_sales_order_lines',
  name: 'Oracle Fusion SCM List Sales Order Lines',
  description:
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Sales Order Lines in this bounded page',
      items: { type: 'object', properties: oracleFusionScmSalesOrderLineOutputProperties },
    },
