...
export const oracleFusionScmListTransferOrdersTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_transfer_orders',
  name: 'Oracle Fusion SCM List Transfer Orders',
  description: 'List one bounded page of transfer orders. q and finder are mutually exclusive.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Transfer Orders in this bounded page',
      items: { type: 'object', properties: oracleFusionScmTransferOrderOutputProperties },
    },
