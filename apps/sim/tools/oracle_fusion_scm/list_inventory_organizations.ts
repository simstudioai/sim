...
export const oracleFusionScmListInventoryOrganizationsTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_inventory_organizations',
  name: 'Oracle Fusion SCM List Inventory Organizations',
  description: 'List one bounded page of inventory organizations using a fixed safe projection.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Inventory Organizations in this bounded page',
      items: { type: 'object', properties: oracleFusionScmInventoryOrganizationOutputProperties },
    },
