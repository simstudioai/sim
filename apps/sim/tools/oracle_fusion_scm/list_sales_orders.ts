...
export const oracleFusionScmListSalesOrdersTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_sales_orders',
  name: 'Oracle Fusion SCM List Sales Orders',
  description: 'List one bounded page of sales orders. q and finder are mutually exclusive.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Sales Orders in this bounded page',
      items: { type: 'object', properties: oracleFusionScmSalesOrderOutputProperties },
    },
