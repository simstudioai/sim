...
export const oracleFusionScmListSupplyRequestsTool: InternalToolConfig<
  OracleFusionScmListParams,
  OracleFusionScmListResponse
> = {
  id: 'oracle_fusion_scm_list_supply_requests',
  name: 'Oracle Fusion SCM List Supply Requests',
  description: 'List one bounded page of supply requests using a fixed safe projection.',
  version: '1.0.0',
  params,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Supply Requests in this bounded page',
      items: { type: 'object', properties: oracleFusionScmSupplyRequestOutputProperties },
    },
