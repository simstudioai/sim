import type {
  JsmGetOrganizationUsersParams,
  JsmGetOrganizationUsersResponse,
} from '@/tools/jsm/types'
import { CUSTOMER_ITEM_PROPERTIES } from '@/tools/jsm/types'
import type { ToolConfig } from '@/tools/types'

export const jsmGetOrganizationUsersTool: ToolConfig<
  JsmGetOrganizationUsersParams,
  JsmGetOrganizationUsersResponse
> = {
  id: 'jsm_get_organization_users',
  name: 'JSM Get Organization Users',
  description: 'Get users in an organization in Jira Service Management',
  version: '1.0.0',
  ...
  params: {
    ...
    organizationId: {
      ...
      required: true,
      visibility: 'user-or-llm',
      description: 'Organization ID to get users from',
    },
    start: {
      type: 'number',
      required: false,
