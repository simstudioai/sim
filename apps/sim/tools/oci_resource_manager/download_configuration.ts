import type {
  OciResourceManagerDownloadConfigurationParams,
...
export const ociResourceManagerDownloadConfigurationTool: InternalToolConfig<
  OciResourceManagerDownloadConfigurationParams,
  OciResourceManagerResponse
> = {
  id: 'oci_resource_manager_download_configuration',
  name: 'OCI Resource Manager Download Configuration',
  description: 'Download stack or job Terraform configuration as a stored ZIP file.',
  version: '1.0.0',
