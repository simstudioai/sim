import type {
  OciResourceManagerPlanRollbackParams,
...
export const ociResourceManagerPlanRollbackTool: InternalToolConfig<
  OciResourceManagerPlanRollbackParams,
  OciResourceManagerResponse
> = {
  id: 'oci_resource_manager_plan_rollback',
  name: 'OCI Resource Manager Plan Rollback',
  description: 'Plan rollback toward a successful apply job from the same stack.',
  version: '1.0.0',
  ...
  params: {
    ...
    targetRollbackJobId: { ...ociResourceManagerParams.targetRollbackJobId, required: true },
