import type {
  OciResourceManagerDeleteStackParams,
...
export const ociResourceManagerDeleteStackTool: InternalToolConfig<
  OciResourceManagerDeleteStackParams,
  OciResourceManagerResponse
> = {
  id: 'oci_resource_manager_delete_stack',
  name: 'OCI Resource Manager Delete Stack',
  description: 'Delete a stack and its state file while leaving deployed resources in place.',
  version: '1.0.0',
  ...
  params: {
    ...
    confirmDelete: { ...ociResourceManagerParams.confirmDelete, required: true },
