...
export const deleteRowsTool: ToolConfig<SnowflakeDeleteRowsParams, SnowflakeDeleteRowsResponse> = {
  ...
  request: {
    ...
    body: (params) => buildSnowflakeStatementBody(params, buildDeleteRows(params)),
  },
