...
export const oracleFusionServiceListServiceRequestMessagesTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_request_messages',
  name: 'Oracle Fusion Service List Service Request Messages',
  description:
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceMessagesOutputs },
    },
