...
export const oracleFusionServiceListServiceRequestContactsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_request_contacts',
  name: 'Oracle Fusion Service List Service Request Contacts',
  description: 'Read one page of Oracle Fusion Service service request contacts.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceRequestContactsOutputs },
    },
