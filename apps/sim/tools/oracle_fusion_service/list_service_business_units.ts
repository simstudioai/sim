...
export const oracleFusionServiceListServiceBusinessUnitsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_business_units',
  name: 'Oracle Fusion Service List Service Business Units',
  description: 'Read one page of Oracle Fusion Service service business units.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceBusinessUnitsOutputs },
    },
