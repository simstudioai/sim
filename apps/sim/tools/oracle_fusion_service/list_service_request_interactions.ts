...
export const oracleFusionServiceListServiceRequestInteractionsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_request_interactions',
  name: 'Oracle Fusion Service List Service Request Interactions',
  description: 'Read one page of Oracle Fusion Service service request interactions.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceInteractionsOutputs },
    },
