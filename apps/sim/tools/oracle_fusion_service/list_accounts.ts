...
export const oracleFusionServiceListAccountsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_accounts',
  name: 'Oracle Fusion Service List Accounts',
  description:
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceAccountsOutputs },
    },
