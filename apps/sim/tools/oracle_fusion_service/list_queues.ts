...
export const oracleFusionServiceListQueuesTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_queues',
  name: 'Oracle Fusion Service List Queues',
  description: 'Read one page of Oracle Fusion Service queues.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceQueuesOutputs },
    },
