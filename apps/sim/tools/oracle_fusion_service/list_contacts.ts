...
export const oracleFusionServiceListContactsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_contacts',
  name: 'Oracle Fusion Service List Contacts',
  description:
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceContactsOutputs },
    },
