...
export const oracleFusionServiceListServiceRequestResourcesTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_request_resources',
  name: 'Oracle Fusion Service List Service Request Resources',
  description: 'Read one page of Oracle Fusion Service service request resources.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceRequestResourcesOutputs },
    },
