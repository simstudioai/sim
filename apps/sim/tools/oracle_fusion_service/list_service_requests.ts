...
export const oracleFusionServiceListServiceRequestsTool: InternalToolConfig<
  OracleFusionServiceParams,
  OracleFusionServiceResponse
> = {
  id: 'oracle_fusion_service_list_service_requests',
  name: 'Oracle Fusion Service List Service Requests',
  description: 'Read one page of Oracle Fusion Service service requests.',
  version: '1.0.0',
  ...
  outputs: {
    items: {
      ...
      items: { type: 'object', properties: oracleFusionServiceRequestOutputs },
    },
