import type {
  OracleEpmEdmImportDimensionParams,
  OracleEpmEdmImportDimensionResponse,
...
export const oracleEpmEdmImportDimensionTool: InternalToolConfig<
  OracleEpmEdmImportDimensionParams,
  OracleEpmEdmImportDimensionResponse
> = {
  id: 'oracle_epm_edm_import_dimension',
  name: 'Oracle EDM Import Dimension',
  description: 'Import a dimension using an explicit import mode and staged or uploaded file.',
  version: '1.0.0',
  oauth: {
    required: true,
  ...
  params: {
    ...
    importOption: edmParam(
      'string',
      true,
      'Required import mode; no destructive provider default is applied. Allowed values: ResetDimension, ReplaceNodes, Merge.'
    ),
    file: edmParam(
      'file',
      false,
  ...
  operation: { input: (params) => edmOperationInput('oracle_epm_edm_import_dimension', params) },
  outputs: {
