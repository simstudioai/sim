import type { WikipediaPageSummaryParams, WikipediaPageSummaryResponse } from '@/tools/wikipedia/types'
    ...
    return {
      ...
      output: {
        summary: {
          ...
          content_urls: data.content_urls || { desktop: { page: '', revisions: '', edit: '', talk: '' }, mobile: { page: '', revisions: '', edit: '', talk: '' } },
          lang: data.lang || '',
          dir: data.dir || 'ltr',
