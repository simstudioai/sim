...
import type {
  OracleFusionListProjectsParams,
...
export const oracleFusionProjectManagementListProjectsTool: InternalToolConfig<
  OracleFusionListProjectsParams,
  OracleFusionProjectManagementResponse
> = {
  ...
  outputs: {
    items: { type: 'array', description: 'This page of project records', items: { type: 'object', properties: oracleFusionProjectOutput } },
