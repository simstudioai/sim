...
import type {
  OracleFusionListProjectCostsParams,
...
export const oracleFusionProjectManagementListProjectCostsTool: InternalToolConfig<
  OracleFusionListProjectCostsParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_project_costs',
  name: 'Oracle Fusion Project Management List Project Costs',
  description: "List project costs in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
  ...
  outputs: {
    items: { type: 'array', description: 'This page of cost records', items: { type: 'object', properties: oracleFusionCostOutput } },
