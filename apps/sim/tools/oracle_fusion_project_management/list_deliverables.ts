...
import type {
  OracleFusionListDeliverablesParams,
...
export const oracleFusionProjectManagementListDeliverablesTool: InternalToolConfig<
  OracleFusionListDeliverablesParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_deliverables',
  name: 'Oracle Fusion Project Management List Deliverables',
  description: "List deliverables in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
