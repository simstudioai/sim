...
> = {
  ...
  description: "List task labor resource assignments in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
  ...
  outputs: {
    items: { type: 'array', description: 'This page of labor Assignment records', items: { type: 'object', properties: oracleFusionLaborAssignmentOutput } },
