...
import type {
  OracleFusionListTaskStatusHistoryParams,
...
export const oracleFusionProjectManagementListTaskStatusHistoryTool: InternalToolConfig<
  OracleFusionListTaskStatusHistoryParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_task_status_history',
  name: 'Oracle Fusion Project Management List Task Status History',
  description:
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'This page of history records',
      items: { type: 'object', properties: oracleFusionHistoryOutput },
    },
