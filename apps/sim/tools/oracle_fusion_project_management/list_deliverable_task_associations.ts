...
import type {
  OracleFusionListDeliverableTaskAssociationsParams,
...
export const oracleFusionProjectManagementListDeliverableTaskAssociationsTool: InternalToolConfig<
  OracleFusionListDeliverableTaskAssociationsParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_deliverable_task_associations',
  name: 'Oracle Fusion Project Management List Deliverable Task Associations',
  description: "List deliverable task associations in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
