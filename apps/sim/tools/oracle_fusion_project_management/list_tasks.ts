...
export const oracleFusionProjectManagementListTasksTool: InternalToolConfig<
  OracleFusionListTasksParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_tasks',
  name: 'Oracle Fusion Project Management List Tasks',
  description: "List tasks in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
