...
import type {
  OracleFusionListProjectContractInvoicesParams,
...
export const oracleFusionProjectManagementListProjectContractInvoicesTool: InternalToolConfig<
  OracleFusionListProjectContractInvoicesParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_project_contract_invoices',
  name: 'Oracle Fusion Project Management List Project Contract Invoices',
  description: "List project contract invoices in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
