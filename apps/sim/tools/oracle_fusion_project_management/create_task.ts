...
export const oracleFusionProjectManagementCreateTaskTool: InternalToolConfig<
  OracleFusionCreateTaskParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_create_task',
  name: 'Oracle Fusion Project Management Create Task',
  description: "Create a task using projectPlans management access. Oracle lists task name, number, and level as required; its descriptions also note automatic number and level calculation.",
  version: '1.0.0',
