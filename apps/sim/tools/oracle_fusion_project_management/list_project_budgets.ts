...
import type {
  OracleFusionListProjectBudgetsParams,
...
export const oracleFusionProjectManagementListProjectBudgetsTool: InternalToolConfig<
  OracleFusionListProjectBudgetsParams,
  OracleFusionProjectManagementResponse
> = {
  id: 'oracle_fusion_project_management_list_project_budgets',
  name: 'Oracle Fusion Project Management List Project Budgets',
  description: "List project budgets in Oracle Fusion Cloud Project Management. Returns one bounded page, not an automatically drained collection.",
  version: '1.0.0',
  ...
  params: {
    ...
    projectId: {
      ...
      required: false,
      visibility: 'user-or-llm',
      description: "Filter by an exact project ID",
    },
  },
  operation: { input: createInternalToolOperationInput },
  outputs: {
    items: { type: 'array', description: 'This page of budget records', items: { type: 'object', properties: oracleFusionBudgetOutput } },
