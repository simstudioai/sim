...
export const oracleFusionBudgetResourceItemSchema = {
  type: 'object', additionalProperties: false, required: ['RbsElementId', 'TaskId'],
  properties: {
    RbsElementId: { type: 'string', description: 'Resource breakdown structure element ID', pattern: '^[1-9][0-9]{0,17}$' },
    TaskId: { type: 'string', description: 'Budget task ID', pattern: '^[1-9][0-9]{0,17}$' },
    PlanningStartDate: { type: 'string', format: 'date-time' },
    PlanningEndDate: { type: 'string', format: 'date-time' },
    PlanningAmounts: {
      type: 'array', maxItems: 100,
      items: {
        type: 'object', additionalProperties: false, required: ['Currency'],
        properties: {
          Currency: { type: 'string', minLength: 1, maxLength: 15 },
          Quantity: { type: 'number' },
          RawCostAmounts: { type: 'number' },
          BurdenedCostAmounts: { type: 'number' },
          RevenueAmounts: { type: 'number' },
        },
      },
    },
  },
...
export const oracleFusionProjectOutput = {
  ...
  ProjectDescription: { type: 'string', description: "Project Description", optional: true, nullable: true, },
  ProjectStatusCode: { type: 'string', description: "Project Status Code", optional: true, nullable: true, },
  ...
  ProjectEndDate: { type: 'string', description: "Project End Date", optional: true, nullable: true, },
  ProjectManagerEmail: { type: 'string', description: "Project Manager Email", optional: true, nullable: true, },
  ProjectManagerName: { type: 'string', description: "Project Manager Name", optional: true, nullable: true, },
  OwningOrganizationId: { type: 'string', description: "Owning Organization ID (exact decimal ID)", optional: true, },
  OwningOrganizationName: { type: 'string', description: "Owning Organization Name", optional: true, },
  BusinessUnitId: { type: 'string', description: "Business Unit ID (exact decimal ID)", optional: true, },
  BusinessUnitName: { type: 'string', description: "Business Unit Name", optional: true, },
  ProjectTypeId: { type: 'string', description: "Project Type ID (exact decimal ID)", optional: true, },
...
export const oracleFusionPlanOutput = {
  ...
  PercentComplete: { type: 'string', description: "Percent Complete (decimal text)", optional: true, nullable: true, },
  CurrencyCode: { type: 'string', description: "Currency Code", optional: true, },
  OrganizationId: { type: 'string', description: "Organization ID (exact decimal ID)", optional: true, },
  PrimaryProjectManagerName: { type: 'string', description: "Primary Project Manager Name", optional: true, },
  FinanciallyEnabledFlag: { type: 'boolean', description: "Financially Enabled Flag", optional: true, nullable: true, },
  ViewAccessCode: { type: 'string', description: "View Access Code", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionTaskOutput = {
  ...
  Description: { type: 'string', description: "Description", optional: true, nullable: true, },
  ParentTaskId: { type: 'string', description: "Parent Task ID (exact decimal ID)", optional: true, nullable: true, },
  MilestoneFlag: { type: 'boolean', description: "Milestone Flag", optional: true, nullable: true, },
  TaskStatusCode: { type: 'string', description: "Task Status Code", optional: true, nullable: true, },
  PhysicalPercentComplete: { type: 'string', description: "Physical Percent Complete (decimal text)", optional: true, nullable: true, },
  PercentComplete: { type: 'string', description: "Percent Complete (decimal text)", optional: true, nullable: true, },
  PlannedStartDateTime: { type: 'string', description: "Planned Start Date Time", optional: true, nullable: true, },
  PlannedFinishDateTime: { type: 'string', description: "Planned Finish Date Time", optional: true, nullable: true, },
  PlannedEffort: { type: 'string', description: "Planned Effort (decimal text)", optional: true, nullable: true, },
  PlannedDuration: { type: 'string', description: "Planned Duration (decimal text)", optional: true, nullable: true, },
  ActualStartDateTime: { type: 'string', description: "Actual Start Date Time", optional: true, nullable: true, },
  ActualFinishDateTime: { type: 'string', description: "Actual Finish Date Time", optional: true, nullable: true, },
  ActualHours: { type: 'string', description: "Actual Hours (decimal text)", optional: true, nullable: true, },
  PrimaryResourceName: { type: 'string', description: "Primary Resource Name", optional: true, },
  PrimaryResourceEmail: { type: 'string', description: "Primary Resource Email", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionDeliverableOutput = {
  ...
  OwnerId: { type: 'string', description: "Owner ID (exact decimal ID)", optional: true, nullable: true, },
...
export const oracleFusionAssociationOutput = {
  ...
  ProjectId: { type: 'string', description: "Project ID (exact decimal ID)", optional: true, nullable: true, },
...
export const oracleFusionTeamMemberOutput = {
  TeamMemberId: { type: 'string', description: "Team Member ID (exact decimal ID)", nullable: true, },
  ProjectId: { type: 'string', description: "Project ID (exact decimal ID)", optional: true, nullable: true, },
  PersonId: { type: 'string', description: "Person ID (exact decimal ID)", optional: true, nullable: true, },
  ...
  AssignmentTypeCode: { type: 'string', description: "Assignment Type Code", optional: true, nullable: true, },
  AssignmentType: { type: 'string', description: "Assignment Type", optional: true, nullable: true, },
  ResourceAllocationPercentage: { type: 'string', description: "Resource Allocation Percentage (decimal text)", optional: true, nullable: true, },
  ResourceAssignmentEffortInHours: { type: 'string', description: "Resource Assignment Effort In Hours (decimal text)", optional: true, nullable: true, },
  BillablePercent: { type: 'string', description: "Billable Percent", optional: true, nullable: true, },
  TrackTimeFlag: { type: 'boolean', description: "Track Time Flag", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionLaborAssignmentOutput = {
  TaskLaborResourceAssignmentId: { type: 'string', description: "Task Labor Resource Assignment ID (exact decimal ID)", },
  TaskId: { type: 'string', description: "Task ID (exact decimal ID)", optional: true, },
  LaborResourceId: { type: 'string', description: "Labor Resource ID (exact decimal ID)", optional: true, nullable: true, },
  ...
  PrimaryResourceFlag: { type: 'boolean', description: "Primary Resource Flag", optional: true, nullable: true, },
  ResourceAllocation: { type: 'string', description: "Resource Allocation (decimal text)", optional: true, nullable: true, },
  PlannedEffortinHours: { type: 'string', description: "Planned Effort in hours (decimal text)", optional: true, nullable: true, },
  ActualEffortinHours: { type: 'string', description: "Actual Effort in hours (decimal text)", optional: true, nullable: true, },
  RemainingEffortinHours: { type: 'string', description: "Remaining Effort in hours (decimal text)", optional: true, nullable: true, },
  PercentComplete: { type: 'string', description: "Percent Complete (decimal text)", optional: true, nullable: true, },
  ProgressStatus: { type: 'string', description: "Progress Status", optional: true, nullable: true, },
  EffectiveBillRate: { type: 'string', description: "Effective Bill Rate (decimal text)", optional: true, nullable: true, },
  EffectiveCostRate: { type: 'string', description: "Effective Cost Rate (decimal text)", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionResourceOutput = {
  ...
  ResourceEmail: { type: 'string', description: "Resource Email", optional: true, nullable: true, },
  PersonId: { type: 'string', description: "Person ID (exact decimal ID)", optional: true, nullable: true, },
  ResourceProjectPrimaryRole: { type: 'string', description: "Resource Project Primary Role", optional: true, },
...
export const oracleFusionCostOutput = {
  costKey: { type: 'string', description: 'Opaque key extracted from the credential-bound self link; not CostId' },
  ...
  ExpenditureOrganization: { type: 'string', description: "Expenditure Organization", optional: true, },
  Quantity: { type: 'string', description: "Quantity (decimal text)", optional: true, nullable: true, },
  UnitOfMeasureCode: { type: 'string', description: "Unit Of Measure Code", optional: true, nullable: true, },
  TransactionCurrency: { type: 'string', description: "Transaction Currency", optional: true, },
  RawCostInTransactionCurrency: { type: 'string', description: "Raw Cost In Transaction Currency (decimal text)", optional: true, nullable: true, },
  BurdenedCostInTransactionCurrency: { type: 'string', description: "Burdened Cost In Transaction Currency (decimal text)", optional: true, nullable: true, },
  RawCostInProjectCurrency: { type: 'string', description: "Raw Cost In Project Currency (decimal text)", optional: true, nullable: true, },
  BurdenedCostInProjectCurrency: { type: 'string', description: "Burdened Cost In Project Currency (decimal text)", optional: true, nullable: true, },
  BillableFlag: { type: 'boolean', description: "Billable Flag", optional: true, },
  CapitalizableFlag: { type: 'boolean', description: "Capitalizable Flag", optional: true, nullable: true, },
  HoldInvoiceFlag: { type: 'boolean', description: "Hold Invoice Flag", optional: true, },
  HoldRevenueFlag: { type: 'boolean', description: "Hold Revenue Flag", optional: true, nullable: true, },
  AccountingDate: { type: 'string', description: "Accounting Date", optional: true, nullable: true, },
  ...
  ExternalBillRate: { type: 'string', description: "External Bill Rate (decimal text)", optional: true, nullable: true, },
  ExternalBillRateCurrency: { type: 'string', description: "External Bill Rate Currency", optional: true, nullable: true, },
  IntercompanyBillRate: { type: 'string', description: "Intercompany Bill Rate (decimal text)", optional: true, nullable: true, },
  IntercompanyBillRateCurrency: { type: 'string', description: "Intercompany Bill Rate Currency", optional: true, nullable: true, },
  LastUpdateDate: { type: 'string', description: "Last Update Date", optional: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionBudgetOutput = {
  ...
  PlanVersionNumber: { type: 'string', description: "Plan Version Number (exact decimal ID)", optional: true, nullable: true, },
  PlanVersionDescription: { type: 'string', description: "Plan Version Description", optional: true, nullable: true, },
  PlanVersionStatus: { type: 'string', description: "Plan Version Status", optional: true, nullable: true, },
  ProjectId: { type: 'string', description: "Project ID (exact decimal ID)", optional: true, },
  ProjectName: { type: 'string', description: "Project Name", optional: true, },
  ProjectNumber: { type: 'string', description: "Project Number", optional: true, },
  FinancialPlanType: { type: 'string', description: "Financial Plan Type", optional: true, nullable: true, },
  PlanningAmounts: { type: 'string', description: "Planning Amounts", optional: true, nullable: true, },
  ...
  PCRawCostAmounts: { type: 'string', description: "PCRaw Cost Amounts (decimal text)", optional: true, nullable: true, },
  PCBurdenedCostAmounts: { type: 'string', description: "PCBurdened Cost Amounts (decimal text)", optional: true, nullable: true, },
  PCRevenueAmounts: { type: 'string', description: "PCRevenue Amounts (decimal text)", optional: true, nullable: true, },
  PFCRawCostAmounts: { type: 'string', description: "PFCRaw Cost Amounts (decimal text)", optional: true, nullable: true, },
  PFCBurdenedCostAmounts: { type: 'string', description: "PFCBurdened Cost Amounts (decimal text)", optional: true, nullable: true, },
  PFCRevenueAmounts: { type: 'string', description: "PFCRevenue Amounts (decimal text)", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionInvoiceOutput = {
  ...
  InvoiceNumber: { type: 'string', description: "Invoice Number (exact decimal ID)", optional: true, },
  ...
  InvoiceTypeCode: { type: 'string', description: "Invoice Type Code", optional: true, nullable: true, },
  InvoiceTypeMeaning: { type: 'string', description: "Invoice Type Meaning", optional: true, },
  InvoiceAmount: { type: 'string', description: "Invoice Amount (decimal text)", optional: true, nullable: true, },
  TaxAmount: { type: 'string', description: "Tax Amount (decimal text)", optional: true, nullable: true, },
  ...
  ProjectNumber: { type: 'string', description: "Project Number", optional: true, nullable: true, },
  OrganizationId: { type: 'string', description: "Organization ID (exact decimal ID)", optional: true, },
  OrganizationName: { type: 'string', description: "Organization Name", optional: true, nullable: true, },
  InvoiceComment: { type: 'string', description: "Invoice Comment", optional: true, nullable: true, },
  InvoiceInstructions: { type: 'string', description: "Invoice Instructions", optional: true, nullable: true, },
  ReceivablesNumber: { type: 'string', description: "Receivables Number", optional: true, nullable: true, },
  ...
  TransferredDate: { type: 'string', description: "Transferred Date", optional: true, nullable: true, },
...
export const oracleFusionStatusOutput = {
  ...
  StatusClassificationCode: { type: 'string', description: "Status Classification Code", optional: true, },
  ...
  WorkflowEnabledFlag: { type: 'boolean', description: "Workflow Enabled Flag", optional: true, nullable: true, },
} as const satisfies Record<string, ToolOutputProperty>
...
export const oracleFusionHistoryOutput = {
  ...
  StatusChangeComments: { type: 'string', description: "Status Change Comments", optional: true, nullable: true, },
  CreationDate: { type: 'string', description: "Creation Date", optional: true, },
  LastUpdateDate: { type: 'string', description: "Last Update Date", optional: true, },
} as const satisfies Record<string, ToolOutputProperty>
