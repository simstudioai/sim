...
export const sailpointListRolesTool: ToolConfig<SailPointListParams, SailPointListResponse> = {
  id: 'sailpoint_list_roles',
  name: 'SailPoint List Roles',
  description: 'List roles in SailPoint with optional filters, sorters, and pagination.',
  version: '1.0.0',
