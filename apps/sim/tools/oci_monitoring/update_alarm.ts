import {
  ...
  type OciMonitoringUpdateAlarmParams,
...
export const ociMonitoringUpdateAlarmTool: InternalToolConfig<
  OciMonitoringUpdateAlarmParams,
  OciMonitoringResponse
> = {
  id: 'oci_monitoring_update_alarm',
  name: 'OCI Monitoring Update Alarm',
  description: 'Update supplied alarm fields using an optional ETag',
  version: '1.0.0',
  params: {
