...
export const oracleFusionFinancialsListPayablesAvailablePrepaymentsTool: InternalToolConfig<
  OracleFusionFinancialsInvoiceChildListParams,
  OracleFusionFinancialsListResponse
> = {
  id: 'oracle_fusion_financials_list_payables_available_prepayments',
  name: 'Oracle Fusion Financials List Payables Available Prepayments',
  description: 'List one page of prepayments available to apply to a Payables invoice.',
  version: '1.0.0',
  params: {
    ...oracleFusionFinancialsAuthParamFields,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Available prepayments in this page',
      items: { type: 'object', properties: oracleFusionAvailablePrepaymentOutputProperties },
    },
