...
export const oracleFusionFinancialsListPayablesPaymentsTool: InternalToolConfig<
  OracleFusionFinancialsListParams,
  OracleFusionFinancialsListResponse
> = {
  id: 'oracle_fusion_financials_list_payables_payments',
  name: 'Oracle Fusion Financials List Payables Payments',
  description: 'List one page of Oracle Fusion Payables payments using a fixed safe projection.',
  version: '1.0.0',
  params: {
    ...oracleFusionFinancialsAuthParamFields,
    ...oracleFusionFinancialsListParamFields,
  ...
  outputs: {
    items: {
      type: 'array',
      description: 'Payables payments in this page',
      items: { type: 'object', properties: oracleFusionPaymentOutputProperties },
    },
