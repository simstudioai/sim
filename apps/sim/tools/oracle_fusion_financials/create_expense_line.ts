...
import type {
  OracleFusionFinancialsCreateExpenseLineParams,
  OracleFusionFinancialsDetailResponse,
} from '@/tools/oracle_fusion_financials/types'
import type { InternalToolConfig } from '@/tools/types'

export const oracleFusionFinancialsCreateExpenseLineTool: InternalToolConfig<
  OracleFusionFinancialsCreateExpenseLineParams,
  OracleFusionFinancialsDetailResponse<'expenseLine'>
> = {
  id: 'oracle_fusion_financials_create_expense_line',
  name: 'Oracle Fusion Financials Create Expense Line',
  description: 'Create an Oracle Fusion expense line.',
  version: '1.0.0',
  params: {
    ...oracleFusionFinancialsAuthParamFields,
    expenseReportUniqId: {
