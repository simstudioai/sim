...
import type {
  ...
  OracleFusionFinancialsGetReceivablesInvoiceInstallmentParams,
} from '@/tools/oracle_fusion_financials/types'
import type { InternalToolConfig } from '@/tools/types'

export const oracleFusionFinancialsGetReceivablesInvoiceInstallmentTool: InternalToolConfig<
  OracleFusionFinancialsGetReceivablesInvoiceInstallmentParams,
...
> = {
  ...
  name: 'Oracle Fusion Financials Get Receivables Invoice Installment',
  description: 'Get Oracle Fusion receivables invoice installment.',
  version: '1.0.0',
  params: {
    ...oracleFusionFinancialsAuthParamFields,
