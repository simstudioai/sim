...
import type {
  OciDevopsListDeployArtifactsParams,
  OciDevopsResponse,
} from '@/tools/oci_devops/types'
import type { InternalToolConfig } from '@/tools/types'

export const ociDevopsListDeployArtifactsTool: InternalToolConfig<
  OciDevopsListDeployArtifactsParams,
  OciDevopsResponse
> = {
  id: 'oci_devops_list_deploy_artifacts',
  name: 'OCI DevOps List Deploy Artifacts',
  description: 'List Deploy Artifacts in OCI DevOps',
  version: '1.0.0',
  params: {
    oauthCredential: {
      type: 'string',
    ...
    lifecycleState: {
      ...
      visibility: 'user-or-llm',
      description:
        'A filter to return only DeployArtifacts that matches the given lifecycleState. Allowed: CREATING, UPDATING, ACTIVE, DELETING, DELETED, FAILED.',
    },
    displayName: {
      type: 'string',
      required: false,
