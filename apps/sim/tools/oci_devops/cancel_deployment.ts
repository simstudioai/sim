...
import type { OciDevopsCancelDeploymentParams, OciDevopsResponse } from '@/tools/oci_devops/types'
import type { InternalToolConfig } from '@/tools/types'

export const ociDevopsCancelDeploymentTool: InternalToolConfig<
  OciDevopsCancelDeploymentParams,
  OciDevopsResponse
> = {
  id: 'oci_devops_cancel_deployment',
  name: 'OCI DevOps Cancel Deployment',
  description: 'Cancel Deployment in OCI DevOps',
  version: '1.0.0',
  params: {
    oauthCredential: {
      type: 'string',
