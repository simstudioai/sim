...
import type { OciDevopsListBuildPipelinesParams, OciDevopsResponse } from '@/tools/oci_devops/types'
import type { InternalToolConfig } from '@/tools/types'

export const ociDevopsListBuildPipelinesTool: InternalToolConfig<
  OciDevopsListBuildPipelinesParams,
  OciDevopsResponse
> = {
  id: 'oci_devops_list_build_pipelines',
  name: 'OCI DevOps List Build Pipelines',
  description: 'List Build Pipelines in OCI DevOps',
  version: '1.0.0',
  params: {
    oauthCredential: {
      type: 'string',
    ...
    lifecycleState: {
      ...
      visibility: 'user-or-llm',
      description:
        'A filter to return only build pipelines that matches the given lifecycle state. Allowed: CREATING, UPDATING, ACTIVE, INACTIVE, DELETING, DELETED, FAILED.',
    },
    displayName: {
      type: 'string',
      required: false,
