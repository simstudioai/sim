...
import type {
  OciDevopsListDeployPipelinesParams,
  OciDevopsResponse,
} from '@/tools/oci_devops/types'
import type { InternalToolConfig } from '@/tools/types'

export const ociDevopsListDeployPipelinesTool: InternalToolConfig<
  OciDevopsListDeployPipelinesParams,
  OciDevopsResponse
> = {
  id: 'oci_devops_list_deploy_pipelines',
  name: 'OCI DevOps List Deploy Pipelines',
  description: 'List Deploy Pipelines in OCI DevOps',
  version: '1.0.0',
  params: {
    oauthCredential: {
      type: 'string',
    ...
    lifecycleState: {
      ...
      visibility: 'user-or-llm',
      description:
        'A filter to return only DeployPipelines that matches the given lifecycleState. Allowed: CREATING, UPDATING, ACTIVE, INACTIVE, DELETING, DELETED, FAILED.',
    },
    displayName: {
      type: 'string',
      required: false,
