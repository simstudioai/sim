...
> = {
  ...
  params: {
    ...
    orderBy: {
      ...
      visibility: 'user-or-llm',
      description:
        'Field and direction for sorting (e.g., LastName ASC) Bare field API names only, optionally with ASC/DESC and NULLS FIRST/LAST; SOQL functions such as DISTANCE() are not accepted here — use the Salesforce Query tool for those.',
    },
  },
