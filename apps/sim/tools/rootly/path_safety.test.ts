 ...
 *
 * Guards every Rootly tool against path traversal through an LLM-writable
...
import * as toolModule from '@/tools/rootly/index'
...
const LEGITIMATE = [
  '2f9c1e3a-7b64-4d51-9c8f-1a2b3c4d5e6f',
  '12345',
  'INC-2024-001',
  '..foo',
  'foo..',
