...
export const ORACLE_FUSION_LEARNING_SELF_PACED_ITEM_OUTPUT_PROPERTIES = {
  ...
  learningItemVisibility: {
    type: 'string',
    description: 'Learning Item Visibility',
    nullable: true,
  },
  learningItemDescription: {
    type: 'string',
    description: 'Learning Item Description',
    nullable: true,
  },
  learningItemCatalogProfileId: {
    type: 'string',
    description: 'Learning Item Catalog Profile Id',
    nullable: true,
  },
  learningItemCatalogProfileNumber: {
    type: 'string',
    description: 'Learning Item Catalog Profile Number',
    nullable: true,
  },
  learningItemExpectedEffortInSeconds: {
    type: 'number',
    description: 'Learning Item Expected Effort In Seconds',
    nullable: true,
  },
  learningItemPublishStartDate: {
    type: 'string',
    description: 'Learning Item Publish Start Date',
    nullable: true,
  },
  learningItemPublishEndDate: {
    type: 'string',
    description: 'Learning Item Publish End Date',
    nullable: true,
  },
  learningItemEnrollmentStartDate: {
    type: 'string',
    description: 'Learning Item Enrollment Start Date',
    nullable: true,
  },
  learningItemEnrollmentEndDate: {
    type: 'string',
    description: 'Learning Item Enrollment End Date',
    nullable: true,
  },
  learningItemLastModifiedDate: {
    type: 'string',
    description: 'Learning Item Last Modified Date',
    nullable: true,
  },
  learningItemActiveDate: {
    type: 'string',
    description: 'Learning Item Active Date',
    nullable: true,
  },
  learningItemInactiveDate: {
    type: 'string',
    description: 'Learning Item Inactive Date',
    nullable: true,
  },
  learningItemProvider: { type: 'string', description: 'Learning Item Provider', nullable: true },
  learningItemProviderType: {
    type: 'string',
    description: 'Learning Item Provider Type',
    nullable: true,
  },
  learningItemDraftExists: {
    type: 'string',
    description: 'Learning Item Draft Exists',
    nullable: true,
  },
  learningItemPublishedExists: {
    type: 'string',
    description: 'Learning Item Published Exists',
    nullable: true,
  },
} satisfies Record<string, ToolOutputProperty>
...
export const ORACLE_FUSION_LEARNING_EVENT_ACTIVITY_OUTPUT_PROPERTIES = {
  ...
  expectedEffortInSeconds: {
    type: 'number',
    description: 'Expected Effort In Seconds',
    nullable: true,
  },
  ...
  enableAttendanceProcessing: {
    type: 'string',
    description: 'Enable Attendance Processing',
    nullable: true,
  },
...
export const ORACLE_FUSION_LEARNING_LEARNING_RECORD_OUTPUT_PROPERTIES = {
  ...
  assignmentRecordNumber: {
    type: 'string',
    description: 'Assignment Record Number',
    nullable: true,
  },
  ...
  assignmentLastModifiedDate: {
    type: 'string',
    description: 'Assignment Last Modified Date',
    nullable: true,
  },
} satisfies Record<string, ToolOutputProperty>
...
export const ORACLE_FUSION_LEARNING_SELECTED_COURSE_OFFERING_OUTPUT_PROPERTIES = {
  ...
  offeringAvailableCapacity: {
    type: 'number',
    description: 'Offering Available Capacity',
    nullable: true,
  },
  currentWaitlistPosition: {
    type: 'number',
    description: 'Current Waitlist Position',
    nullable: true,
  },
} satisfies Record<string, ToolOutputProperty>
...
export const ORACLE_FUSION_LEARNING_COMPLETION_DETAIL_OUTPUT_PROPERTIES = {
  ...
  activityAttemptActualScore: {
    type: 'number',
    description: 'Activity Attempt Actual Score',
    nullable: true,
  },
  activityAttemptActualEffort: {
    type: 'number',
    description: 'Activity Attempt Actual Effort',
    nullable: true,
  },
  ...
  activityLearnerMarkCompl: {
    type: 'string',
    description: 'Activity Learner Mark Compl',
    nullable: true,
  },
  activityLearnerRecordAttendance: {
    type: 'string',
    description: 'Activity Learner Record Attendance',
    nullable: true,
  },
  activityStartDatetimeUTC: {
    type: 'string',
    description: 'Activity Start Datetime U T C',
    nullable: true,
  },
  activityEndDatetimeUTC: {
    type: 'string',
    description: 'Activity End Datetime U T C',
    nullable: true,
  },
  activityTimeZone: { type: 'string', description: 'Activity Time Zone', nullable: true },
  activityAttemptComplDate: {
    type: 'string',
    description: 'Activity Attempt Compl Date',
    nullable: true,
  },
} satisfies Record<string, ToolOutputProperty>
...
export const ORACLE_FUSION_LEARNING_COMPLETION_SUMMARY_OUTPUT_PROPERTIES = {
  ...
  activitySectionsTotalActivitiesCount: {
    type: 'number',
    description: 'Activity Sections Total Activities Count',
    nullable: true,
  },
  ...
  completionRequirementUnits: {
    type: 'string',
    description: 'Completion Requirement Units',
    nullable: true,
  },
  completionRequirementUnitsMeaning: {
    type: 'string',
    description: 'Completion Requirement Units Meaning',
    nullable: true,
  },
...
export const ORACLE_FUSION_LEARNING_ACTION_HINTS_OUTPUT_PROPERTIES = {
  ...
  canEditAssignmentHint: {
    type: 'string',
    description: 'Can Edit Assignment Hint',
    nullable: true,
  },
  canManageLearningItem: {
    type: 'string',
    description: 'Can Manage Learning Item',
    nullable: true,
  },
  canRecommendLearningItem: {
    type: 'string',
    description: 'Can Recommend Learning Item',
    nullable: true,
  },
  canRetakeLearningItem: {
    type: 'string',
    description: 'Can Retake Learning Item',
    nullable: true,
  },
  dataSecurityPrivilege: { type: 'string', description: 'Data Security Privilege', nullable: true },
  isWithdrawApprovalEnabled: {
    type: 'string',
    description: 'Is Withdraw Approval Enabled',
    nullable: true,
  },
...
export const ORACLE_FUSION_LEARNING_ENROLLMENT_HISTORY_OUTPUT_PROPERTIES = {
  enrollmentHistoryOrderId: {
    type: 'number',
    description: 'Enrollment History Order Id',
    nullable: true,
  },
  enrollmentHistoryStatusMessage: {
    type: 'string',
    description: 'Enrollment History Status Message',
    nullable: true,
  },
} satisfies Record<string, ToolOutputProperty>
...
export const ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_OUTPUT_PROPERTIES = {
  ...
  assignmentProfileNumber: {
    type: 'string',
    description: 'Assignment Profile Number',
    nullable: true,
  },
  assignmentProfileTitle: {
    type: 'string',
    description: 'Assignment Profile Title',
    nullable: true,
  },
  assignmentProfileDescription: {
    type: 'string',
  ...
  assignmentProfileStatus: {
    type: 'string',
    description: 'Assignment Profile Status',
    nullable: true,
  },
  assignmentProfileStartDate: {
    type: 'string',
    description: 'Assignment Profile Start Date',
    nullable: true,
  },
  assignmentProfileEndDate: {
    type: 'string',
    description: 'Assignment Profile End Date',
    nullable: true,
  },
  learningItemId: { type: 'string', description: 'Learning Item Id', nullable: true },
  learningItemNumber: { type: 'string', description: 'Learning Item Number', nullable: true },
  ...
  targetAssignmentStatus: {
    type: 'string',
    description: 'Target Assignment Status',
    nullable: true,
  },
  assignmentRecordStatus: {
    type: 'string',
    description: 'Assignment Record Status',
    nullable: true,
  },
  assignmentDueDate: { type: 'string', description: 'Assignment Due Date', nullable: true },
  assignmentDueDateType: {
    type: 'string',
    description: 'Assignment Due Date Type',
    nullable: true,
  },
...
export const ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_RECORD_OUTPUT_PROPERTIES = {
  ...
  assignmentStatusMeaning: {
    type: 'string',
    description: 'Assignment Status Meaning',
    nullable: true,
  },
  assignmentType: { type: 'string', description: 'Assignment Type', nullable: true },
  assignmentProcessingStatus: {
    type: 'string',
    description: 'Assignment Processing Status',
    nullable: true,
  },
  assignmentProcessingStatusMeaning: {
    type: 'string',
    description: 'Assignment Processing Status Meaning',
    nullable: true,
  },
  learningItemId: { type: 'string', description: 'Learning Item Id', nullable: true },
...
export const ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_CRITERION_OUTPUT_PROPERTIES = {
  ...
  assignmentProfileCriteriaType: {
    type: 'string',
    description: 'Assignment Profile Criteria Type',
    nullable: true,
  },
  assignmentProfileCriteriaTypeMeaning: {
    type: 'string',
    description: 'Assignment Profile Criteria Type Meaning',
    nullable: true,
  },
  assignmentProfileCriteriaTypeId: {
    type: 'string',
    description: 'Assignment Profile Criteria Type Id',
    nullable: true,
  },
  assignmentProfileCriteriaTypeNumber: {
    type: 'string',
    description: 'Assignment Profile Criteria Type Number',
    nullable: true,
  },
  assignmentProfileCriteriaSourceName: {
    type: 'string',
    description: 'Assignment Profile Criteria Source Name',
    nullable: true,
  },
  assignmentProfileCriteriaCount: {
    type: 'number',
    description: 'Assignment Profile Criteria Count',
    nullable: true,
  },
  assignmentProfileId: { type: 'string', description: 'Assignment Profile Id', nullable: true },
...
export const ORACLE_FUSION_LEARNING_LEARNING_ITEM_AUDIENCE_OUTPUT_PROPERTIES = {
  ...
  sourceTypeDisplayName: {
    type: 'string',
    description: 'Source Type Display Name',
    nullable: true,
  },
...
export type ListSelfPacedItemsParams = Omit<
  z.input<typeof Schemas.list_self_paced_itemsSchema>,
...
export const ORACLE_FUSION_LEARNING_LIST_SELF_PACED_ITEMS_OUTPUTS = {
  items: {
    type: 'array',
    description: 'Requested page of Learning records',
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_SELF_PACED_ITEM_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type GetSelfPacedItemParams = Omit<
  z.input<typeof Schemas.get_self_paced_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_GET_SELF_PACED_ITEM_OUTPUTS = {
  item: {
    type: 'object',
    description: 'Safe Learning resource projection',
    properties: ORACLE_FUSION_LEARNING_SELF_PACED_ITEM_OUTPUT_PROPERTIES,
  },
} satisfies Record<string, ToolOutputProperty>

export type CreateSelfPacedItemParams = Omit<
  z.input<typeof Schemas.create_self_paced_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateSelfPacedItemParams = Omit<
  z.input<typeof Schemas.update_self_paced_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type DeleteSelfPacedItemParams = Omit<
  z.input<typeof Schemas.delete_self_paced_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListLearningEventsParams = Omit<
  z.input<typeof Schemas.list_learning_eventsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_LEARNING_EVENTS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_LEARNING_EVENT_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type GetLearningEventParams = Omit<
  z.input<typeof Schemas.get_learning_eventSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type CreateLearningEventParams = Omit<
  z.input<typeof Schemas.create_learning_eventSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateLearningEventParams = Omit<
  z.input<typeof Schemas.update_learning_eventSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListEventActivitiesParams = Omit<
  z.input<typeof Schemas.list_event_activitiesSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_EVENT_ACTIVITIES_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_EVENT_ACTIVITY_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type CreateEventActivityParams = Omit<
  z.input<typeof Schemas.create_event_activitySchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateEventActivityParams = Omit<
  z.input<typeof Schemas.update_event_activitySchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type DeleteEventActivityParams = Omit<
  z.input<typeof Schemas.delete_event_activitySchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListLearningRecordsParams = Omit<
  z.input<typeof Schemas.list_learning_recordsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_LEARNING_RECORDS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_LEARNING_RECORD_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type GetLearningRecordParams = Omit<
  z.input<typeof Schemas.get_learning_recordSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type CreateLearningRecordParams = Omit<
  z.input<typeof Schemas.create_learning_recordSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateLearningRecordParams = Omit<
  z.input<typeof Schemas.update_learning_recordSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListSelectedCourseOfferingsParams = Omit<
  z.input<typeof Schemas.list_selected_course_offeringsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_SELECTED_COURSE_OFFERINGS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_SELECTED_COURSE_OFFERING_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type SelectCourseOfferingParams = Omit<
  z.input<typeof Schemas.select_course_offeringSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateSelectedCourseOfferingParams = Omit<
  z.input<typeof Schemas.update_selected_course_offeringSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListCompletionDetailsParams = Omit<
  z.input<typeof Schemas.list_completion_detailsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_COMPLETION_DETAILS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_COMPLETION_DETAIL_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type UpdateCompletionDetailParams = Omit<
  z.input<typeof Schemas.update_completion_detailSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListCompletionSummariesParams = Omit<
  z.input<typeof Schemas.list_completion_summariesSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_COMPLETION_SUMMARIES_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_COMPLETION_SUMMARY_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type ListLearningRecordActionHintsParams = Omit<
  z.input<typeof Schemas.list_learning_record_action_hintsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_LEARNING_RECORD_ACTION_HINTS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_ACTION_HINTS_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type ListEnrollmentHistoryParams = Omit<
  z.input<typeof Schemas.list_enrollment_historySchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_ENROLLMENT_HISTORY_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_ENROLLMENT_HISTORY_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type ListAssignmentProfilesParams = Omit<
  z.input<typeof Schemas.list_assignment_profilesSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_ASSIGNMENT_PROFILES_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type GetAssignmentProfileParams = Omit<
  z.input<typeof Schemas.get_assignment_profileSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type CreateAssignmentProfileParams = Omit<
  z.input<typeof Schemas.create_assignment_profileSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateAssignmentProfileParams = Omit<
  z.input<typeof Schemas.update_assignment_profileSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ProcessAssignmentProfileParams = Omit<
  z.input<typeof Schemas.process_assignment_profileSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListAssignmentProfileRecordsParams = Omit<
  z.input<typeof Schemas.list_assignment_profile_recordsSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_ASSIGNMENT_PROFILE_RECORDS_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_RECORD_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type ListAssignmentProfileCriteriaParams = Omit<
  z.input<typeof Schemas.list_assignment_profile_criteriaSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_ASSIGNMENT_PROFILE_CRITERIA_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_ASSIGNMENT_PROFILE_CRITERION_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type AddAssignmentProfileCriterionParams = Omit<
  z.input<typeof Schemas.add_assignment_profile_criterionSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type RemoveAssignmentProfileCriterionParams = Omit<
  z.input<typeof Schemas.remove_assignment_profile_criterionSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type ListLearningItemAudiencesParams = Omit<
  z.input<typeof Schemas.list_learning_item_audiencesSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_LIST_LEARNING_ITEM_AUDIENCES_OUTPUTS = {
  items: {
    ...
    items: {
      type: 'object',
      properties: ORACLE_FUSION_LEARNING_LEARNING_ITEM_AUDIENCE_OUTPUT_PROPERTIES,
    },
  },
  ...ORACLE_FUSION_LEARNING_PAGINATION_OUTPUT_PROPERTIES,
} satisfies Record<string, ToolOutputProperty>

export type AddLearningItemAudienceParams = Omit<
  z.input<typeof Schemas.add_learning_item_audienceSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type RemoveLearningItemAudienceParams = Omit<
  z.input<typeof Schemas.remove_learning_item_audienceSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type GetContentItemParams = Omit<
  z.input<typeof Schemas.get_content_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export const ORACLE_FUSION_LEARNING_GET_CONTENT_ITEM_OUTPUTS = {
  item: {
    type: 'object',
    description: 'Safe Learning resource projection',
    properties: ORACLE_FUSION_LEARNING_CONTENT_ITEM_OUTPUT_PROPERTIES,
  },
} satisfies Record<string, ToolOutputProperty>

export type CreateWebLinkContentParams = Omit<
  z.input<typeof Schemas.create_web_link_contentSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
...
export type UpdateContentItemParams = Omit<
  z.input<typeof Schemas.update_content_itemSchema>,
  'accessToken' | 'instanceUrl'
> & {
  oauthCredential: string
  accessToken?: string
