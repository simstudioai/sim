...
/**
 * Bright Data Walmart Seller dataset tool.
 */
export const datasetWalmartSellerTool: ToolConfig<DatasetParams, DatasetResponse> = {
  id: 'brightdata_dataset_walmart_seller',
  name: 'Bright Data Walmart Seller Dataset',
