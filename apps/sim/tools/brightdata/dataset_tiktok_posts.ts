...
/**
 * Bright Data Tiktok Posts dataset tool.
 */
export const datasetTiktokPostsTool: ToolConfig<DatasetParams, DatasetResponse> = {
  id: 'brightdata_dataset_tiktok_posts',
  name: 'Bright Data Tiktok Posts Dataset',
  description:
