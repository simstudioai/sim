...
/**
 * Bright Data Instagram Profiles dataset tool.
 */
export const datasetInstagramProfilesTool: ToolConfig<DatasetParams, DatasetResponse> = {
  id: 'brightdata_dataset_instagram_profiles',
  name: 'Bright Data Instagram Profiles Dataset',
