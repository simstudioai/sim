...
/**
 * Bright Data Tiktok Profiles dataset tool.
 */
export const datasetTiktokProfilesTool: ToolConfig<DatasetParams, DatasetResponse> = {
  id: 'brightdata_dataset_tiktok_profiles',
  name: 'Bright Data Tiktok Profiles Dataset',
  description:
