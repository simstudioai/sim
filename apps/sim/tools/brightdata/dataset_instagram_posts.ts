...
/**
 * Bright Data Instagram Posts dataset tool.
 */
export const datasetInstagramPostsTool: ToolConfig<DatasetParams, DatasetResponse> = {
  id: 'brightdata_dataset_instagram_posts',
  name: 'Bright Data Instagram Posts Dataset',
  description:
