import type { ClockifyReportAttendanceParams, ClockifyReportAttendanceResponse } from '@/tools/clockify/types'
import type { ToolConfig } from '@/tools/types'

export const clockifyReportAttendanceTool: ToolConfig<
  ClockifyReportAttendanceParams,
  ClockifyReportAttendanceResponse
> = {
  id: 'clockify_report_attendance',
  name: 'Clockify Attendance Report',
  description: 'Generate an attendance report for a workspace with optional user and project filters',
  version: '1.0.0',
  ...
  request: {
    url: (params) =>
      `https://reports.api.clockify.me/v1/workspaces/${params.workspaceId}/reports/attendance`,
    method: 'POST',
    headers: (params) => ({
  ...
  outputs: {
    attendance: {
      type: 'json',
      description: 'Attendance report records',
    },
  },
}
