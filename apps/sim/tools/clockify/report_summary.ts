import type { ClockifyReportSummaryParams, ClockifyReportSummaryResponse } from '@/tools/clockify/types'
import type { ToolConfig } from '@/tools/types'

export const clockifyReportSummaryTool: ToolConfig<
  ClockifyReportSummaryParams,
  ClockifyReportSummaryResponse
> = {
  id: 'clockify_report_summary',
  name: 'Clockify Summary Report',
  description: 'Generate a summary report for a workspace with optional user and project filters',
  version: '1.0.0',
  ...
  request: {
    url: (params) =>
      `https://reports.api.clockify.me/v1/workspaces/${params.workspaceId}/reports/summary`,
    method: 'POST',
    headers: (params) => ({
  ...
  outputs: {
    groups: {
      type: 'json',
      description: 'Summary report groups',
    },
    totals: {
      type: 'json',
      description: 'Summary report totals',
    },
  },
}
