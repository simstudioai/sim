import type { ClockifyReportDetailedParams, ClockifyReportDetailedResponse } from '@/tools/clockify/types'
import type { ToolConfig } from '@/tools/types'

export const clockifyReportDetailedTool: ToolConfig<
  ClockifyReportDetailedParams,
  ClockifyReportDetailedResponse
> = {
  id: 'clockify_report_detailed',
  name: 'Clockify Detailed Report',
  description: 'Generate a detailed time entry report for a workspace with optional user and project filters',
  version: '1.0.0',
  ...
  request: {
    url: (params) =>
      `https://reports.api.clockify.me/v1/workspaces/${params.workspaceId}/reports/detailed`,
    method: 'POST',
    headers: (params) => ({
  ...
  outputs: {
    ...
    totals: {
      type: 'json',
      description: 'Detailed report totals',
    },
  },
}
