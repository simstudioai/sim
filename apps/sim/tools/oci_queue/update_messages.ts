import {
  ...
  OCI_QUEUE_ENTRIES_OUTPUT,
  OCI_QUEUE_REQUEST_ID_OUTPUT,
  OCI_QUEUE_SERVER_FAILURES_OUTPUT,
  OCI_QUEUE_STATUS_OUTPUT,
  type OciQueueResponse,
  type OciQueueUpdateMessagesParams,
} from '@/tools/oci_queue/types'
import { transformOciQueueResponse } from '@/tools/oci_queue/utils'
import type { InternalToolConfig } from '@/tools/types'

export const ociQueueUpdateMessagesTool: InternalToolConfig<
  OciQueueUpdateMessagesParams,
  OciQueueResponse
> = {
  id: 'oci_queue_update_messages',
  name: 'OCI Queue Update Messages',
  description:
  ...
  outputs: {
    ...
    entries: OCI_QUEUE_ENTRIES_OUTPUT,
