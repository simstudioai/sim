import type { NetlifyGetDeployParams, NetlifyGetDeployResponse } from '@/tools/netlify/types'
...
export const netlifyGetDeployTool: ToolConfig<NetlifyGetDeployParams, NetlifyGetDeployResponse> = {
  id: 'netlify_get_deploy',
  name: 'Netlify Get Deploy',
  ...
  request: {
    url: (params: NetlifyGetDeployParams) =>
      `https://api.netlify.com/api/v1/deploys/${encodeURIComponent(params.deployId.trim())}`,
    method: 'GET',
    headers: (params: NetlifyGetDeployParams) => ({
