...
import {
  ORACLE_FUSION_HCM_UPDATE_TIME_ENTRY_OUTPUTS,
  type OracleFusionHcmUpdateTimeEntryParams,
  type OracleFusionHcmUpdateTimeEntryResponse,
} from '@/tools/oracle_fusion_hcm/types'
import type { InternalToolConfig } from '@/tools/types'

export const oracleFusionHcmUpdateTimeEntryTool: InternalToolConfig<
  OracleFusionHcmUpdateTimeEntryParams,
  OracleFusionHcmUpdateTimeEntryResponse
> = {
  ...
  outputs: ORACLE_FUSION_HCM_UPDATE_TIME_ENTRY_OUTPUTS,
}
