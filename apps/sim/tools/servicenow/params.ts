...
export const inputDisplayValueParam: ServiceNowParams = {
  inputDisplayValue: {
    ...
    visibility: 'user-or-llm',
    description:
      'Set to true to write display names into reference fields (e.g., assigned_to: "Beth Anglin") and let ServiceNow resolve them to sys_ids. Defaults to false, meaning reference fields must be sys_ids.',
  },
}
