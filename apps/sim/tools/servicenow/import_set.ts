...
export const importSetTool: ToolConfig<
  ServiceNowImportSetParams,
  ServiceNowImportSetResponse
> = {
  ...
  params: {
    ...
    records: {
      ...
      required: true,
      visibility: 'user-or-llm',
      description: 'Array of records to import. Each record should be a JSON object with field values.',
    },
    transformMap: {
      type: 'string',
      required: false,
  ...
  outputs: {
    ...
    metadata: {
      type: 'json',
      description: 'Import metadata including counts of inserted, updated, ignored, and error records',
    },
  },
}
