...
export const oracleEpmAccountReconciliationArchiveMatchedTransactionsTool: InternalToolConfig<
  OracleEpmAccountReconciliationArchiveMatchedTransactionsParams,
  OracleEpmAccountReconciliationResponse
> = {
  id: 'oracle_epm_account_reconciliation_archive_matched_transactions',
  name: 'Oracle EPM Account Reconciliation Archive Matched Transactions',
  description:
