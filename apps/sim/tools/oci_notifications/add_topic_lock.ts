import {
  ...
  type OciNotificationsAddTopicLockParams,
...
export const ociNotificationsAddTopicLockTool: InternalToolConfig<
  OciNotificationsAddTopicLockParams,
  OciNotificationsResponse
> = {
  id: 'oci_notifications_add_topic_lock',
  name: 'OCI Notifications Add Topic Lock',
  description: 'Add a FULL or DELETE topic lock using Oracle resource-lock permissions.',
  version: '1.0.0',
  params: {
    oauthCredential: {
      type: 'string',
