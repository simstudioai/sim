...
/** Contract: https://docs.oracle.com/en/cloud/saas/enterprise-performance-management-common/prest/rules.html */
export const oracleEpmPlanningRunRuleTool: InternalToolConfig<
  OracleEpmPlanningRunRuleParams,
  OracleEpmPlanningResponse
> = {
  id: 'oracle_epm_planning_run_rule',
  name: 'Oracle EPM Planning Run Rule',
  description:
