import {
  type OciComputeListVolumeAttachmentsParams,
...
export const ociComputeListVolumeAttachmentsTool: InternalToolConfig<
  OciComputeListVolumeAttachmentsParams,
  OciComputeResponse
> = {
  id: 'oci_compute_list_volume_attachments',
  name: 'OCI Compute List Volume Attachments',
  description: 'List volume attachments in OCI',
  version: '1.0.0',
  ...
  outputs: {
    ...
    volumeAttachments: {
      type: 'array',
      description: 'Volume Attachments information returned by OCI',
      items: { type: 'object', properties: VOLUME_ATTACHMENT_OUTPUT_PROPERTIES },
    },
  },
}
