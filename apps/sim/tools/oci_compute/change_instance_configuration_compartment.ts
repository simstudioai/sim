import {
  type OciComputeChangeInstanceConfigurationCompartmentParams,
  type OciComputeResponse,
  ociComputeOperationInput,
} from '@/tools/oci_compute/types'
import type { InternalToolConfig } from '@/tools/types'

export const ociComputeChangeInstanceConfigurationCompartmentTool: InternalToolConfig<
  OciComputeChangeInstanceConfigurationCompartmentParams,
  OciComputeResponse
> = {
  id: 'oci_compute_change_instance_configuration_compartment',
  name: 'OCI Compute Change Instance Configuration Compartment',
  description: 'Change instance configuration compartment in OCI',
  version: '1.0.0',
