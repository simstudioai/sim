...
import {
  ociLoggingCreateLogGroupTool,
  ociLoggingCreateLogTool,
  ociLoggingDeleteLogGroupTool,
  ociLoggingDeleteLogTool,
  ociLoggingGetLogGroupTool,
  ociLoggingGetLogTool,
  ociLoggingGetSavedSearchTool,
  ociLoggingGetWorkRequestTool,
  ociLoggingListLogGroupsTool,
  ociLoggingListLogsTool,
  ociLoggingListSavedSearchesTool,
  ociLoggingListWorkRequestErrorsTool,
  ociLoggingPutLogsTool,
  ociLoggingSearchLogsTool,
  ociLoggingUpdateLogGroupTool,
  ociLoggingUpdateLogTool,
} from '@/tools/oci_logging'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oci_logging_create_log: ociLoggingCreateLogTool,
  oci_logging_create_log_group: ociLoggingCreateLogGroupTool,
  oci_logging_delete_log: ociLoggingDeleteLogTool,
  oci_logging_delete_log_group: ociLoggingDeleteLogGroupTool,
  oci_logging_get_log: ociLoggingGetLogTool,
  oci_logging_get_log_group: ociLoggingGetLogGroupTool,
  oci_logging_get_saved_search: ociLoggingGetSavedSearchTool,
  oci_logging_get_work_request: ociLoggingGetWorkRequestTool,
  oci_logging_list_log_groups: ociLoggingListLogGroupsTool,
  oci_logging_list_logs: ociLoggingListLogsTool,
  oci_logging_list_saved_searches: ociLoggingListSavedSearchesTool,
  oci_logging_list_work_request_errors: ociLoggingListWorkRequestErrorsTool,
  oci_logging_put_logs: ociLoggingPutLogsTool,
  oci_logging_search_logs: ociLoggingSearchLogsTool,
  oci_logging_update_log: ociLoggingUpdateLogTool,
  oci_logging_update_log_group: ociLoggingUpdateLogGroupTool,
