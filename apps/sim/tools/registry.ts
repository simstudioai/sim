...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oci_vision_analyze_image: ociVisionAnalyzeImageTool,
  oci_vision_cancel_image_job: ociVisionCancelImageJobTool,
  oci_vision_create_image_job: ociVisionCreateImageJobTool,
  oci_vision_download_image_job_output: ociVisionDownloadImageJobOutputTool,
  oci_vision_get_image_job: ociVisionGetImageJobTool,
  oci_vision_get_model: ociVisionGetModelTool,
  oci_vision_get_project: ociVisionGetProjectTool,
  oci_vision_list_image_job_outputs: ociVisionListImageJobOutputsTool,
  oci_vision_list_models: ociVisionListModelsTool,
  oci_vision_list_projects: ociVisionListProjectsTool,
