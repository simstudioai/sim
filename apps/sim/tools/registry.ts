...
import {
  ociQueueChangeQueueCompartmentTool,
  ociQueueCreateQueueTool,
  ociQueueDeleteMessagesTool,
  ociQueueDeleteMessageTool,
  ociQueueDeleteQueueTool,
  ociQueueGetMessagesTool,
  ociQueueGetQueueTool,
  ociQueueGetStatsTool,
  ociQueueGetWorkRequestTool,
  ociQueueListChannelsTool,
  ociQueueListQueuesTool,
  ociQueueListWorkRequestErrorsTool,
  ociQueueListWorkRequestLogsTool,
  ociQueueListWorkRequestsTool,
  ociQueuePurgeQueueTool,
  ociQueuePutMessagesTool,
  ociQueueUpdateMessagesTool,
  ociQueueUpdateMessageTool,
  ociQueueUpdateQueueTool,
} from '@/tools/oci_queue'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oci_queue_change_queue_compartment: ociQueueChangeQueueCompartmentTool,
  oci_queue_create_queue: ociQueueCreateQueueTool,
  oci_queue_delete_message: ociQueueDeleteMessageTool,
  oci_queue_delete_messages: ociQueueDeleteMessagesTool,
  oci_queue_delete_queue: ociQueueDeleteQueueTool,
  oci_queue_get_messages: ociQueueGetMessagesTool,
  oci_queue_get_queue: ociQueueGetQueueTool,
  oci_queue_get_stats: ociQueueGetStatsTool,
  oci_queue_get_work_request: ociQueueGetWorkRequestTool,
  oci_queue_list_channels: ociQueueListChannelsTool,
  oci_queue_list_queues: ociQueueListQueuesTool,
  oci_queue_list_work_request_errors: ociQueueListWorkRequestErrorsTool,
  oci_queue_list_work_request_logs: ociQueueListWorkRequestLogsTool,
  oci_queue_list_work_requests: ociQueueListWorkRequestsTool,
  oci_queue_purge_queue: ociQueuePurgeQueueTool,
  oci_queue_put_messages: ociQueuePutMessagesTool,
  oci_queue_update_message: ociQueueUpdateMessageTool,
  oci_queue_update_messages: ociQueueUpdateMessagesTool,
  oci_queue_update_queue: ociQueueUpdateQueueTool,
