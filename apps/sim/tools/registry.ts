...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_fusion_hcm_get_absence: oracleFusionHcmGetAbsenceTool,
  oracle_fusion_hcm_get_worker: oracleFusionHcmGetWorkerTool,
  oracle_fusion_hcm_get_worker_assignment: oracleFusionHcmGetWorkerAssignmentTool,
  oracle_fusion_hcm_list_absence_types: oracleFusionHcmListAbsenceTypesTool,
  oracle_fusion_hcm_list_absences: oracleFusionHcmListAbsencesTool,
  oracle_fusion_hcm_list_business_units: oracleFusionHcmListBusinessUnitsTool,
  oracle_fusion_hcm_list_departments: oracleFusionHcmListDepartmentsTool,
  oracle_fusion_hcm_list_grades: oracleFusionHcmListGradesTool,
  oracle_fusion_hcm_list_job_families: oracleFusionHcmListJobFamiliesTool,
  oracle_fusion_hcm_list_jobs: oracleFusionHcmListJobsTool,
  oracle_fusion_hcm_list_legal_employers: oracleFusionHcmListLegalEmployersTool,
  oracle_fusion_hcm_list_locations: oracleFusionHcmListLocationsTool,
  oracle_fusion_hcm_list_person_types: oracleFusionHcmListPersonTypesTool,
  oracle_fusion_hcm_list_positions: oracleFusionHcmListPositionsTool,
  oracle_fusion_hcm_list_worker_assignments: oracleFusionHcmListWorkerAssignmentsTool,
  oracle_fusion_hcm_list_worker_direct_reports: oracleFusionHcmListWorkerDirectReportsTool,
  oracle_fusion_hcm_list_worker_managers: oracleFusionHcmListWorkerManagersTool,
  oracle_fusion_hcm_list_workers: oracleFusionHcmListWorkersTool,
  oracle_fusion_hcm_list_payroll_relationships: oracleFusionHcmListPayrollRelationshipsTool,
  oracle_fusion_hcm_get_payroll_relationship: oracleFusionHcmGetPayrollRelationshipTool,
  oracle_fusion_hcm_list_payroll_assignments: oracleFusionHcmListPayrollAssignmentsTool,
  oracle_fusion_hcm_get_payroll_assignment: oracleFusionHcmGetPayrollAssignmentTool,
  oracle_fusion_hcm_list_assigned_payrolls: oracleFusionHcmListAssignedPayrollsTool,
  oracle_fusion_hcm_get_assigned_payroll: oracleFusionHcmGetAssignedPayrollTool,
  oracle_fusion_hcm_create_assigned_payroll: oracleFusionHcmCreateAssignedPayrollTool,
  oracle_fusion_hcm_update_assigned_payroll: oracleFusionHcmUpdateAssignedPayrollTool,
  oracle_fusion_hcm_list_payroll_definitions: oracleFusionHcmListPayrollDefinitionsTool,
  oracle_fusion_hcm_list_payroll_time_periods: oracleFusionHcmListPayrollTimePeriodsTool,
  oracle_fusion_hcm_list_payroll_element_definitions: oracleFusionHcmListPayrollElementDefinitionsTool,
  oracle_fusion_hcm_list_payroll_input_values: oracleFusionHcmListPayrollInputValuesTool,
  oracle_fusion_hcm_list_element_entries: oracleFusionHcmListElementEntriesTool,
  oracle_fusion_hcm_get_element_entry: oracleFusionHcmGetElementEntryTool,
  oracle_fusion_hcm_list_element_entry_values: oracleFusionHcmListElementEntryValuesTool,
  oracle_fusion_hcm_create_element_entry: oracleFusionHcmCreateElementEntryTool,
  oracle_fusion_hcm_update_element_entry_value: oracleFusionHcmUpdateElementEntryValueTool,
  oracle_fusion_hcm_list_person_process_results: oracleFusionHcmListPersonProcessResultsTool,
  oracle_fusion_hcm_get_person_process_result: oracleFusionHcmGetPersonProcessResultTool,
  oracle_fusion_hcm_list_payroll_run_results: oracleFusionHcmListPayrollRunResultsTool,
  oracle_fusion_hcm_list_payroll_balances: oracleFusionHcmListPayrollBalancesTool,
  oracle_fusion_hcm_list_salaries: oracleFusionHcmListSalariesTool,
  oracle_fusion_hcm_get_salary: oracleFusionHcmGetSalaryTool,
  oracle_fusion_hcm_create_salary: oracleFusionHcmCreateSalaryTool,
  oracle_fusion_hcm_correct_salary: oracleFusionHcmCorrectSalaryTool,
  oracle_fusion_hcm_list_salary_bases: oracleFusionHcmListSalaryBasesTool,
  oracle_fusion_hcm_list_salary_components: oracleFusionHcmListSalaryComponentsTool,
  oracle_fusion_hcm_list_grade_rate_values: oracleFusionHcmListGradeRateValuesTool,
  oracle_fusion_hcm_list_goal_plans: oracleFusionHcmListGoalPlansTool,
  oracle_fusion_hcm_get_goal_plan: oracleFusionHcmGetGoalPlanTool,
  oracle_fusion_hcm_list_performance_goals: oracleFusionHcmListPerformanceGoalsTool,
  oracle_fusion_hcm_get_performance_goal: oracleFusionHcmGetPerformanceGoalTool,
  oracle_fusion_hcm_list_development_goals: oracleFusionHcmListDevelopmentGoalsTool,
  oracle_fusion_hcm_get_development_goal: oracleFusionHcmGetDevelopmentGoalTool,
  oracle_fusion_hcm_list_performance_documents: oracleFusionHcmListPerformanceDocumentsTool,
  oracle_fusion_hcm_get_performance_document: oracleFusionHcmGetPerformanceDocumentTool,
  oracle_fusion_hcm_list_performance_document_roles: oracleFusionHcmListPerformanceDocumentRolesTool,
  oracle_fusion_hcm_list_performance_document_participants: oracleFusionHcmListPerformanceDocumentParticipantsTool,
  oracle_fusion_hcm_list_performance_document_tasks: oracleFusionHcmListPerformanceDocumentTasksTool,
  oracle_fusion_hcm_list_talent_profiles: oracleFusionHcmListTalentProfilesTool,
  oracle_fusion_hcm_get_talent_profile: oracleFusionHcmGetTalentProfileTool,
  oracle_fusion_hcm_list_talent_profile_sections: oracleFusionHcmListTalentProfileSectionsTool,
  oracle_fusion_hcm_list_talent_profile_skills: oracleFusionHcmListTalentProfileSkillsTool,
  oracle_fusion_hcm_list_talent_profile_certifications: oracleFusionHcmListTalentProfileCertificationsTool,
  oracle_fusion_hcm_list_time_records: oracleFusionHcmListTimeRecordsTool,
  oracle_fusion_hcm_get_time_record: oracleFusionHcmGetTimeRecordTool,
  oracle_fusion_hcm_list_time_cards: oracleFusionHcmListTimeCardsTool,
  oracle_fusion_hcm_get_time_card: oracleFusionHcmGetTimeCardTool,
  oracle_fusion_hcm_list_time_attributes: oracleFusionHcmListTimeAttributesTool,
  oracle_fusion_hcm_list_time_attribute_data_sources: oracleFusionHcmListTimeAttributeDataSourcesTool,
  oracle_fusion_hcm_list_time_attribute_criteria_binds: oracleFusionHcmListTimeAttributeCriteriaBindsTool,
  oracle_fusion_hcm_list_time_attribute_values: oracleFusionHcmListTimeAttributeValuesTool,
  oracle_fusion_hcm_create_time_entry: oracleFusionHcmCreateTimeEntryTool,
  oracle_fusion_hcm_update_time_entry: oracleFusionHcmUpdateTimeEntryTool,
  oracle_fusion_hcm_delete_time_entry: oracleFusionHcmDeleteTimeEntryTool,
  oracle_fusion_hcm_get_time_record_request: oracleFusionHcmGetTimeRecordRequestTool,
  oracle_fusion_hcm_list_time_record_request_events: oracleFusionHcmListTimeRecordRequestEventsTool,
  oracle_fusion_hcm_list_time_record_event_messages: oracleFusionHcmListTimeRecordEventMessagesTool,
