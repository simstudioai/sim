...
import {
  oracleEpmPlatformAddUsersToGroupTool,
  oracleEpmPlatformAssignRoleTool,
  oracleEpmPlatformCreateGroupsTool,
  oracleEpmPlatformCreateUsersTool,
  oracleEpmPlatformDeleteFileTool,
  oracleEpmPlatformDeleteGroupsTool,
  oracleEpmPlatformDeleteUsersTool,
  oracleEpmPlatformDownloadFileTool,
  oracleEpmPlatformExportSnapshotTool,
  oracleEpmPlatformGetAdminJobStatusTool,
  oracleEpmPlatformGetEnvironmentInfoTool,
  oracleEpmPlatformGetIdleSessionTimeoutTool,
  oracleEpmPlatformGetRestrictedDataAccessTool,
  oracleEpmPlatformGetRoleAssignmentsTool,
  oracleEpmPlatformGetSnapshotTool,
  oracleEpmPlatformGetUploadVirusScanTool,
  oracleEpmPlatformGetUserGroupReportTool,
  oracleEpmPlatformImportSnapshotTool,
  oracleEpmPlatformListFilesTool,
  oracleEpmPlatformListGroupsTool,
  oracleEpmPlatformListMigrationsTool,
  oracleEpmPlatformListRolesTool,
  oracleEpmPlatformListUsersTool,
  oracleEpmPlatformRemoveUsersFromGroupTool,
  oracleEpmPlatformRenameSnapshotTool,
  oracleEpmPlatformRunDailyMaintenanceTool,
  oracleEpmPlatformSetIdleSessionTimeoutTool,
  oracleEpmPlatformSetMaintenanceWindowTool,
  oracleEpmPlatformSetRestrictedDataAccessTool,
  oracleEpmPlatformSetUploadVirusScanTool,
  oracleEpmPlatformUnassignRoleTool,
  oracleEpmPlatformUpdateUsersTool,
  oracleEpmPlatformUploadRepositoryFileTool,
  oracleEpmPlatformUploadSnapshotTool,
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_epm_platform_add_users_to_group: oracleEpmPlatformAddUsersToGroupTool,
  oracle_epm_platform_assign_role: oracleEpmPlatformAssignRoleTool,
  oracle_epm_platform_create_groups: oracleEpmPlatformCreateGroupsTool,
  oracle_epm_platform_create_users: oracleEpmPlatformCreateUsersTool,
  oracle_epm_platform_delete_file: oracleEpmPlatformDeleteFileTool,
  oracle_epm_platform_delete_groups: oracleEpmPlatformDeleteGroupsTool,
  oracle_epm_platform_delete_users: oracleEpmPlatformDeleteUsersTool,
  oracle_epm_platform_download_file: oracleEpmPlatformDownloadFileTool,
  oracle_epm_platform_export_snapshot: oracleEpmPlatformExportSnapshotTool,
  oracle_epm_platform_get_admin_job_status: oracleEpmPlatformGetAdminJobStatusTool,
  oracle_epm_platform_get_environment_info: oracleEpmPlatformGetEnvironmentInfoTool,
  oracle_epm_platform_get_idle_session_timeout: oracleEpmPlatformGetIdleSessionTimeoutTool,
  oracle_epm_platform_get_restricted_data_access: oracleEpmPlatformGetRestrictedDataAccessTool,
  oracle_epm_platform_get_role_assignments: oracleEpmPlatformGetRoleAssignmentsTool,
  oracle_epm_platform_get_snapshot: oracleEpmPlatformGetSnapshotTool,
  oracle_epm_platform_get_upload_virus_scan: oracleEpmPlatformGetUploadVirusScanTool,
  oracle_epm_platform_get_user_group_report: oracleEpmPlatformGetUserGroupReportTool,
  oracle_epm_platform_import_snapshot: oracleEpmPlatformImportSnapshotTool,
  oracle_epm_platform_list_files: oracleEpmPlatformListFilesTool,
  oracle_epm_platform_list_groups: oracleEpmPlatformListGroupsTool,
  oracle_epm_platform_list_migrations: oracleEpmPlatformListMigrationsTool,
  oracle_epm_platform_list_roles: oracleEpmPlatformListRolesTool,
  oracle_epm_platform_list_users: oracleEpmPlatformListUsersTool,
  oracle_epm_platform_remove_users_from_group: oracleEpmPlatformRemoveUsersFromGroupTool,
  oracle_epm_platform_rename_snapshot: oracleEpmPlatformRenameSnapshotTool,
  oracle_epm_platform_run_daily_maintenance: oracleEpmPlatformRunDailyMaintenanceTool,
  oracle_epm_platform_set_idle_session_timeout: oracleEpmPlatformSetIdleSessionTimeoutTool,
  oracle_epm_platform_set_maintenance_window: oracleEpmPlatformSetMaintenanceWindowTool,
  oracle_epm_platform_set_restricted_data_access: oracleEpmPlatformSetRestrictedDataAccessTool,
  oracle_epm_platform_set_upload_virus_scan: oracleEpmPlatformSetUploadVirusScanTool,
  oracle_epm_platform_unassign_role: oracleEpmPlatformUnassignRoleTool,
  oracle_epm_platform_update_users: oracleEpmPlatformUpdateUsersTool,
  oracle_epm_platform_upload_repository_file: oracleEpmPlatformUploadRepositoryFileTool,
  oracle_epm_platform_upload_snapshot: oracleEpmPlatformUploadSnapshotTool,
