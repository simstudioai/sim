...
import {
  oracleEpmFccsAddMemberTool,
  oracleEpmFccsClearDataProfileTool,
  oracleEpmFccsClearDataSliceTool,
  oracleEpmFccsCopyDataProfileTool,
  oracleEpmFccsDeleteFileTool,
  oracleEpmFccsDownloadFileTool,
  oracleEpmFccsExecuteJobTool,
  oracleEpmFccsExportApplicationDataTool,
  oracleEpmFccsExportConsolidationRulesetsTool,
  oracleEpmFccsExportDataSliceTool,
  oracleEpmFccsExportJobConsoleTool,
  oracleEpmFccsExportJournalsTool,
  oracleEpmFccsExportMetadataTool,
  oracleEpmFccsGenerateIntercompanyReportTool,
  oracleEpmFccsGetChildJobDetailsTool,
  oracleEpmFccsGetDimensionTool,
  oracleEpmFccsGetJobDetailsTool,
  oracleEpmFccsGetJobTool,
  oracleEpmFccsGetMemberTool,
  oracleEpmFccsImportApplicationDataTool,
  oracleEpmFccsImportConsolidationRulesetsTool,
  oracleEpmFccsImportDataSliceTool,
  oracleEpmFccsImportExchangeRatesTool,
  oracleEpmFccsImportJournalsTool,
  oracleEpmFccsImportMetadataTool,
  oracleEpmFccsListApplicationsTool,
  oracleEpmFccsListCubesTool,
  oracleEpmFccsListDimensionsTool,
  oracleEpmFccsListFilesTool,
  oracleEpmFccsListJobDefinitionsTool,
  oracleEpmFccsListJournalsTool,
  oracleEpmFccsPerformJournalActionTool,
  oracleEpmFccsRunConsolidationTool,
  oracleEpmFccsRunRulesetTool,
  oracleEpmFccsRunRuleTool,
  oracleEpmFccsRunTranslationTool,
  oracleEpmFccsUpdateJournalPeriodTool,
  oracleEpmFccsUploadFileTool,
  oracleEpmFccsValidateMetadataTool,
  oracleEpmFccsWaitForJobTool,
} from '@/tools/oracle_epm_fccs'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_epm_fccs_list_applications: oracleEpmFccsListApplicationsTool,
  oracle_epm_fccs_list_cubes: oracleEpmFccsListCubesTool,
  oracle_epm_fccs_list_dimensions: oracleEpmFccsListDimensionsTool,
  oracle_epm_fccs_get_dimension: oracleEpmFccsGetDimensionTool,
  oracle_epm_fccs_get_member: oracleEpmFccsGetMemberTool,
  oracle_epm_fccs_add_member: oracleEpmFccsAddMemberTool,
  oracle_epm_fccs_validate_metadata: oracleEpmFccsValidateMetadataTool,
  oracle_epm_fccs_list_job_definitions: oracleEpmFccsListJobDefinitionsTool,
  oracle_epm_fccs_execute_job: oracleEpmFccsExecuteJobTool,
  oracle_epm_fccs_run_rule: oracleEpmFccsRunRuleTool,
  oracle_epm_fccs_run_ruleset: oracleEpmFccsRunRulesetTool,
  oracle_epm_fccs_run_consolidation: oracleEpmFccsRunConsolidationTool,
  oracle_epm_fccs_run_translation: oracleEpmFccsRunTranslationTool,
  oracle_epm_fccs_get_job: oracleEpmFccsGetJobTool,
  oracle_epm_fccs_wait_for_job: oracleEpmFccsWaitForJobTool,
  oracle_epm_fccs_get_job_details: oracleEpmFccsGetJobDetailsTool,
  oracle_epm_fccs_get_child_job_details: oracleEpmFccsGetChildJobDetailsTool,
  oracle_epm_fccs_export_job_console: oracleEpmFccsExportJobConsoleTool,
  oracle_epm_fccs_export_data_slice: oracleEpmFccsExportDataSliceTool,
  oracle_epm_fccs_import_data_slice: oracleEpmFccsImportDataSliceTool,
  oracle_epm_fccs_clear_data_slice: oracleEpmFccsClearDataSliceTool,
  oracle_epm_fccs_clear_data_profile: oracleEpmFccsClearDataProfileTool,
  oracle_epm_fccs_copy_data_profile: oracleEpmFccsCopyDataProfileTool,
  oracle_epm_fccs_export_application_data: oracleEpmFccsExportApplicationDataTool,
  oracle_epm_fccs_import_application_data: oracleEpmFccsImportApplicationDataTool,
  oracle_epm_fccs_import_exchange_rates: oracleEpmFccsImportExchangeRatesTool,
  oracle_epm_fccs_export_metadata: oracleEpmFccsExportMetadataTool,
  oracle_epm_fccs_import_metadata: oracleEpmFccsImportMetadataTool,
  oracle_epm_fccs_list_journals: oracleEpmFccsListJournalsTool,
  oracle_epm_fccs_perform_journal_action: oracleEpmFccsPerformJournalActionTool,
  oracle_epm_fccs_update_journal_period: oracleEpmFccsUpdateJournalPeriodTool,
  oracle_epm_fccs_export_journals: oracleEpmFccsExportJournalsTool,
  oracle_epm_fccs_import_journals: oracleEpmFccsImportJournalsTool,
  oracle_epm_fccs_generate_intercompany_report: oracleEpmFccsGenerateIntercompanyReportTool,
  oracle_epm_fccs_export_consolidation_rulesets: oracleEpmFccsExportConsolidationRulesetsTool,
  oracle_epm_fccs_import_consolidation_rulesets: oracleEpmFccsImportConsolidationRulesetsTool,
  oracle_epm_fccs_list_files: oracleEpmFccsListFilesTool,
  oracle_epm_fccs_upload_file: oracleEpmFccsUploadFileTool,
  oracle_epm_fccs_download_file: oracleEpmFccsDownloadFileTool,
  oracle_epm_fccs_delete_file: oracleEpmFccsDeleteFileTool,
