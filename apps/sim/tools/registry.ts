...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  table_list_folders: tableListFoldersTool,
  table_create_folder: tableCreateFolderTool,
  table_update_folder: tableUpdateFolderTool,
  table_delete_folder: tableDeleteFolderTool,
  table_restore_folder: tableRestoreFolderTool,
  table_move: tableMoveTool,
