...
import {
  oracleEpmPlanningAddMemberTool,
  oracleEpmPlanningChangePlanningUnitStatusTool,
  oracleEpmPlanningClearDataSliceTool,
  oracleEpmPlanningDeleteFileTool,
  oracleEpmPlanningDeleteSubstitutionVariableTool,
  oracleEpmPlanningDownloadFileTool,
  oracleEpmPlanningExportApplicationDataTool,
  oracleEpmPlanningExportDataSliceTool,
  oracleEpmPlanningExportFormDataTool,
  oracleEpmPlanningGetDimensionTool,
  oracleEpmPlanningGetInsightsTool,
  oracleEpmPlanningGetJobDetailsTool,
  oracleEpmPlanningGetJobTool,
  oracleEpmPlanningGetMemberTool,
  oracleEpmPlanningGetPlanningUnitActionsTool,
  oracleEpmPlanningGetPlanningUnitHistoryTool,
  oracleEpmPlanningGetSubstitutionVariableTool,
  oracleEpmPlanningImportApplicationDataTool,
  oracleEpmPlanningImportDataSliceTool,
  oracleEpmPlanningListApplicationsTool,
  oracleEpmPlanningListCubesTool,
  oracleEpmPlanningListDimensionsTool,
  oracleEpmPlanningListFilesTool,
  oracleEpmPlanningListJobDefinitionsTool,
  oracleEpmPlanningListPlanningUnitsTool,
  oracleEpmPlanningListSubstitutionVariablesTool,
  oracleEpmPlanningListUserVariableValuesTool,
  oracleEpmPlanningRefreshCubeTool,
  oracleEpmPlanningRunDataMapTool,
  oracleEpmPlanningRunJobTool,
  oracleEpmPlanningRunRulesetTool,
  oracleEpmPlanningRunRuleTool,
  oracleEpmPlanningSetAdministrationModeTool,
  oracleEpmPlanningSetSubstitutionVariablesTool,
  oracleEpmPlanningSetUserVariableValuesTool,
  oracleEpmPlanningSummarizeInsightsTool,
  oracleEpmPlanningUploadFileTool,
  oracleEpmPlanningWaitForJobTool,
} from '@/tools/oracle_epm_planning'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_epm_planning_add_member: oracleEpmPlanningAddMemberTool,
  oracle_epm_planning_change_planning_unit_status: oracleEpmPlanningChangePlanningUnitStatusTool,
  oracle_epm_planning_clear_data_slice: oracleEpmPlanningClearDataSliceTool,
  oracle_epm_planning_delete_file: oracleEpmPlanningDeleteFileTool,
  oracle_epm_planning_delete_substitution_variable: oracleEpmPlanningDeleteSubstitutionVariableTool,
  oracle_epm_planning_download_file: oracleEpmPlanningDownloadFileTool,
  oracle_epm_planning_export_application_data: oracleEpmPlanningExportApplicationDataTool,
  oracle_epm_planning_export_data_slice: oracleEpmPlanningExportDataSliceTool,
  oracle_epm_planning_export_form_data: oracleEpmPlanningExportFormDataTool,
  oracle_epm_planning_get_dimension: oracleEpmPlanningGetDimensionTool,
  oracle_epm_planning_get_insights: oracleEpmPlanningGetInsightsTool,
  oracle_epm_planning_get_job_details: oracleEpmPlanningGetJobDetailsTool,
  oracle_epm_planning_get_job: oracleEpmPlanningGetJobTool,
  oracle_epm_planning_get_member: oracleEpmPlanningGetMemberTool,
  oracle_epm_planning_get_planning_unit_actions: oracleEpmPlanningGetPlanningUnitActionsTool,
  oracle_epm_planning_get_planning_unit_history: oracleEpmPlanningGetPlanningUnitHistoryTool,
  oracle_epm_planning_get_substitution_variable: oracleEpmPlanningGetSubstitutionVariableTool,
  oracle_epm_planning_import_application_data: oracleEpmPlanningImportApplicationDataTool,
  oracle_epm_planning_import_data_slice: oracleEpmPlanningImportDataSliceTool,
  oracle_epm_planning_list_applications: oracleEpmPlanningListApplicationsTool,
  oracle_epm_planning_list_cubes: oracleEpmPlanningListCubesTool,
  oracle_epm_planning_list_dimensions: oracleEpmPlanningListDimensionsTool,
  oracle_epm_planning_list_files: oracleEpmPlanningListFilesTool,
  oracle_epm_planning_list_job_definitions: oracleEpmPlanningListJobDefinitionsTool,
  oracle_epm_planning_list_planning_units: oracleEpmPlanningListPlanningUnitsTool,
  oracle_epm_planning_list_substitution_variables: oracleEpmPlanningListSubstitutionVariablesTool,
  oracle_epm_planning_list_user_variable_values: oracleEpmPlanningListUserVariableValuesTool,
  oracle_epm_planning_refresh_cube: oracleEpmPlanningRefreshCubeTool,
  oracle_epm_planning_run_data_map: oracleEpmPlanningRunDataMapTool,
  oracle_epm_planning_run_job: oracleEpmPlanningRunJobTool,
  oracle_epm_planning_run_rule: oracleEpmPlanningRunRuleTool,
  oracle_epm_planning_run_ruleset: oracleEpmPlanningRunRulesetTool,
  oracle_epm_planning_set_administration_mode: oracleEpmPlanningSetAdministrationModeTool,
  oracle_epm_planning_set_substitution_variables: oracleEpmPlanningSetSubstitutionVariablesTool,
  oracle_epm_planning_set_user_variable_values: oracleEpmPlanningSetUserVariableValuesTool,
  oracle_epm_planning_summarize_insights: oracleEpmPlanningSummarizeInsightsTool,
  oracle_epm_planning_upload_file: oracleEpmPlanningUploadFileTool,
  oracle_epm_planning_wait_for_job: oracleEpmPlanningWaitForJobTool,
