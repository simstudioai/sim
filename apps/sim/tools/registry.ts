...
import {
  oraclePcmApplyDataGrantsTool,
  oraclePcmClearPovTool,
  oraclePcmCopyPovTool,
  oraclePcmCreateApplicationTool,
  oraclePcmDeployCubeTool,
  oraclePcmDownloadFileTool,
  oraclePcmEnableApplicationTool,
  oraclePcmExportQueryResultsTool,
  oraclePcmGenerateProgramDocumentationTool,
  oraclePcmGetRuleBalancingTool,
  oraclePcmGetTaskStatusTool,
  oraclePcmImportTemplateTool,
  oraclePcmListFilesTool,
  oraclePcmLoadDataTool,
  oraclePcmMergeSlicesTool,
  oraclePcmOptimizeCubeTool,
  oraclePcmRunCalculationTool,
  oraclePcmUpdateDimensionsTool,
  oraclePcmUploadFileTool,
  oraclePcmWaitForTaskTool,
} from '@/tools/oracle_epm_profitability'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_epm_profitability_apply_data_grants: oraclePcmApplyDataGrantsTool,
  oracle_epm_profitability_clear_pov: oraclePcmClearPovTool,
  oracle_epm_profitability_copy_pov: oraclePcmCopyPovTool,
  oracle_epm_profitability_create_application: oraclePcmCreateApplicationTool,
  oracle_epm_profitability_deploy_cube: oraclePcmDeployCubeTool,
  oracle_epm_profitability_download_file: oraclePcmDownloadFileTool,
  oracle_epm_profitability_enable_application: oraclePcmEnableApplicationTool,
  oracle_epm_profitability_export_query_results: oraclePcmExportQueryResultsTool,
  oracle_epm_profitability_generate_program_documentation:
    oraclePcmGenerateProgramDocumentationTool,
  oracle_epm_profitability_get_rule_balancing: oraclePcmGetRuleBalancingTool,
  oracle_epm_profitability_get_task_status: oraclePcmGetTaskStatusTool,
  oracle_epm_profitability_import_template: oraclePcmImportTemplateTool,
  oracle_epm_profitability_list_files: oraclePcmListFilesTool,
  oracle_epm_profitability_load_data: oraclePcmLoadDataTool,
  oracle_epm_profitability_merge_slices: oraclePcmMergeSlicesTool,
  oracle_epm_profitability_optimize_cube: oraclePcmOptimizeCubeTool,
  oracle_epm_profitability_run_calculation: oraclePcmRunCalculationTool,
  oracle_epm_profitability_update_dimensions: oraclePcmUpdateDimensionsTool,
  oracle_epm_profitability_upload_file: oraclePcmUploadFileTool,
  oracle_epm_profitability_wait_for_task: oraclePcmWaitForTaskTool,
