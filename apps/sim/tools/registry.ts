...
import {
  oracleEpmDataDeleteFileTool,
  oracleEpmDataDownloadFileTool,
  oracleEpmDataExecuteReportTool,
  oracleEpmDataExportDataIntegrationTool,
  oracleEpmDataExportMappingsTool,
  oracleEpmDataGetConnectionTool,
  oracleEpmDataGetJobStatusTool,
  oracleEpmDataGetPipelineDetailsTool,
  oracleEpmDataGetPovStatusTool,
  oracleEpmDataImportDataIntegrationTool,
  oracleEpmDataImportMappingsTool,
  oracleEpmDataListConnectionsTool,
  oracleEpmDataListFilesTool,
  oracleEpmDataRunBatchTool,
  oracleEpmDataRunDataRuleTool,
  oracleEpmDataRunIntegrationTool,
  oracleEpmDataRunPipelineTool,
  oracleEpmDataSetPovLockTool,
  oracleEpmDataUpdateConnectionTool,
  oracleEpmDataUploadFileTool,
} from '@/tools/oracle_epm_data'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_epm_data_delete_file: oracleEpmDataDeleteFileTool,
  oracle_epm_data_download_file: oracleEpmDataDownloadFileTool,
  oracle_epm_data_execute_report: oracleEpmDataExecuteReportTool,
  oracle_epm_data_export_data_integration: oracleEpmDataExportDataIntegrationTool,
  oracle_epm_data_export_mappings: oracleEpmDataExportMappingsTool,
  oracle_epm_data_get_connection: oracleEpmDataGetConnectionTool,
  oracle_epm_data_get_job_status: oracleEpmDataGetJobStatusTool,
  oracle_epm_data_get_pipeline_details: oracleEpmDataGetPipelineDetailsTool,
  oracle_epm_data_get_pov_status: oracleEpmDataGetPovStatusTool,
  oracle_epm_data_import_data_integration: oracleEpmDataImportDataIntegrationTool,
  oracle_epm_data_import_mappings: oracleEpmDataImportMappingsTool,
  oracle_epm_data_list_connections: oracleEpmDataListConnectionsTool,
  oracle_epm_data_list_files: oracleEpmDataListFilesTool,
  oracle_epm_data_run_batch: oracleEpmDataRunBatchTool,
  oracle_epm_data_run_data_rule: oracleEpmDataRunDataRuleTool,
  oracle_epm_data_run_integration: oracleEpmDataRunIntegrationTool,
  oracle_epm_data_run_pipeline: oracleEpmDataRunPipelineTool,
  oracle_epm_data_set_pov_lock: oracleEpmDataSetPovLockTool,
  oracle_epm_data_update_connection: oracleEpmDataUpdateConnectionTool,
  oracle_epm_data_upload_file: oracleEpmDataUploadFileTool,
