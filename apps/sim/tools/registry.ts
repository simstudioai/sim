...
import {
  ...
  jsmAddOrganizationUsersTool,
  jsmAddParticipantsTool,
  jsmAnswerApprovalTool,
  jsmCreateCustomerTool,
  jsmCreateOrganizationTool,
  jsmCreateRequestTool,
  jsmDeleteFeedbackTool,
  jsmDeleteOrganizationTool,
  jsmGetApprovalsTool,
  jsmGetCommentsTool,
  jsmGetCustomersTool,
  jsmGetFeedbackTool,
  jsmGetNotificationTool,
  jsmGetOrganizationsTool,
  jsmGetOrganizationTool,
  jsmGetOrganizationUsersTool,
  jsmGetParticipantsTool,
  jsmGetQueueIssuesTool,
  jsmGetQueuesTool,
  jsmGetRequestAttachmentsTool,
  jsmGetRequestStatusTool,
  jsmGetRequestsTool,
  jsmGetRequestTool,
  jsmGetRequestTypeFieldsTool,
  jsmGetRequestTypesTool,
  jsmGetServiceDesksTool,
  jsmGetServiceDeskTool,
  jsmGetSlaTool,
  jsmGetTransitionsTool,
  jsmRemoveCustomerTool,
  jsmRemoveOrganizationTool,
  jsmRemoveOrganizationUsersTool,
  jsmRemoveParticipantsTool,
  jsmSearchKnowledgeBaseTool,
  jsmSubscribeNotificationTool,
  jsmTransitionRequestTool,
  jsmUnsubscribeNotificationTool,
} from '@/tools/jsm'
import {
...
export const tools: Record<string, ToolConfig> = {
  ...
  jira_get_watchers: jiraGetWatchersTool,
  jira_get_users: jiraGetUsersTool,
  jira_search_users: jiraSearchUsersTool,
  jira_get_myself: jiraGetMyselfTool,
  jira_list_projects: jiraListProjectsTool,
  jira_get_project: jiraGetProjectTool,
  jira_get_project_components: jiraGetProjectComponentsTool,
  jira_get_project_versions: jiraGetProjectVersionsTool,
  jira_list_boards: jiraListBoardsTool,
  jira_get_board_sprints: jiraGetBoardSprintsTool,
  jira_get_sprint: jiraGetSprintTool,
  jira_create_sprint: jiraCreateSprintTool,
  jira_update_sprint: jiraUpdateSprintTool,
  jira_delete_sprint: jiraDeleteSprintTool,
  jira_get_sprint_issues: jiraGetSprintIssuesTool,
  jira_move_issues_to_sprint: jiraMoveIssuesToSprintTool,
  jira_move_to_backlog: jiraMoveToBacklogTool,
  jira_create_component: jiraCreateComponentTool,
  jira_update_component: jiraUpdateComponentTool,
  jira_delete_component: jiraDeleteComponentTool,
  jira_create_version: jiraCreateVersionTool,
  jira_update_version: jiraUpdateVersionTool,
  jira_delete_version: jiraDeleteVersionTool,
  jira_get_issue_types: jiraGetIssueTypesTool,
  jira_get_priorities: jiraGetPrioritiesTool,
  jira_get_statuses: jiraGetStatusesTool,
  jira_get_labels: jiraGetLabelsTool,
  jira_get_resolutions: jiraGetResolutionsTool,
  jira_get_fields: jiraGetFieldsTool,
  jira_get_link_types: jiraGetLinkTypesTool,
  jira_get_transitions: jiraGetTransitionsTool,
  jira_get_changelog: jiraGetChangelogTool,
  jsm_get_service_desks: jsmGetServiceDesksTool,
  jsm_get_service_desk: jsmGetServiceDeskTool,
  ...
  jsm_get_request_status: jsmGetRequestStatusTool,
  jsm_get_request_attachments: jsmGetRequestAttachmentsTool,
  ...
  jsm_remove_customer: jsmRemoveCustomerTool,
  jsm_create_customer: jsmCreateCustomerTool,
  jsm_get_organizations: jsmGetOrganizationsTool,
  jsm_get_organization: jsmGetOrganizationTool,
  jsm_create_organization: jsmCreateOrganizationTool,
  jsm_add_organization: jsmAddOrganizationTool,
  jsm_remove_organization: jsmRemoveOrganizationTool,
  jsm_delete_organization: jsmDeleteOrganizationTool,
  jsm_get_organization_users: jsmGetOrganizationUsersTool,
  jsm_add_organization_users: jsmAddOrganizationUsersTool,
  jsm_remove_organization_users: jsmRemoveOrganizationUsersTool,
  jsm_get_queues: jsmGetQueuesTool,
  jsm_get_queue_issues: jsmGetQueueIssuesTool,
  ...
  jsm_remove_participants: jsmRemoveParticipantsTool,
  jsm_get_approvals: jsmGetApprovalsTool,
  jsm_answer_approval: jsmAnswerApprovalTool,
  jsm_search_knowledge_base: jsmSearchKnowledgeBaseTool,
  jsm_get_feedback: jsmGetFeedbackTool,
  jsm_add_feedback: jsmAddFeedbackTool,
  jsm_delete_feedback: jsmDeleteFeedbackTool,
  jsm_get_notification: jsmGetNotificationTool,
  jsm_subscribe_notification: jsmSubscribeNotificationTool,
  jsm_unsubscribe_notification: jsmUnsubscribeNotificationTool,
  ...
  confluence_update_page_property: confluenceUpdatePagePropertyTool,
