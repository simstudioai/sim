...
import {
  rampCreateDepartmentTool,
  rampGetBillTool,
  rampGetBusinessBalanceTool,
  rampGetBusinessTool,
  rampGetCardTool,
  rampGetDepartmentTool,
  rampGetLimitTool,
  rampGetReceiptTool,
  rampGetReimbursementTool,
  rampGetSpendProgramTool,
  rampGetTransactionTool,
  rampGetUserTool,
  rampGetVendorTool,
  rampListBillsTool,
  rampListCardsTool,
  rampListDepartmentsTool,
  rampListEntitiesTool,
  rampListLimitsTool,
  rampListReceiptsTool,
  rampListReimbursementsTool,
  rampListSpendProgramsTool,
  rampListTransactionsTool,
  rampListUsersTool,
  rampListVendorsTool,
...
export const tools: Record<string, ToolConfig> = {
  ...
  ramp_create_department: rampCreateDepartmentTool,
  ramp_get_bill: rampGetBillTool,
  ramp_get_business: rampGetBusinessTool,
  ramp_get_business_balance: rampGetBusinessBalanceTool,
  ramp_get_card: rampGetCardTool,
  ramp_get_department: rampGetDepartmentTool,
  ramp_get_limit: rampGetLimitTool,
  ramp_get_receipt: rampGetReceiptTool,
  ramp_get_reimbursement: rampGetReimbursementTool,
  ramp_get_spend_program: rampGetSpendProgramTool,
  ramp_get_transaction: rampGetTransactionTool,
  ramp_get_user: rampGetUserTool,
  ramp_get_vendor: rampGetVendorTool,
  ramp_list_bills: rampListBillsTool,
  ramp_list_cards: rampListCardsTool,
  ramp_list_departments: rampListDepartmentsTool,
  ramp_list_entities: rampListEntitiesTool,
  ramp_list_limits: rampListLimitsTool,
  ramp_list_receipts: rampListReceiptsTool,
  ramp_list_reimbursements: rampListReimbursementsTool,
  ramp_list_spend_programs: rampListSpendProgramsTool,
  ramp_list_transactions: rampListTransactionsTool,
  ramp_list_users: rampListUsersTool,
  ramp_list_vendors: rampListVendorsTool,
  ramp_upload_receipt: rampUploadReceiptTool,
