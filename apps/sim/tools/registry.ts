...
import {
  oracleB2CServiceCreateAnswerTool,
  oracleB2CServiceCreateContactTool,
  oracleB2CServiceCreateIncidentResponseTool,
  oracleB2CServiceCreateIncidentTool,
  oracleB2CServiceCreateOrganizationTool,
  oracleB2CServiceDeleteAnswerTool,
  oracleB2CServiceDeleteContactTool,
  oracleB2CServiceDeleteIncidentTool,
  oracleB2CServiceDeleteOrganizationTool,
  oracleB2CServiceGetAnswerTool,
  oracleB2CServiceGetContactTool,
  oracleB2CServiceGetIncidentTool,
  oracleB2CServiceGetOrganizationTool,
  oracleB2CServiceListAnswersTool,
  oracleB2CServiceListContactsTool,
  oracleB2CServiceListIncidentsTool,
  oracleB2CServiceListOrganizationsTool,
  oracleB2CServiceUpdateAnswerTool,
  oracleB2CServiceUpdateContactTool,
  oracleB2CServiceUpdateIncidentTool,
  oracleB2CServiceUpdateOrganizationTool,
} from '@/tools/oracle_b2c_service'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_b2c_service_create_answer: oracleB2CServiceCreateAnswerTool,
  oracle_b2c_service_create_contact: oracleB2CServiceCreateContactTool,
  oracle_b2c_service_create_incident: oracleB2CServiceCreateIncidentTool,
  oracle_b2c_service_create_incident_response: oracleB2CServiceCreateIncidentResponseTool,
  oracle_b2c_service_create_organization: oracleB2CServiceCreateOrganizationTool,
  oracle_b2c_service_delete_answer: oracleB2CServiceDeleteAnswerTool,
  oracle_b2c_service_delete_contact: oracleB2CServiceDeleteContactTool,
  oracle_b2c_service_delete_incident: oracleB2CServiceDeleteIncidentTool,
  oracle_b2c_service_delete_organization: oracleB2CServiceDeleteOrganizationTool,
  oracle_b2c_service_get_answer: oracleB2CServiceGetAnswerTool,
  oracle_b2c_service_get_contact: oracleB2CServiceGetContactTool,
  oracle_b2c_service_get_incident: oracleB2CServiceGetIncidentTool,
  oracle_b2c_service_get_organization: oracleB2CServiceGetOrganizationTool,
  oracle_b2c_service_list_answers: oracleB2CServiceListAnswersTool,
  oracle_b2c_service_list_contacts: oracleB2CServiceListContactsTool,
  oracle_b2c_service_list_incidents: oracleB2CServiceListIncidentsTool,
  oracle_b2c_service_list_organizations: oracleB2CServiceListOrganizationsTool,
  oracle_b2c_service_update_answer: oracleB2CServiceUpdateAnswerTool,
  oracle_b2c_service_update_contact: oracleB2CServiceUpdateContactTool,
  oracle_b2c_service_update_incident: oracleB2CServiceUpdateIncidentTool,
  oracle_b2c_service_update_organization: oracleB2CServiceUpdateOrganizationTool,
