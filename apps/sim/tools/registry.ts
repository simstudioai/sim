...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  knowledge_list_folders: knowledgeListFoldersTool,
  knowledge_create_folder: knowledgeCreateFolderTool,
  knowledge_update_folder: knowledgeUpdateFolderTool,
  knowledge_delete_folder: knowledgeDeleteFolderTool,
