...
import {
  oracleFusionScmConfirmQuickShipLinesTool,
  oracleFusionScmCreateMaintenanceWorkOrderTool,
  oracleFusionScmCreateManufacturingWorkOrderTool,
  oracleFusionScmCreateSalesOrderTool,
  oracleFusionScmCreateSupplyRequestTool,
  oracleFusionScmDeleteSalesOrderTool,
  oracleFusionScmGetFulfillmentLineDetailTool,
  oracleFusionScmGetInventoryOrganizationTool,
  oracleFusionScmGetInventoryTransactionTool,
  oracleFusionScmGetItemTool,
  oracleFusionScmGetMaintenanceWorkOrderTool,
  oracleFusionScmGetManufacturingWorkOrderTool,
  oracleFusionScmGetOnHandQuantityTool,
  oracleFusionScmGetSalesOrderLineTool,
  oracleFusionScmGetSalesOrderTool,
  oracleFusionScmGetShipmentLineTool,
  oracleFusionScmGetShipmentTool,
  oracleFusionScmGetSupplyOrderLineTool,
  oracleFusionScmGetSupplyRequestTool,
  oracleFusionScmGetTransferOrderLineTool,
  oracleFusionScmGetTransferOrderTool,
  oracleFusionScmListFulfillmentLineDetailsTool,
  oracleFusionScmListInventoryOrganizationsTool,
  oracleFusionScmListInventoryTransactionsTool,
  oracleFusionScmListItemsTool,
  oracleFusionScmListMaintenanceWorkOrdersTool,
  oracleFusionScmListManufacturingWorkOrdersTool,
  oracleFusionScmListOnHandQuantitiesTool,
  oracleFusionScmListSalesOrderLinesTool,
  oracleFusionScmListSalesOrdersTool,
  oracleFusionScmListShipmentLinesTool,
  oracleFusionScmListShipmentsTool,
  oracleFusionScmListSupplyOrderLinesTool,
  oracleFusionScmListSupplyRequestsTool,
  oracleFusionScmListTransferOrderLinesTool,
  oracleFusionScmListTransferOrdersTool,
  oracleFusionScmPickReleaseShipmentLinesTool,
  oracleFusionScmUpdateItemTool,
  oracleFusionScmUpdateMaintenanceWorkOrderTool,
  oracleFusionScmUpdateManufacturingWorkOrderTool,
  oracleFusionScmUpdateSalesOrderTool,
  oracleFusionScmUpdateSupplyRequestTool,
  oracleFusionScmUpdateTransferOrderLineTool,
  oracleFusionScmUpdateTransferOrderTool,
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  oracle_fusion_scm_confirm_quick_ship_lines: oracleFusionScmConfirmQuickShipLinesTool,
  oracle_fusion_scm_create_maintenance_work_order: oracleFusionScmCreateMaintenanceWorkOrderTool,
  oracle_fusion_scm_create_manufacturing_work_order:
    oracleFusionScmCreateManufacturingWorkOrderTool,
  oracle_fusion_scm_create_sales_order: oracleFusionScmCreateSalesOrderTool,
  oracle_fusion_scm_create_supply_request: oracleFusionScmCreateSupplyRequestTool,
  oracle_fusion_scm_delete_sales_order: oracleFusionScmDeleteSalesOrderTool,
  oracle_fusion_scm_get_fulfillment_line_detail: oracleFusionScmGetFulfillmentLineDetailTool,
  oracle_fusion_scm_get_inventory_organization: oracleFusionScmGetInventoryOrganizationTool,
  oracle_fusion_scm_get_inventory_transaction: oracleFusionScmGetInventoryTransactionTool,
  oracle_fusion_scm_get_item: oracleFusionScmGetItemTool,
  oracle_fusion_scm_get_maintenance_work_order: oracleFusionScmGetMaintenanceWorkOrderTool,
  oracle_fusion_scm_get_manufacturing_work_order: oracleFusionScmGetManufacturingWorkOrderTool,
  oracle_fusion_scm_get_on_hand_quantity: oracleFusionScmGetOnHandQuantityTool,
  oracle_fusion_scm_get_sales_order: oracleFusionScmGetSalesOrderTool,
  oracle_fusion_scm_get_sales_order_line: oracleFusionScmGetSalesOrderLineTool,
  oracle_fusion_scm_get_shipment: oracleFusionScmGetShipmentTool,
  oracle_fusion_scm_get_shipment_line: oracleFusionScmGetShipmentLineTool,
  oracle_fusion_scm_get_supply_order_line: oracleFusionScmGetSupplyOrderLineTool,
  oracle_fusion_scm_get_supply_request: oracleFusionScmGetSupplyRequestTool,
  oracle_fusion_scm_get_transfer_order: oracleFusionScmGetTransferOrderTool,
  oracle_fusion_scm_get_transfer_order_line: oracleFusionScmGetTransferOrderLineTool,
  oracle_fusion_scm_list_fulfillment_line_details: oracleFusionScmListFulfillmentLineDetailsTool,
  oracle_fusion_scm_list_inventory_organizations: oracleFusionScmListInventoryOrganizationsTool,
  oracle_fusion_scm_list_inventory_transactions: oracleFusionScmListInventoryTransactionsTool,
  oracle_fusion_scm_list_items: oracleFusionScmListItemsTool,
  oracle_fusion_scm_list_maintenance_work_orders: oracleFusionScmListMaintenanceWorkOrdersTool,
  oracle_fusion_scm_list_manufacturing_work_orders: oracleFusionScmListManufacturingWorkOrdersTool,
  oracle_fusion_scm_list_on_hand_quantities: oracleFusionScmListOnHandQuantitiesTool,
  oracle_fusion_scm_list_sales_order_lines: oracleFusionScmListSalesOrderLinesTool,
  oracle_fusion_scm_list_sales_orders: oracleFusionScmListSalesOrdersTool,
  oracle_fusion_scm_list_shipment_lines: oracleFusionScmListShipmentLinesTool,
  oracle_fusion_scm_list_shipments: oracleFusionScmListShipmentsTool,
  oracle_fusion_scm_list_supply_order_lines: oracleFusionScmListSupplyOrderLinesTool,
  oracle_fusion_scm_list_supply_requests: oracleFusionScmListSupplyRequestsTool,
  oracle_fusion_scm_list_transfer_order_lines: oracleFusionScmListTransferOrderLinesTool,
  oracle_fusion_scm_list_transfer_orders: oracleFusionScmListTransferOrdersTool,
  oracle_fusion_scm_pick_release_shipment_lines: oracleFusionScmPickReleaseShipmentLinesTool,
  oracle_fusion_scm_update_item: oracleFusionScmUpdateItemTool,
  oracle_fusion_scm_update_maintenance_work_order: oracleFusionScmUpdateMaintenanceWorkOrderTool,
  oracle_fusion_scm_update_manufacturing_work_order:
    oracleFusionScmUpdateManufacturingWorkOrderTool,
  oracle_fusion_scm_update_sales_order: oracleFusionScmUpdateSalesOrderTool,
  oracle_fusion_scm_update_supply_request: oracleFusionScmUpdateSupplyRequestTool,
  oracle_fusion_scm_update_transfer_order: oracleFusionScmUpdateTransferOrderTool,
  oracle_fusion_scm_update_transfer_order_line: oracleFusionScmUpdateTransferOrderLineTool,
