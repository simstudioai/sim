...
import {
  clockifyGetCurrentUserTool,
  clockifyGetHolidaysTool,
  clockifyGetInProgressTool,
  clockifyGetMemberProfileTool,
  clockifyGetProjectsTool,
  clockifyGetTimeEntriesTool,
  clockifyGetTimeEntryTool,
  clockifyGetTimeOffTool,
  clockifyGetUsersTool,
  clockifyGetWorkspacesTool,
  clockifyReportAttendanceTool,
  clockifyReportDetailedTool,
  clockifyReportSummaryTool,
  clockifyReportWeeklyTool,
} from '@/tools/clockify'
import {
...
export const tools: Record<string, ToolConfig> = {
  ...
  clockify_get_current_user: clockifyGetCurrentUserTool,
  clockify_get_workspaces: clockifyGetWorkspacesTool,
  clockify_get_users: clockifyGetUsersTool,
  clockify_get_member_profile: clockifyGetMemberProfileTool,
  clockify_get_projects: clockifyGetProjectsTool,
  clockify_report_summary: clockifyReportSummaryTool,
  clockify_report_detailed: clockifyReportDetailedTool,
  clockify_report_weekly: clockifyReportWeeklyTool,
  clockify_report_attendance: clockifyReportAttendanceTool,
  clockify_get_time_entries: clockifyGetTimeEntriesTool,
  clockify_get_time_entry: clockifyGetTimeEntryTool,
  clockify_get_in_progress: clockifyGetInProgressTool,
  clockify_get_time_off: clockifyGetTimeOffTool,
  clockify_get_holidays: clockifyGetHolidaysTool,
