...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  slack_lists_access_delete: slackListsAccessDeleteTool,
  slack_lists_download_start: slackListsDownloadStartTool,
  slack_lists_download_get: slackListsDownloadGetTool,
  slack_lists_items_delete_multiple: slackListsItemsDeleteMultipleTool,
  slack_share_canvas: slackShareCanvasTool,
  slack_revoke_canvas_access: slackRevokeCanvasAccessTool,
  slack_join_conversation: slackJoinConversationTool,
  slack_leave_conversation: slackLeaveConversationTool,
  slack_kick_conversation: slackKickConversationTool,
  slack_unarchive_conversation: slackUnarchiveConversationTool,
  slack_close_conversation: slackCloseConversationTool,
  slack_mark_conversation_read: slackMarkConversationReadTool,
  slack_open_conversation: slackOpenConversationTool,
  slack_lookup_user_by_email: slackLookupUserByEmailTool,
  slack_list_user_conversations: slackListUserConversationsTool,
  slack_get_user_profile: slackGetUserProfileTool,
  slack_update_user_profile: slackUpdateUserProfileTool,
  slack_set_user_presence: slackSetUserPresenceTool,
  slack_get_file_info: slackGetFileInfoTool,
  slack_list_files: slackListFilesTool,
  slack_delete_file: slackDeleteFileTool,
  slack_get_reactions: slackGetReactionsTool,
  slack_list_reactions: slackListReactionsTool,
  slack_pin_message: slackPinMessageTool,
  slack_unpin_message: slackUnpinMessageTool,
  slack_list_pins: slackListPinsTool,
  slack_add_bookmark: slackAddBookmarkTool,
  slack_edit_bookmark: slackEditBookmarkTool,
  slack_list_bookmarks: slackListBookmarksTool,
  slack_remove_bookmark: slackRemoveBookmarkTool,
  slack_create_user_group: slackCreateUserGroupTool,
  slack_update_user_group: slackUpdateUserGroupTool,
  slack_enable_user_group: slackEnableUserGroupTool,
  slack_disable_user_group: slackDisableUserGroupTool,
  slack_list_user_groups: slackListUserGroupsTool,
  slack_list_user_group_members: slackListUserGroupMembersTool,
  slack_update_user_group_members: slackUpdateUserGroupMembersTool,
  slack_search_messages: slackSearchMessagesTool,
  slack_search_files: slackSearchFilesTool,
  slack_search_all: slackSearchAllTool,
  slack_get_dnd_info: slackGetDndInfoTool,
  slack_get_team_dnd_info: slackGetTeamDndInfoTool,
  slack_set_dnd_snooze: slackSetDndSnoozeTool,
  slack_end_dnd_snooze: slackEndDndSnoozeTool,
  slack_end_dnd: slackEndDndTool,
  slack_list_emoji: slackListEmojiTool,
  slack_get_team_info: slackGetTeamInfoTool,
  slack_get_team_profile: slackGetTeamProfileTool,
  slack_unfurl_links: slackUnfurlLinksTool,
