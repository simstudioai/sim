...
import {
  oracleEpcmAddMemberTool,
  oracleEpcmCalculateModelTool,
  oracleEpcmClearPovTool,
  oracleEpcmCopyPovTool,
  oracleEpcmDeleteFileTool,
  oracleEpcmDeletePovTool,
  oracleEpcmDownloadFileTool,
  oracleEpcmExportDataSliceTool,
  oracleEpcmExportDataTool,
  oracleEpcmExportMetadataTool,
  oracleEpcmGenerateModelDocumentationTool,
  oracleEpcmGetChildJobDetailsTool,
  oracleEpcmGetJobDetailsTool,
  oracleEpcmGetJobStatusTool,
  oracleEpcmGetMemberTool,
  oracleEpcmImportDataSliceTool,
  oracleEpcmImportDataTool,
  oracleEpcmImportMetadataTool,
  oracleEpcmListApplicationsTool,
  oracleEpcmListFilesTool,
  oracleEpcmListJobDefinitionsTool,
  oracleEpcmUploadFileTool,
  oracleEpcmValidateModelTool,
  oracleEpcmWaitForJobTool,
} from '@/tools/oracle_epm_enterprise_profitability'
import {
