...
import type { WordPressGetPostParams, WordPressGetPostResponse } from './types'
...
export const getPostTool: ToolConfig<WordPressGetPostParams, WordPressGetPostResponse> = {
  ...
  description: 'Get a single blog post from WordPress by ID',
  version: '1.0.0',
  ...
  request: {
    url: (params) => {
      ...
      return `${baseUrl}/wp-json/wp/v2/posts/${params.postId}`
    },
    method: 'GET',
    headers: (params) => {
