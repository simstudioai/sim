...
export const oracleEpmNarrativeReportingListReportSnapshotsTool: InternalToolConfig<
  NarrativeToolParams,
  NarrativeResponse
> = {
  id: 'oracle_epm_narrative_reporting_list_report_snapshots',
  name: 'Oracle EPM Narrative Reporting List Report Snapshots',
  description: 'List one bounded page of report snapshots, not database backups.',
  version: '1.0.0',
  ...
  outputs: {
    snapshots: {
      type: 'array',
      description: 'Documented snapshots',
      items: {
        type: 'object',
        properties: {
          reportId: {
