...
export const oracleEpmNarrativeReportingGetReportGlobalPovTool: InternalToolConfig<
  NarrativeToolParams,
  NarrativeResponse
> = {
  id: 'oracle_epm_narrative_reporting_get_report_global_pov',
  name: 'Oracle EPM Narrative Reporting Get Report Global POV',
  description: 'Read the report’s global point-of-view dimensions and suggested members.',
  version: '1.0.0',
