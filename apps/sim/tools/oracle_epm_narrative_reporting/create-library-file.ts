...
export const oracleEpmNarrativeReportingCreateLibraryFileTool: InternalToolConfig<
  NarrativeToolParams,
  NarrativeResponse
> = {
  id: 'oracle_epm_narrative_reporting_create_library_file',
  name: 'Oracle EPM Narrative Reporting Create Library File',
  description:
