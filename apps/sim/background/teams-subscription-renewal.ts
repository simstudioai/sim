...
/**
 * Background job to renew provider subscriptions before they expire
 *
 * Runs periodically (e.g., every 2 days) to find and renew subscriptions
 * approaching expiration across all providers (Teams, Telegram, etc.)
 */
