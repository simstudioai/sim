...
export const env = createEnv({
  ...
  server: {
    ...
    GEMINI_API_KEY:                        z.string().min(1).optional(),           // Primary Google Gemini API key
    GEMINI_API_KEY_1:                      z.string().min(1).optional(),           // Additional Gemini API key for load balancing
