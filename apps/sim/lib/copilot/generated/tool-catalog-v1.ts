      ...
      args: {
        ...
        properties: {
          ...
          viewId: {
            type: 'string',
            description:
              'Saved view id. For query_rows: query through the view (its stored filter and order apply; an explicit filter or order overrides that part). Required for update_view and delete_view.',
          },
          viewName: {
            type: 'string',
            description:
