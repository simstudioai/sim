...
export const CreateFile: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"contentType":{"type":"string","description":"Optional MIME type override. Usually omit and let the system infer from the file extension."},"fileName":{"type":"string","description":"Plain workspace filename including extension, e.g. \"main.py\" or \"report.md\". Must not contain slashes."}},"required":["fileName"]},
  resultSchema: {"type":"object","properties":{"data":{"type":"object","description":"Contains id (the fileId) and name."},"message":{"type":"string","description":"Human-readable outcome."},"success":{"type":"boolean","description":"Whether the file was created."}},"required":["success","message"]},
  requiredPermission: "write",
};
...
export const DeleteFile: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"fileIds":{"type":"array","description":"Canonical workspace file IDs of the files to delete.","items":{"type":"string"}}},"required":["fileIds"]},
  resultSchema: {"type":"object","properties":{"message":{"type":"string","description":"Human-readable outcome."},"success":{"type":"boolean","description":"Whether the delete succeeded."}},"required":["success","message"]},
  requiredPermission: "write",
};
...
export const DeleteFolder: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"folderIds":{"type":"array","description":"The folder IDs to delete.","items":{"type":"string"}}},"required":["folderIds"]},
  requiresConfirmation: true,
  requiredPermission: "write",
};
...
export const DeleteWorkflow: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"workflowIds":{"type":"array","description":"The workflow IDs to delete.","items":{"type":"string"}}},"required":["workflowIds"]},
  requiresConfirmation: true,
  requiredPermission: "write",
};
...
export const EditContent: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"content":{"type":"string","description":"The text content to write. For append: text to append. For update: full replacement text. For patch with search_replace: the replacement text. For patch with anchored: the insert/replacement text."}},"required":["content"]},
  resultSchema: {"type":"object","properties":{"data":{"type":"object","description":"Optional operation metadata such as file id, file name, size, and content type."},"message":{"type":"string","description":"Human-readable summary of the outcome."},"success":{"type":"boolean","description":"Whether the content was applied successfully."}},"required":["success","message"]},
  requiredPermission: "write",
};
...
export const ManageCredential: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"credentialId":{"type":"string","description":"The credential ID (required for rename)"},"credentialIds":{"type":"array","description":"Array of credential IDs (for batch delete)","items":{"type":"string"}},"displayName":{"type":"string","description":"New display name (required for rename)"},"operation":{"type":"string","description":"The operation to perform","enum":["rename","delete"]}},"required":["operation"]},
  requiresConfirmation: true,
  requiredPermission: "admin",
};
...
export const MoveWorkflow: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"folderId":{"type":"string","description":"Target folder ID. Omit or pass empty string to move to workspace root."},"workflowIds":{"type":"array","description":"The workflow IDs to move.","items":{"type":"string"}}},"required":["workflowIds"]},
  requiredPermission: "write",
};
...
export const OpenResource: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"resources":{"type":"array","description":"Array of resources to open. Each item must have type and id.","items":{"type":"object","properties":{"id":{"type":"string","description":"The resource ID."},"type":{"type":"string","description":"The resource type.","enum":["workflow","table","knowledgebase","file","log"]}},"required":["type","id"]}}},"required":["resources"]},
};
...
export const RenameFile: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"fileId":{"type":"string","description":"Canonical workspace file ID of the file to rename."},"newName":{"type":"string","description":"New filename including extension, e.g. \"draft_v2.md\". Must not contain slashes."}},"required":["fileId","newName"]},
  resultSchema: {"type":"object","properties":{"data":{"type":"object","description":"Contains id and the new name."},"message":{"type":"string","description":"Human-readable outcome."},"success":{"type":"boolean","description":"Whether the rename succeeded."}},"required":["success","message"]},
  requiredPermission: "write",
};
...
export const RestoreResource: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"id":{"type":"string","description":"The canonical resource ID to restore."},"type":{"type":"string","description":"The resource type to restore.","enum":["workflow","table","file","knowledgebase","folder"]}},"required":["type","id"]},
  requiresConfirmation: true,
  requiredPermission: "admin",
};
...
export const SetBlockEnabled: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"blockId":{"type":"string","description":"The block ID whose enabled state should be changed."},"enabled":{"type":"boolean","description":"Set to true to enable the block, or false to disable it."},"workflowId":{"type":"string","description":"Optional workflow ID to edit. If not provided, uses the current workflow in context."}},"required":["blockId","enabled"]},
  requiredPermission: "write",
};
...
export const SetEnvironmentVariables: ToolCatalogEntry = {
  ...
  route: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"scope":{"type":"string","description":"Whether to set workspace or personal environment variables. Defaults to workspace.","enum":["personal","workspace"],"default":"workspace"},"variables":{"type":"array","description":"List of env vars to set","items":{"type":"object","properties":{"name":{"type":"string","description":"Variable name"},"value":{"type":"string","description":"Variable value"}},"required":["name","value"]}}},"required":["variables"]},
  requiresConfirmation: true,
  requiredPermission: "write",
};
...
export type KnowledgeBaseOperation = (typeof KnowledgeBaseOperation)[keyof typeof KnowledgeBaseOperation];
...
export type ManageCredentialOperation = (typeof ManageCredentialOperation)[keyof typeof ManageCredentialOperation];
...
export type ManageCustomToolOperation = (typeof ManageCustomToolOperation)[keyof typeof ManageCustomToolOperation];
...
export type ManageMcpToolOperation = (typeof ManageMcpToolOperation)[keyof typeof ManageMcpToolOperation];
...
export type MaterializeFileOperation = (typeof MaterializeFileOperation)[keyof typeof MaterializeFileOperation];
...
export type WorkspaceFileOperation = (typeof WorkspaceFileOperation)[keyof typeof WorkspaceFileOperation];
