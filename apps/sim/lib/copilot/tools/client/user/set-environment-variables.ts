...
export class SetEnvironmentVariablesClientTool extends BaseClientTool {
	...
	constructor(toolCallId: string) {
		super(toolCallId, SetEnvironmentVariablesClientTool.id, SetEnvironmentVariablesClientTool.metadata)
	}

	static readonly metadata: BaseClientToolMetadata = {
		displayNames: {
			[ClientToolCallState.generating]: { text: 'Preparing to set environment variables', icon: Loader2 },
