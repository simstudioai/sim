...
const TOOL_TITLES: Record<string, string> = {
  ...
  archive_workflow_eval_suite: 'Archiving Eval Suite',
  ...
  create_workflow_eval_suite: 'Creating Eval Suite',
  ...
  get_workflow_eval_run: 'Getting Eval run',
  get_workflow_eval_suite: 'Getting Eval Suite',
  ...
  list_workflow_eval_suites: 'Listing Eval Suites',
  ...
  run_workflow_eval_suite: 'Running Eval Suite',
  run_workflow_eval_test: 'Running Eval test',
