 ...
 * Form submissions enter through the unified start block exactly like API
 * runs — `findStartBlock` has no 'form' kind by design. Unlisted trigger
 * types resolve as 'manual'.
 */
