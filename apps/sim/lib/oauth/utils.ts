...
export const SCOPE_DESCRIPTIONS: Record<string, string> = {
  ...
  'crm.objects.notes.read': 'Read HubSpot notes',
  'crm.objects.notes.write': 'Create and update HubSpot notes',
  'crm.objects.emails.read': 'Read HubSpot email engagements',
