  ...
  oracle_fusion: {
    ...
    services: {
      oracle_fusion_learning: {
        ...
        description: 'Manage Learning catalog drafts, events, assignments, and completion records.',
        providerId: 'oracle_fusion_learning',
    ...
    defaultService: 'oracle_fusion_learning',
  },
  reddit: {
    name: 'Reddit',
    icon: RedditIcon,
