...
import { BuildWorkflowInput, BuildWorkflowResult } from '@/lib/copilot-new/tools/shared/schemas'

const SIM_AGENT_API_URL = env.SIM_AGENT_API_URL || SIM_AGENT_API_URL_DEFAULT

export const buildWorkflowServerTool: BaseServerTool<ReturnType<typeof BuildWorkflowInput.parse>, ReturnType<typeof BuildWorkflowResult.parse>> = {
	name: 'build_workflow',
	async execute({ yamlContent, description }: ReturnType<typeof BuildWorkflowInput.parse>): Promise<ReturnType<typeof BuildWorkflowResult.parse>> {
