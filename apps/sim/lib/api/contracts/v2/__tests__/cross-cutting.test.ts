...
describe('knowledge and files request-slice strictness', () => {
   ...
   * in-place content edit's query and body, 108 → 109 with the knowledge
   * base export query, and 109 → 116 with the file version list, get, text,
   * download, revert, and delete queries and the revert body.
   */
  it('sweeps every documented query and body slice', () => {
    expect(slices.length).toBe(116)
  })
