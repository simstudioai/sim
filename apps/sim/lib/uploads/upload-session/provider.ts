...
export async function initiateMultipartProviderUpload(params: {
  ...
  if (provider === 'gcs') {
    const { initiateGcsMultipartUpload } = await import('@/lib/uploads/providers/gcs/client.server')
...
export async function createPutProviderTransfer(params: {
  ...
  const { getGcsPresignedUploadUrl } = await import('@/lib/uploads/providers/gcs/client.server')
...
export async function getMultipartProviderPartUrls(params: {
  ...
  const { getGcsMultipartPartUrls } = await import('@/lib/uploads/providers/gcs/client.server')
...
export async function listMultipartProviderParts(params: {
  ...
  const { listGcsMultipartParts } = await import('@/lib/uploads/providers/gcs/client.server')
...
export async function completeMultipartProviderUpload(params: {
  ...
  const { completeGcsMultipartUpload } = await import('@/lib/uploads/providers/gcs/client.server')
  ...
  const head =
    params.provider === 's3'
      ...
      : params.provider === 'blob'
        ...
        : await import('@/lib/uploads/providers/gcs/client.server').then(({ headGcsObject }) =>
...
export async function deleteProviderObjectVersion(params: {
  ...
  const { deleteGcsObjectVersion } = await import('@/lib/uploads/providers/gcs/client.server')
...
export async function abortProviderUpload(params: {
  ...
  if (params.method === 'multipart') {
    ...
    if (params.provider === 's3') {
      ...
      const { abortGcsMultipartUpload } = await import('@/lib/uploads/providers/gcs/client.server')
