...
/** Reviewed against public vendor sources on 2026-09-13; uncertainties are labeled. */
export const n8nProfile: CompetitorProfile = {
  ...
  standoutFeatures: [
    ...
    {
      title: 'Source-available core under the Sustainable Use License',
      description:
        'The Sustainable Use License permits internal business, non-commercial, and personal use within its stated restrictions. Enterprise source files require separate license terms.',
      shortDescription: 'Core source under the Sustainable Use License; separate Enterprise terms.',
      source: {
  ...
  limitations: [
    ...
    {
      title: 'n8n Assistant remains in preview',
      description:
        'The current n8n Assistant is available on Cloud Starter/Pro and self-hosted Community/Business. Enterprise customers must contact their account team about preview access.',
      shortDescription: 'Preview availability varies by edition.',
      source: {
        url: 'https://docs.n8n.io/build/ways-of-building-workflows/n8n-assistant',
        label: 'n8n docs: Use n8n Assistant',
        asOf: '2026-09-13',
      },
    },
    {
  ...
  facts: {
    platform: {
      builderType: {
        ...
        detail:
          'Build workflows from connected nodes, add JavaScript or Python Code steps, or create and edit workflows through the n8n Assistant preview.',
        shortValue: 'Visual canvas, code, and n8n Assistant preview',
        confidence: 'verified',
        sources: [
          {
            url: 'https://n8n.io/pricing/',
      ...
      templates: {
        ...
        detail:
          'The public template directory contains more than 12,000 templates, including an AI category. Directory totals change over time.',
      ...
      customBlocks: {
        value: 'Reusable sub-workflows and custom nodes; workflow-to-node publishing unconfirmed',
        detail:
        ...
        shortValue: 'Sub-workflows; workflow-to-node publishing unconfirmed',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow.md',
    ...
    aiCapabilities: {
      ...
      naturalLanguageBuilding: {
        value: 'Yes: n8n Assistant preview on Cloud and self-hosted',
        detail:
          'The n8n Assistant creates, edits, tests, and troubleshoots workflows. Current docs list Cloud Starter/Pro and self-hosted Community/Registered Community/Business; Enterprise customers must contact their account team about preview access.',
        shortValue: 'n8n Assistant preview, including self-hosted',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.n8n.io/build/ways-of-building-workflows/n8n-assistant',
      ...
      knowledgeBaseRag: {
        value: 'Yes: vector-store workflows and agent knowledge bases in preview',
        detail:
        ...
        shortValue: 'Vector-store RAG; agent knowledge in preview',
        confidence: 'verified',
        sources: [
          {
            url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.vectorstoreinmemory.md',
      ...
      modelFallback: {
        value: 'Yes: optional fallback model on the AI Agent node',
        detail:
          'Enable Fallback Model adds a second language-model connection. When the main model errors, the configured fallback model is used. This is a per-node configuration, not a universal instance-wide failover policy.',
        shortValue: 'Optional Agent-node model fallback',
        confidence: 'verified',
        sources: [
          {
            url: 'https://blog.n8n.io/best-practices-for-deploying-ai-agents-in-production/',
            label: 'n8n: Deploying AI agents in production',
            asOf: '2026-09-13',
          },
          {
            url: 'https://github.com/n8n-io/n8n/blob/master/packages/@n8n/nodes-langchain/nodes/agents/Agent/V2/AgentV2.node.ts',
            label: 'n8n source: AI Agent model fallback',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    integrations: {
      integrationCount: {
        value: '2,174 entries in the integration directory',
        detail:
          'The public directory displayed 2,174 entries on 2026-09-13. Its count includes different node types and partner-built entries, so it is not a count of distinct apps or exclusively first-party connectors.',
        shortValue: '2,174 directory entries',
        confidence: 'verified',
        sources: [
          {
      ...
      triggerTypes: {
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'n8n Docs: webhook',
            asOf: '2026-09-13',
          },
          {
            url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/integrations/builtin/core-nodes/n8n-nodes-base.manualworkflowtrigger.md',
            label: 'n8n Docs: manualworkflowtrigger',
            asOf: '2026-09-13',
          },
          {
            url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/integrations/builtin/core-nodes/n8n-nodes-base.scheduletrigger/README.md',
            label: 'n8n Docs: scheduletrigger',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    pricing: {
      ...
      byok: {
        ...
        detail:
          'OpenAI and Anthropic credentials accept users’ provider API keys. Supported Cloud nodes can also use Gateway credits; MiniMax documents that option. Self-hosted n8n Assistant requires a model-provider configuration.',
        ...
        sources: [
          ...
          {
            url: 'https://docs.n8n.io/deploy/host-n8n/configure-n8n/set-up-n8n-assistant',
            label: 'n8n Docs: Set up n8n Assistant',
            asOf: '2026-09-13',
          },
        ],
      },
  ...
  oneLinerSources: [
    ...
    {
      url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/build/understand-workflows/workflow-components/work-with-nodes.md',
      label: 'n8n Docs: Workflow nodes',
      asOf: '2026-09-13',
    },
    {
      url: 'https://github.com/n8n-io/n8n-docs/blob/main/docs/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/README.md',
      label: 'n8n Docs: AI Agent',
      asOf: '2026-09-13',
    },
    {
      url: 'https://raw.githubusercontent.com/n8n-io/n8n/master/LICENSE.md',
