  ...
  limitations: [
    {
      ...
      description:
        'Zapier states that customer data is hosted on AWS servers in the United States.',
  ...
  facts: {
    platform: {
      ...
      customBlocks: {
        ...
        shortValue: 'Sub-Zaps; custom block publication unconfirmed',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://help.zapier.com/hc/en-us/articles/32283713627533-Understanding-Sub-Zaps',
    ...
    aiCapabilities: {
      ...
      loopIteration: {
        ...
        shortValue: 'Paid beta loops; parallel, up to 500 items',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.zapier.com/hc/en-us/articles/42969233918477-Understanding-Looping-by-Zapier',
    ...
    pricing: {
      pricingModel: {
        value:
          'Free, Professional, and Team plans have monthly task allowances; Enterprise also offers annual task limits. Successful app actions generally use tasks; many built-in data tools are exempt. MCP tool calls use two tasks, and Agents use a separate activity quota.',
        ...
        detail:
          'Trigger billing needs confirmation: task-usage help says triggers are free, while the rate card includes triggers in its one-task standard-step description. AI model tiers and extended code runtime can consume additional tasks.',
      },
      entryPaidPlan: {
        value:
          'Professional starts at US$19.99 per month when billed annually, or US$29.99 when billed monthly. The selected task allowance affects the final price.',
        shortValue: 'Professional from US$19.99/month, billed annually',
        confidence: 'verified',
        sources: [
          {
            url: 'https://zapier.com/pricing',
    ...
    security: {
      ...
      compliance: {
        ...
        shortValue: 'SOC 2 Type II, SOC 3; GDPR/CCPA stated; PHI unsupported',
        confidence: 'verified',
        sources: [
          {
    ...
    observability: {
      ...
      executionLimits: {
        ...
        sources: [
          ...
          {
            url: 'https://help.zapier.com/hc/en-us/articles/8496196837261-How-is-task-usage-measured-in-Zapier',
            label: 'How is task usage measured in Zapier? – Zapier',
            asOf: '2026-09-13',
          },
        ],
        detail:
