...
export const dustProfile: CompetitorProfile = {
  ...
  leadAnswer: [
    'Choose Dust for its ',
    {
      text: 'instruction-based agent builder and Sidekick assistance',
      source: {
    ...
    ', including optional workflow diagrams, and ',
    {
      text: 'Git-managed agent and skill configurations',
      source: {
    ...
    ', and ',
    {
      text: 'workspace promotion on Enterprise Cloud or appropriately enabled self-hosted deployments',
      source: {
  ...
  betterThanAnswer: [
    'The better fit depends on how you want to build and operate agents. Sim offers a ',
    {
      text: 'visual workflow canvas',
      source: {
        url: 'https://docs.sim.ai/introduction',
    ...
    ' and ',
    {
      text: 'customer-operated hosting of its core',
      source: {
        url: 'https://docs.sim.ai/platform/self-hosting/docker',
        label: 'Sim Docs: Docker',
        asOf: '2026-09-13',
    ...
    ' with an ',
    {
      text: 'instruction-based builder and Sidekick',
      source: {
        url: 'https://docs.dust.tt/docs/user-documentation/agents/agent-builder-sidekick.md',
        label: 'Dust: @sidekick agent',
        asOf: '2026-09-13',
    ...
    '. Dust also supports ',
    {
      text: 'Git-managed configurations',
      source: {
        url: 'https://github.com/dust-tt/dust-github-action',
        label: 'Dust: GitHub Action for skills and agents',
        asOf: '2026-09-13',
    ...
    '; configuration control is not exclusive to Sim.',
  ],
  sectionIntros: {
    platform: [
      'Sim provides a ',
      ...
      '; ',
      {
        text: 'workspace forks and promotion',
        source: {
          url: 'https://docs.sim.ai/platform/enterprise/forks',
          label: 'Sim Docs: Workspace forks',
          asOf: '2026-09-13',
      ...
      ' depend on Enterprise Cloud or appropriate self-hosted enablement. Dust combines its ',
      {
        text: 'instruction-based builder',
        source: {
    ...
    pricing: [
      'Sim uses ',
      {
        text: 'per-seat plans with credits',
        source: {
      ...
      ' and ',
      {
        text: 'supports provider keys while retaining base workflow charges',
        source: {
      ...
      '. Dust offers ',
      {
        text: 'per-seat credit subscriptions',
        source: {
          url: 'https://dust.tt/home/pricing',
          label: 'Dust: Pricing',
          asOf: '2026-09-13',
      ...
      ' and ',
      {
        text: 'Enterprise pooled credits',
        source: {
    ...
    security: [
      ...
      ' and ',
      {
        text: 'Enterprise access controls',
        source: {
      ...
      '. Dust documents ',
      {
        text: 'hosted security and compliance options',
        source: {
          url: 'https://dust.tt/home/pricing',
          label: 'Dust: Pricing',
          asOf: '2026-09-13',
      ...
      '. Compare the applicable plan, deployment, and contract scope for your requirements.',
    ],
    aiCapabilities: [
      'Sim provides explicit ',
      {
        text: 'approval steps',
        source: {
      ...
      ' and ',
      {
        text: 'parallel workflow branches',
        source: {
      ...
      ' and ',
      {
        text: 'discover permitted tools on demand',
        source: {
    ...
    integrations: [
      'Sim can ',
      {
        text: 'publish workflows as MCP tools',
        source: {
      ...
      '. Compare the specific connections and deployment controls required by your workflow.',
    ],
    observability: [
      'Sim documents ',
      {
        text: 'run and block logs',
        source: {
      ...
      '. The rows below distinguish documented execution controls from capabilities that remain unconfirmed.',
    ],
    support: [
      'Both provide learning resources: ',
      {
        text: 'Sim Academy',
        source: {
      ...
      '. Their pricing pages describe ',
      {
        text: 'Sim Enterprise dedicated support',
        source: {
          url: 'https://www.sim.ai/pricing',
          label: 'Sim pricing',
          asOf: '2026-09-13',
      ...
      ' and ',
      {
        text: 'Dust Enterprise support options',
        source: {
          url: 'https://dust.tt/home/pricing',
          label: 'Dust: Pricing',
          asOf: '2026-09-13',
  ...
  limitations: [
    ...
    },
    {
      ...
      description:
        'Pod conversations, files, linked data, and tasks form shared context. Open Pods are browsable by all workspace members; sensitive work needs a Restricted Pod with appropriate membership.',
      shortDescription: 'Open Pods are workspace-visible; Restricted Pods require membership.',
      source: {
        url: 'https://docs.dust.tt/docs/user-documentation/pods/overview.md',
        label: 'Dust: Pods overview',
        asOf: '2026-09-13',
  ...
  facts: {
    platform: {
      ...
      environmentPromotion: {
        ...
        detail:
          'Workspace ID and API key are per-workflow inputs, which can be used to target separate environments. Documented development, staging, and production promotion with a review process was not confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://github.com/dust-tt/dust-github-action',
    ...
    aiCapabilities: {
      ...
      evaluationGuardrails: {
        value: 'Agent preview and tool approvals are documented',
        shortValue: 'Preview and tool approvals',
        detail:
          'A native batch dataset regression suite and a production monitoring surface were not confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.dust.tt/docs/user-documentation/agents/create-your-first-agent.md',
      ...
      humanInTheLoop: {
        ...
        detail:
          'Agents pause and wait for a user to approve or decline a tool action. Admin configuration of approval levels was not confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.dust.tt/docs/changelog.md',
    ...
    pricing: {
      ...
      entryPaidPlan: {
        value:
          'Pro is $30 or €30 per seat/month, or $24 or €24 per seat/month billed annually, depending on the pricing view; excludes VAT and includes 8,000 monthly credits.',
        shortValue: 'Pro: $30/€30 per seat/mo; $24/€24 annually, excl. VAT',
        confidence: 'verified',
        sources: [
          {
            url: 'https://dust.tt/home/pricing',
    ...
    security: {
      ...
      compliance: {
        value: 'Vendor lists SOC 2 Type II on its pricing page',
        shortValue: 'SOC 2 Type II listed',
        detail:
          'A HIPAA claim was not found in current public Dust documentation, including the changelog, so HIPAA support is neither asserted nor ruled out. The restricted trust materials were not inspectable. No current GDPR, ISO 27001, PCI DSS, or FedRAMP certification is asserted.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://dust.tt/home/pricing',
    ...
    observability: {
      tracingDepth: {
        value:
          'Analytics reports workspace credit consumption attributed to agents, members, models, and tools; per-run execution tracing was not confirmed',
        shortValue: 'Workspace credit analytics; run tracing unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.dust.tt/docs/changelog.md',
    ...
    support: {
      ...
      academy: {
        value: 'Yes: Dust Academy provides courses, tutorials, and videos for learning Dust.',
        shortValue: 'Dust Academy courses and tutorials',
        detail:
          'The public catalog offers English and French learning tracks covering AI agents, platform basics, agent building, automation, and Computer.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://dust.tt/academy',
