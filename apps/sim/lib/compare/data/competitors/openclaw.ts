...
/** Reviewed against public primary sources on 2026-09-13; uncertainties are labeled. */
export const openClawProfile: CompetitorProfile = {
  ...
  standoutFeatures: [
    ...
    },
    {
      ...
      shortDescription: 'Markdown memory; hybrid retrieval when embeddings are configured.',
      source: {
  ...
  limitations: [
    ...
    },
    {
      ...
      description: 'Team setup requires an always-on Gateway host.',
  ...
  facts: {
    platform: {
      ...
      environmentPromotion: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/gateway/multi-tenant-hosting',
    ...
    aiCapabilities: {
      multiLlmSupport: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/concepts/model-providers/official-provider-plugins',
            label: 'Official provider plugins',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/concepts/model-providers/custom-providers',
            label: 'Custom providers and local runtimes',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      naturalLanguageBuilding: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/automation/cron-jobs/how-it-works',
            label: 'How automations work',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/automation/cron-jobs/managing-jobs',
      ...
      mcpSupport: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/cli/mcp/registry',
            label: 'Manage saved MCP servers',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      modelFallback: {
        ...
        shortValue: 'Credential rotation and model fallbacks',
        confidence: 'verified',
        sources: [
          {
      ...
      parallelExecution: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/tools/subagents/operations',
            label: 'Sub-agent concurrency, recovery, and stopping',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      loopIteration: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/automation/cron-jobs/webhooks',
    ...
    integrations: {
      ...
      triggerTypes: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/automation/cron-jobs/schedules',
      ...
      codeSandboxRuntime: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/gateway/sandboxing/images-and-setup',
            label: 'Images and setup',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/gateway/sandboxing/workspace-access',
      ...
      extensibilitySdk: {
        value:
          'Experimental typed plugin SDK for tools, channels, providers, and runtime extensions',
        shortValue: 'Experimental typed plugin SDK',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.openclaw.ai/plugins/sdk-overview.md',
      ...
      mcpPublishing: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/cli/mcp/serve',
            label: 'Run OpenClaw as an MCP server',
            asOf: '2026-09-13',
          },
        ],
        detail:
    ...
    pricing: {
      pricingModel: {
        ...
        sources: [
          {
            url: 'https://github.com/openclaw/openclaw/blob/main/LICENSE',
            label: 'openclaw/LICENSE at main · openclaw/openclaw · GitHub',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/reference/api-usage-costs',
            label: 'API usage and costs',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/gateway/cloud-sessions.md',
    ...
    security: {
      ...
      modelAndToolGovernance: {
        ...
        shortValue: 'Layered tool policies',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.openclaw.ai/gateway/sandbox-vs-tool-policy-vs-elevated',
            label: 'Sandbox vs tool policy vs elevated',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/gateway/operator-scopes.md',
            label: 'Operator scopes',
            asOf: '2026-09-13',
          },
        ],
      ...
      dataRetention: {
        ...
        detail:
          'Isolated automation sessions default to 24-hour retention; terminal run history is retained for 7 days, except lost rows for 24 hours, subject to documented row caps. Other data has separate policies.',
      },
      piiRedaction: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/gateway/security/secrets-and-storage',
            label: 'Secrets, storage, and logs',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      thirdPartyVetting: {
        value:
          'ClawHub publishes SkillSpector, A.I.G, and risk-analysis findings for release artifacts',
    ...
    observability: {
      tracingDepth: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/gateway/opentelemetry/privacy-and-trace-context',
            label: 'Privacy and trace context',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      failureAlerting: {
        ...
        sources: [
          {
            url: 'https://docs.openclaw.ai/automation/cron-jobs/delivery',
      ...
      dataDrains: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/gateway/opentelemetry/configuration',
            label: 'OpenTelemetry configuration',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      executionLimits: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.openclaw.ai/tools/subagents/nesting',
            label: 'Nested sub-agents and authentication',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.openclaw.ai/tools/subagents/tool-reference',
            label: 'Sub-agent tool reference',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Sub-agent nesting defaults to five levels and supports a maximum depth of five. A zero sub-agent timeout does not remove every other runtime limit.',
      },
