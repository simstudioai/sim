...
export const retoolProfile: CompetitorProfile = {
  ...
  standoutFeatures: [
    {
      ...
      description:
        'Generate apps from prompts, inspect and edit their React frontend and TypeScript backend, or import existing React projects. Retool applies configured resource permissions and deployment controls.',
    ...
    },
    {
      ...
      description:
        'Retool Vectors stores document and website text for retrieval. Builders choose an OpenAI embedding model when creating a vector; that model cannot be changed for an existing vector.',
    ...
    },
    {
      ...
      description:
        'Retool connects agents to remote MCP tools and exposes an organization MCP server for app building and administration. Retool describes the Cloud server as public beta.',
      shortDescription: 'Remote MCP tools; Cloud MCP administration in public beta.',
      source: {
        url: 'https://retool.com/resources/how-to-use-mcp-in-retool',
        label: 'Using MCP in Retool: Build From Any AI Tool | Retool',
        asOf: '2026-09-13',
      },
    },
  ],
  ...
  facts: {
    platform: {
      builderType: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.retool.com/apps/concepts/multiplayer',
            label: 'Multiplayer | Retool Docs',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      environmentPromotion: {
        ...
        shortValue: 'Enterprise Source Control and multi-instance releases',
        detail:
      ...
      versionControlDepth: {
        value:
          'Enterprise Source Control provides Git branches, pull-request review, commit rollback, versioned releases, and per-instance release selection.',
        shortValue: 'Enterprise branches, PRs, rollback, and releases',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.retool.com/source-control/quickstart',
    ...
    aiCapabilities: {
      ...
      mcpSupport: {
        value:
          'Yes: remote MCP resources for agent tools and an OAuth-authenticated organization MCP server for external clients. Retool describes the Cloud server as public beta.',
        shortValue: 'Remote MCP tools; Cloud server in public beta',
        detail:
      ...
      humanInTheLoop: {
        value:
          'User Task blocks are documented as Beta: they pause workflows until assigned users or groups complete a task in a Retool app. Current enrollment availability was not verified.',
        shortValue: 'Beta User Tasks; availability unverified',
        detail:
    ...
    integrations: {
      ...
      mcpPublishing: {
        value:
          'Partial: an organization MCP endpoint exposes Retool app-building and management tools. Retool describes the Cloud server as public beta.',
        shortValue: 'Cloud MCP public beta; workflow publishing unverified',
        detail:
    ...
    observability: {
      ...
      dataDrains: {
        ...
        shortValue: 'Enterprise Datadog/Splunk; self-hosted stdout',
        detail:
      ...
      executionLimits: {
        value:
          'Cloud workflows: normally 15 minutes to the first synchronous Response block, but 3 minutes for synchronous child workflows; asynchronous runs normally time out after 30 hours. Concurrency depends on the trigger.',
        shortValue: 'Cloud timeouts and concurrency vary by trigger',
        detail:
          'Asynchronous workflows with User Task/Wait blocks have no overall timeout; individual Wait blocks cap at 60 days. Cloud allows 100 concurrent runs per workflow, but scheduled runs wait for the prior run to finish. Cloud memory is 2.5GB/run and outbound concurrency is 50 requests/workflow. Block-specific timeouts also apply.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.retool.com/workflows/concepts/limits',
