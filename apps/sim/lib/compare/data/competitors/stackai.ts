...
export const stackaiProfile: CompetitorProfile = {
  ...
  limitations: [
    {
      ...
      shortDescription: 'Free includes 500 monthly runs, 2 projects, and 1 seat.',
      source: {
        url: 'https://www.stackai.com/pricing',
        label: 'StackAI Pricing – Plans for Teams & Enterprise',
        asOf: '2026-09-13',
  ...
  facts: {
    platform: {
      ...
      license: {
        value:
          'Commercial platform offered under subscription terms for SaaS and on-premise purchases.',
        shortValue: 'Commercial subscription platform',
        confidence: 'verified',
        sources: [
          {
            url: 'https://asana.com/terms/asana-product-specific-terms-071026',
            label: 'Asana Product-Specific Terms (June 22, 2026)',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    security: {
      ...
      compliance: {
        ...
        shortValue: 'Vendor-reported SOC 2 Type II and ISO 27001',
        confidence: 'verified',
        sources: [
          {
      ...
      credentialGovernance: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.stackai.com/welcome-to-stackai/security-and-governance/security-in-stackai/workspace-and-folder-access',
            label: 'Workspace and Folder Access',
            asOf: '2026-09-13',
          },
        ],
        detail:
    ...
    observability: {
      ...
      dataDrains: {
        ...
        shortValue: 'Scheduled exports/webhooks for selected security use cases',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.stackai.com/welcome-to-stackai/security-and-governance/ai-governance',
  ...
  oneLinerSources: [
    ...
    {
      url: 'https://investors.asana.com/news-releases/news-release-details/asana-acquires-stackai-adding-cross-system-execution-human-agent',
      label: 'Asana Acquires StackAI, Adding Cross-System Execution for Human-Agent Teams',
      asOf: '2026-09-13',
    },
    {
      url: 'https://www.stackai.com/pricing',
