...
export const microsoftCopilotProfile: CompetitorProfile = {
  ...
  facts: {
    platform: {
      ...
      customBlocks: {
        ...
        sources: [
          ...
          {
            url: 'https://learn.microsoft.com/en-us/microsoft-copilot-studio/guidance/generative-orchestration',
            label: 'Apply generative orchestration capabilities',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    aiCapabilities: {
      ...
      agentSkills: {
        value: 'Reusable Markdown skills for agents powered by the GitHub Copilot harness',
        detail:
        ...
        shortValue: 'Markdown skills (GitHub Copilot harness)',
        confidence: 'verified',
        sources: [
          {
            url: 'https://learn.microsoft.com/en-us/microsoft-copilot-studio/agents-experience/skills-overview',
      ...
      loopIteration: {
        ...
        detail:
          'Express-mode (preview) documentation specifies limits for both loop types; constraints depend on the execution mode.',
    ...
    security: {
      ...
      auditLogging: {
        value:
          'Copilot Studio activity can be audited in Microsoft Purview outside FedRAMP tenants',
        detail:
          'Microsoft documents Copilot Studio-specific audit events and required licensing and access. The documented prerequisites exclude FedRAMP tenants, and some channels are excluded from interaction logging.',
        shortValue: 'Microsoft Purview auditing; FedRAMP tenants excluded',
        confidence: 'verified',
        sources: [
          {
    ...
    observability: {
      ...
      executionLimits: {
        value:
          'Agent-invoked flows must respond within 100 seconds; express mode (preview) has additional limits',
        detail:
          'Express mode is a preview for eligible upgraded environments, with a two-minute execution timeout, a 64 KB per-action message limit and a guideline of 100 executed actions including loop iterations. These are separate from the agent-tool contract’s 100-second response deadline.',
    ...
    support: {
      ...
      companyMaturity: {
        ...
        sources: [
          ...
          {
            url: 'https://learn.microsoft.com/en-us/power-platform/admin/support-overview',
            label: 'Support for Microsoft Power Platform and Dynamics 365 apps',
            asOf: '2026-09-13',
          },
        ],
      },
