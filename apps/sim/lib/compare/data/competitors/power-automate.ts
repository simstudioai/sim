...
/** Reviewed against current primary sources on 2026-09-13; unresolved claims remain qualified. */
  ...
  standoutFeatures: [
    {
      ...
      description:
        'Power Automate combines connector-based cloud workflows with attended and unattended desktop automation. Microsoft-hosted machines are available through the Hosted Process plan.',
      shortDescription: 'Cloud workflows and desktop RPA in one product family.',
      source: {
    ...
    },
    {
      ...
      description:
        'The Power Platform admin center provides reports on runs, usage, errors, sharing and connectors. These reports exclude solution-aware flows and are unavailable in government and sovereign clouds.',
      shortDescription: 'Non-solution flow analytics outside government and sovereign clouds.',
      source: {
  ...
  facts: {
    platform: {
      ...
      versionControlDepth: {
        ...
        shortValue: 'New-designer solution history; desktop comparison subject to rollout',
        confidence: 'verified',
        sources: [
          {
            url: 'https://learn.microsoft.com/en-us/power-automate/drafts-versioning',
    ...
    aiCapabilities: {
      ...
      evaluationGuardrails: {
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'Choose evaluation methods - Microsoft Copilot Studio | Microsoft Learn',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      generativeMedia: {
        value:
          'AI Builder offers text generation and image description (preview); a native image/video/audio generation suite is not confirmed',
        detail:
          'The AI Builder catalog documents prompt actions and preview image-description actions. Media-generating integrations need separate verification of the chosen provider and connector.',
    ...
    pricing: {
      ...
      entryPaidPlan: {
        value: 'US advertised price: Premium $15 per user/month, paid yearly',
        detail:
    ...
    observability: {
      tracingDepth: {
        ...
        detail:
          'Action inputs and outputs help diagnose failures. The cited admin analytics exclude solution-aware flows and government/sovereign clouds; permissions and configuration affect visibility.',
        shortValue: 'Run history; non-solution analytics outside government/sovereign clouds',
        confidence: 'verified',
        sources: [
          {
          ...
          {
            url: 'https://learn.microsoft.com/en-us/power-automate/guidance/coding-guidelines/use-secure-inputs-outputs-triggers',
            label: 'Secure data used in cloud flows - Power Automate | Microsoft Learn',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      failureAlerting: {
        ...
        shortValue: 'Selective failure emails and weekly digest',
        confidence: 'verified',
        sources: [
          {
            url: 'https://learn.microsoft.com/en-us/power-automate/understand-flow-failure-notifications',
