  ...
  facts: {
    ...
    integrations: {
      ...
      codeSandboxRuntime: {
        ...
        shortValue: 'Desktop scripting actions load external modules; cloud runtime is fixed',
        confidence: 'verified',
        sources: [
          {
