...
/** Reviewed against current primary sources on 2026-09-13. */
export const gumloopProfile: CompetitorProfile = {
  ...
  brand: {
    ...
    socials: [
      {
        type: 'x',
        url: 'https://x.com/gumloop',
      },
      {
        type: 'linkedin',
        url: 'https://linkedin.com/company/gumloop',
      },
      {
        type: 'youtube',
        url: 'https://youtube.com/@Gumloop_AI',
      },
    ],
  ...
  standoutFeatures: [
    {
      ...
      source: {
        url: 'https://docs.gumloop.com/core-concepts/brain',
        label: 'Gumloop: Brain',
        asOf: '2026-09-13',
      },
    },
    ...
    },
    {
      ...
      source: {
        url: 'https://docs.gumloop.com/core-concepts/organization_skills',
    ...
    },
    {
      ...
      source: {
        url: 'https://docs.gumloop.com/core-concepts/evaluations',
    ...
    },
    {
      ...
      description: 'The vendor advertises managed connections to more than 250 MCP servers.',
  ...
  limitations: [
    ...
    },
    {
      ...
      description:
        'Agent runs incur tool and orchestration charges; compute is waived for Enterprise customers running in their own VPC. BYOK removes model credits but raises the standard agent orchestration rate to 16%; provider tokens are billed separately.',
      shortDescription: 'BYOK still carries agent orchestration and other charges.',
      source: {
        url: 'https://docs.gumloop.com/core-concepts/credits',
  ...
  facts: {
    platform: {
      builderType: {
        ...
        sources: [
          ...
          {
            url: 'https://www.gumloop.com/blog/gummie-agent',
            label: 'Gummie Agent: Let Gumloop build for you',
            asOf: '2026-09-13',
          },
          {
            url: 'https://www.gumloop.com/pricing',
      ...
      environmentPromotion: {
        value:
          'GitHub-backed organization skills; current workflow checkpoint behavior unconfirmed',
        shortValue: 'GitHub skill sync; workflow checkpoints unconfirmed',
        detail:
          'Organization skills synchronize from a selected GitHub branch. The vendor’s May 11, 2026 changelog documents restoring previous workflow versions. Current checkpoint controls and staged-promotion behavior remain unconfirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/organization_skills',
          ...
          },
          {
            ...
            label: 'Gumloop: Workflow version restoration in May 11 changelog',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      realtimeCollaboration: {
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/teams',
            label: 'Gumloop: Organization and Teams',
            asOf: '2026-09-13',
          },
        ],
      },
      nativeFileStorage: {
        value:
          'Stored, versioned agent artifacts with previews and controlled sharing; folder hierarchy and deleted-item recovery controls unconfirmed',
        shortValue: 'Versioned artifacts; full file-storage controls unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agent_artifacts',
      ...
      subWorkflows: {
        value:
          'Subflows are referenced in vendor guidance; current saved-workflow reuse and port details are unconfirmed',
        shortValue: 'Subflows documented; reuse and port details unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://forum.gumloop.com/t/how-does-error-shield-actually-works/3145',
            label: 'How does Error Shield actually works? — Gumloop staff replies',
            asOf: '2026-09-13',
          },
        ],
      },
      customBlocks: {
        value:
          'Custom MCP nodes are documented; shared workflow-block publishing remains unconfirmed',
        shortValue: 'Custom MCP nodes; workflow-block publishing unconfirmed',
        detail:
          'Gumloop documents AI-generated Python nodes for integrations. Current organization library sharing and hidden workflow internals were not confirmed.',
        confidence: 'estimated',
        sources: [
          {
    ...
    aiCapabilities: {
      multiLlmSupport: {
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/ai_models',
      ...
      agentReasoningBlocks: {
        value:
          'Yes: autonomous agents choose tools. Agent steps inside the legacy workflow canvas are not confirmed in current public documentation.',
        shortValue: 'Tool-using agents; workflow-canvas steps unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agents',
      ...
      knowledgeBaseRag: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.gumloop.com/api-reference/brain/search',
      ...
      mcpSupport: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.gumloop.com/mcp-server/overview',
      ...
      humanInTheLoop: {
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/human_in_the_loop',
      ...
      generativeMedia: {
        ...
        detail:
          'The ElevenLabs MCP integration also documents speech and video generation. Separate native video or text-to-speech abilities were not confirmed.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agents',
          ...
          {
            url: 'https://www.gumloop.com/mcp/elevenlabs',
            label: 'Gumloop: ElevenLabs MCP speech and video tools',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      nativeChatDeployment: {
        value: 'Yes: standalone hosted agent chat pages requiring Gumloop sign-in',
        shortValue: 'Hosted chat; Gumloop sign-in required',
        detail:
          'Hosted pages use gumloopagents.com. Users must sign in and have sufficient agent access; tool credentials and credit usage normally belong to the chatting user.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/hosted_pages',
      ...
      parallelExecution: {
        value: 'Yes: subagents execute concurrently and return results',
        shortValue: 'Parallel subagents',
        detail:
          'Subagent concurrency depends on subscription. Current workflow Loop Mode concurrency limits could not be confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agents',
      ...
      loopIteration: {
        value: 'Yes: workflow nodes can iterate over inputs in Loop Mode',
        shortValue: 'List iteration through Loop Mode',
        detail:
          'Vendor guidance describes per-item execution. Current concurrency limits and a separate while-loop container were not confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://forum.gumloop.com/t/how-does-error-shield-actually-works/3145',
    ...
    integrations: {
      ...
      triggerTypes: {
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agent_triggers',
            label: 'Gumloop: Agent Triggers',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.gumloop.com/api-reference/getting-started',
            label: 'Gumloop: Getting Started',
            asOf: '2026-09-13',
          },
        ],
      },
      customCodeSteps: {
        value: 'Yes: Python workflow MCP nodes and Python/shell agent sandboxes',
        shortValue: 'Python nodes and Python/shell agent sandboxes',
        confidence: 'verified',
        sources: [
          {
            url: 'https://www.gumloop.com/blog/introducing-mcp-workflows',
      ...
      codeSandboxRuntime: {
        ...
        detail:
          'Editors can persist packages across agent chats; viewer installs are session-only. Commands have a 30-minute timeout.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/agent_sandbox_and_secrets',
      ...
      apiPublishing: {
        value: 'Yes: agent/session APIs and workflow execution through the JavaScript SDK',
      ...
      mcpPublishing: {
        value:
          'Yes: Gumloop MCP Server starts asynchronous agent interactions and retrieves their results',
        shortValue: 'Agents callable through Gumloop MCP',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/mcp-server/overview',
    ...
    pricing: {
      pricingModel: {
        ...
        detail:
          'Enterprise customers running in their own VPC are not charged for compute and may negotiate orchestration rates. Current workflow-specific fee exemptions could not be confirmed.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/credits',
      ...
      freeTier: {
        value: 'A 14-day Pro trial requiring a card for new accounts',
      ...
      byok: {
        value:
          'Yes: Pro+ waives model credits with your key; the standard agent orchestration rate becomes 16%',
        shortValue: 'BYOK waives model credits; other charges remain',
        detail:
          'You pay the provider directly. Tool charges remain; compute is waived for Enterprise customers running in their own VPC. The agent fee uses the run’s pre-waiver value. A negotiated Enterprise orchestration rate increases by 8 percentage points with BYOK.',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/credits',
    ...
    security: {
      dataResidency: {
        ...
        sources: [
          {
            url: 'https://www.gumloop.com/solutions/security',
            label: 'Gumloop: Security and trust at Gumloop',
            asOf: '2026-09-13',
          },
          {
            url: 'https://www.gumloop.com/pricing',
      ...
      rbac: {
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/organization_user_roles',
      ...
      compliance: {
        ...
        shortValue: 'Vendor-reported SOC 2 II; HIPAA/BAA; GDPR alignment',
        detail:
      ...
      modelAndToolGovernance: {
        ...
        detail:
          'App Rules are documented at organization and agent scope. The plan tier each scope requires was not confirmed from the cited sources.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/enterprise-features/ai_model_control',
            label: 'Gumloop: AI Model Governance & Configuration',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.gumloop.com/enterprise-features/user_groups',
            label: 'Gumloop: Custom Roles',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.gumloop.com/enterprise-features/app-policies/app-rules',
      ...
      credentialGovernance: {
        value:
          'Personal and team credentials, organization-wide model-provider keys, and role-gated pinned agent accounts',
        ...
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/credentials',
      ...
      thirdPartyVetting: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.gumloop.com/nodes/mcp/custom_mcp_servers',
            label: 'Gumloop: Custom MCP Servers',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    observability: {
      tracingDepth: {
        value:
          'Enterprise organization usage dashboards and agent chat credit breakdowns; current per-node trace details unconfirmed',
        shortValue: 'Enterprise insights and chat cost breakdowns',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.gumloop.com/enterprise-features/organization_insights',
      ...
      durabilityModel: {
        value: 'Agents save state for human approvals and retry unavailable models with fallbacks',
        shortValue: 'Approval pause/resume and model fallback',
        detail:
      ...
      failureAlerting: {
        value:
          'Yes: agent evaluation notifications and alerts when triggers disable after three consecutive failures',
        shortValue: 'Evaluation and disabled-trigger alerts',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/core-concepts/evaluations',
      ...
      asyncExecution: {
        value: 'Yes: asynchronous agent sessions with retrievable state and results',
        shortValue: 'Asynchronous agent sessions',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.gumloop.com/api-reference/sessions/create-session',
            label: 'Create session — Gumloop API',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.gumloop.com/api-reference/sessions/retrieve-session',
            label: 'Retrieve session — Gumloop API',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      partialFailureHandling: {
        ...
        detail:
          'In vendor guidance, Loop Mode errors skip failed items; outside Loop Mode, Pass Inputs Through exposes failed inputs for handling.',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://forum.gumloop.com/t/how-does-error-shield-actually-works/3145',
    ...
    support: {
      supportChannels: {
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'Gumloop: Gumloop University',
            asOf: '2026-09-13',
          },
          {
            url: 'https://forum.gumloop.com/',
            label: 'Gumloop Forum',
            asOf: '2026-09-13',
          },
        ],
      ...
      community: {
        ...
        sources: [
          {
            url: 'https://www.gumloop.com/templates',
            label: 'Gumloop: Gumloop Community Templates',
            asOf: '2026-09-13',
          },
          {
            url: 'https://forum.gumloop.com/',
