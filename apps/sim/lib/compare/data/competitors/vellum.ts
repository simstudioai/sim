...
export const vellumProfile: CompetitorProfile = {
  ...
  facts: {
    platform: {
      ...
      templates: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.vellum.ai/product/workflows/examples/overview',
            label: 'Vellum workflow examples and walkthroughs',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      license: {
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'Vellum Assistant repository — License',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      environmentPromotion: {
        value:
          'Release promotion between environments; full project/workspace promotion unconfirmed',
        shortValue: 'Release promotion; workspace promotion unconfirmed',
        confidence: 'estimated',
        sources: [
          {
        ...
        detail:
          'API keys, deployed releases, monitoring data, and configuration are environment-scoped; sandbox definitions are shared. Full project/workspace cloning and promotion were not established.',
      },
      versionControlDepth: {
      ...
      richTextEditor: {
        value: 'Markdown Note Nodes; standalone document editor unconfirmed',
        shortValue: 'Markdown notes; document editor unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.vellum.ai/changelog/2025/2025-09',
            label: 'Vellum September 2025 — Markdown Editor in Note Nodes',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Note Nodes support rich markdown formatting for workflow annotations. A standalone rich-text document editor for the workflow platform remains unconfirmed.',
      },
      subWorkflows: {
      ...
      customBlocks: {
        value: 'Custom code nodes in the palette; published workflow blocks unconfirmed',
        shortValue: 'Custom code nodes; workflow blocks unconfirmed',
        confidence: 'estimated',
        sources: [
          {
        ...
        detail:
          'Custom-image nodes can be dragged into workflows. Publishing a deployed workflow as a named organization block without underlying-flow access was not established.',
      },
    },
    aiCapabilities: {
      multiLlmSupport: {
      ...
      generativeMedia: {
        value: 'Image, video, and audio generation through Builder-generated custom API nodes',
        shortValue: 'Media generation through custom API nodes',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.vellum.ai/changelog/2025/2025-11',
            label: 'Vellum November 2025 — Multi-Modal Workflow Outputs',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Agent Builder can generate custom nodes that call media-generation APIs. A fixed catalog of built-in image, video, and TTS/STT nodes and providers remains unconfirmed.',
      },
      dynamicToolUse: {
        value: 'Runtime selection among configured tools; broader tool discovery unconfirmed',
        shortValue: 'Configured tools; broader discovery unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.vellum.ai/product/workflows/nodes/agent-node',
      ...
      agentSkills: {
        ...
        sources: [
          ...
          {
            url: 'https://github.com/vellum-ai/vellum-assistant',
            label: 'Vellum Assistant repository — Skills',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.vellum.ai/product/workflows/nodes/overview',
            label: 'Vellum Nodes Overview — Prompt Deployment Node',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      nativeChatDeployment: {
        value: 'Deployed AI App chat UI and custom Chat Agent interfaces',
        shortValue: 'Deployed chat interfaces; public access unconfirmed',
        confidence: 'estimated',
        sources: [
          {
          ...
          {
            url: 'https://docs.vellum.ai/changelog/2025/2025-09',
            label: 'Vellum September 2025 — AI App UI',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.vellum.ai/changelog/2026/2026-02',
            label: 'Vellum February 2026 — Custom Interfaces for Chat Agents',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'AI App UI runs deployed workflows for end users; custom Chat Agent interfaces publish alongside workflows. Confirm anonymous/public-access requirements for the intended deployment.',
      },
      kbChunkVisibility: {
    ...
    security: {
      ...
      auditLogging: {
        ...
        shortValue: 'Execution records and monitoring webhooks',
        confidence: 'estimated',
        sources: [
          {
      ...
      dataRetention: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.vellum.ai/changelog/2025/2025-09',
            label: 'Vellum September 2025 — Retention change',
            asOf: '2026-09-13',
          },
          {
            url: 'https://docs.vellum.ai/product/organizations/data-retention-policies.md',
            label: 'Vellum Data Retention Policies',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'The documentation conflicts on defaults: the September 4, 2025 changelog says new organizations default to 30 days, while the policy guide still says indefinite retention. Existing organizations keep their settings. Confirm the organization’s retention policy and plan eligibility.',
      },
      piiRedaction: {
        value: 'Not confirmed in the reviewed public documentation',
        shortValue: 'Not confirmed in public documentation',
      ...
      sso: {
        value:
          'A vendor workflow-platform article advertises Enterprise SSO; protocol and provisioning details are unconfirmed.',
        shortValue: 'Vendor-advertised Enterprise SSO; configuration unconfirmed',
        confidence: 'estimated',
        sources: [
          {
          ...
          {
            url: 'https://www.vellum.ai/blog/gumloop-vs-n8n-vs-vellum',
            label: 'Vellum workflow-platform comparison — Enterprise pricing',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'A vendor workflow-platform article lists Enterprise SSO, but SAML/OIDC configuration and provisioning behavior were not established.',
      },
      sessionPolicy: {
        value: 'Not confirmed in the reviewed public documentation',
        shortValue: 'Not confirmed in public documentation',
    ...
    observability: {
      ...
      durabilityModel: {
        value: 'Retry adornments and visual workflow replay/debugging controls',
        shortValue: 'Node retries and visual execution replay',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.vellum.ai/product/workflows/nodes/overview',
  ...
  oneLinerSources: [
    ...
    {
      url: 'https://docs.vellum.ai/',
      label: 'Vellum development-platform overview',
      asOf: '2026-09-13',
    },
    {
      url: 'https://www.vellum.ai',
      label: 'Vellum Assistant website',
      asOf: '2026-09-13',
    },
  ],
}
