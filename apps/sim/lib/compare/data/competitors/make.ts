...
export const makeProfile: CompetitorProfile = {
  ...
  oneLiner:
    'Make is a managed visual automation platform with app modules, AI Agents (open beta), MCP tools, and paid-plan JavaScript/Python steps (open beta). Subscription plans meter usage in credits.',
  standoutFeatures: [
    {
      title: 'Conversational workflow building',
      description:
        'Maia creates and modifies scenarios and AI Agents through conversation. It is in public beta, with paid-plan access and a Free-plan trial of up to 30 days and 45 messages.',
    ...
    },
    {
      ...
      description:
        'AI Agent modules, in open beta, show execution steps, token usage, and reasoning supplied by supported models.',
      shortDescription: 'Inspect open-beta agent execution steps and model-provided reasoning.',
      source: {
  ...
  limitations: [
    ...
    },
    {
      ...
      description:
        'Custom organization and team roles require Enterprise. Enterprise admins and owners can define the permissions for these roles.',
  ...
  facts: {
    platform: {
      builderType: {
        value:
          'Visual scenario canvas with app modules, flow control, AI Agents (open beta), and optional code steps (open beta).',
        shortValue: 'Visual canvas; agent and code features in beta',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-app',
      ...
      dataTables: {
        ...
        shortValue: 'Structured records with manual editing',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.make.com/l6du-data-stores',
      ...
      richTextEditor: {
        ...
        sources: [
          ...
          {
            url: 'https://apps.make.com/google-docs-modules',
            label: 'Make: Google Docs modules',
            asOf: '2026-09-13',
          },
        ],
        detail:
      ...
      customBlocks: {
        value:
          'Reusable scenarios can be called through the Call a Scenario module. A toolbar-published, iconized block distinct from subscenarios was not found in Make documentation.',
    ...
    aiCapabilities: {
      ...
      agentReasoningBlocks: {
        value:
          'Make AI Agents (New), in open beta, expose execution steps, token usage, and model-provided reasoning when available.',
        shortValue: 'Open beta: agent modules with execution visibility',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-app',
      ...
      naturalLanguageBuilding: {
        ...
        detail:
          'Available on paid plans, with a Free-plan trial lasting up to 30 days from signup and including 45 messages. Users review and activate the resulting scenarios.',
      },
      knowledgeBaseRag: {
      ...
      humanInTheLoop: {
        value:
          'The Human in the Loop app provides review-request workflows for invited Enterprise customers in closed beta.',
        shortValue: 'Enterprise invitation-only beta: review requests',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-best-practices',
          ...
          },
          {
            ...
            label: 'Make: Human in the Loop',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Agent workflows can also request review through configured tools such as Slack; that instruction-based pattern does not establish an enforced durable pause.',
      },
      generativeMedia: {
      ...
      dynamicToolUse: {
        ...
        shortValue: 'Selects among configured tools',
        confidence: 'verified',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-app',
      ...
      modelFallback: {
        value:
          'The OpenRouter integration supports configured fallback models; automatic failover in Make AI Agent configuration remains unconfirmed.',
        shortValue: 'Partial: OpenRouter fallback; Agent fallback unconfirmed',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-app',
          ...
          {
            url: 'https://www.make.com/en/integrations/open-router',
            label: 'Make: OpenRouter integration',
            asOf: '2026-09-13',
          },
        ],
      },
      agentSkills: {
        value:
          'Reusable scenario tools are documented, and Make Skills provides packages for external AI assistants in open beta.',
        shortValue: 'Open-beta external skills; native snippets unconfirmed',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://help.make.com/make-ai-agent-new-best-practices',
          ...
          {
            url: 'https://help.make.com/make-skills',
            label: 'Make: Make Skills',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Make Skills uses ZIP/Markdown packages for assistants such as Claude and Codex. A reusable user-defined prompt/knowledge snippet registry within Make AI Agents was not confirmed.',
      },
    ...
    integrations: {
      ...
      customCodeSteps: {
        value: 'Make Code runs JavaScript or Python on paid plans in open beta.',
        shortValue: 'Open beta: paid-plan JavaScript and Python',
        confidence: 'verified',
        sources: [
          {
            url: 'https://apps.make.com/code',
      ...
      mcpPublishing: {
        ...
        detail:
          'Toolbox keys authorize client access; tool annotations describe intended behavior to clients that support them.',
      },
    },
    pricing: {
      pricingModel: {
        value:
          'Subscription plans with included credits; module actions usually cost one credit, while some AI and code operations vary.',
      ...
      entryPaidPlan: {
        value:
          'Core is $12 per month with annual billing or $16 with monthly billing at 10,000 monthly credits.',
        shortValue: 'Core: $12/month annually; $16/month monthly',
        confidence: 'verified',
        sources: [
          {
            url: 'https://www.make.com/en/pricing',
        ...
        detail:
          'The quoted prices are in USD at the 10,000-credit tier; the price changes with billing term and credit volume.',
      },
      freeTier: {
        value:
    ...
    security: {
      ...
      dataRetention: {
        ...
        sources: [
          ...
          {
            url: 'https://help.make.com/knowledge-files-for-ai-agents',
            label: 'Knowledge files for AI agents',
            asOf: '2026-09-13',
          },
        ],
