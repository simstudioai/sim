...
export const crewaiProfile: CompetitorProfile = {
  ...
  limitations: [
    ...
    {
      title: 'Agent customization uses Python APIs',
      description:
        'The Agents guide documents JSONC configuration and Python APIs for defining agents and their behavior.',
      shortDescription: 'Programmatic agent configuration uses Python.',
      source: {
  ...
  facts: {
    platform: {
      ...
      learningCurve: {
        value:
          'The framework supports JSONC crew configuration and Python customization; Studio offers a visual and natural-language entry point.',
        detail:
          'This is an editorial assessment of the documented workflows, not a benchmark of learning time.',
        shortValue: 'JSONC or Python; visual/natural-language Studio',
    ...
    aiCapabilities: {
      ...
      evaluationGuardrails: {
        ...
        detail:
          'Guardrails validate or transform output and can retry failed validation. Plan scope needs confirmation: AMP docs describe the hallucination guardrail as an enterprise feature, while the pricing table lists guardrails and hallucination scores for both Basic and Enterprise.',
        shortValue: 'Task validators and hallucination checks; plan scope unclear',
        confidence: 'estimated',
        sources: [
          {
      ...
      humanInTheLoop: {
        ...
        detail:
          'The default provider uses console input; custom nonblocking providers can integrate Slack or webhooks. Enterprise Flow HITL management adds centralized review and requires CrewAI 1.8.0 or later.',
      ...
      nativeChatDeployment: {
        ...
        sources: [
          ...
          {
            url: 'https://docs-platform.crewai.com/platform/en/guides/react-component-export',
            label: 'CrewAI Docs: React component export',
            asOf: '2026-09-13',
          },
        ],
      },
      kbChunkVisibility: {
        value:
          'Partial: the framework exposes knowledge chunks for inspection in code; a dedicated platform chunk browser is not confirmed.',
        detail:
          'Knowledge retrieval events expose retrieved content, and the debugging example enumerates chunk indexes and text. A built-in visual chunk browser is not established.',
        shortValue: 'Code-level chunk inspection; visual browser unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.crewai.com/en/concepts/knowledge',
    ...
    security: {
      ...
      auditLogging: {
        value: 'CrewAI advertises immutable audit trails in its enterprise Control Plane.',
        detail:
          'The public homepage lists audit alongside RBAC and enterprise identity management. Covered administrative events, retention periods, and export capabilities are not specified there.',
        shortValue: 'Vendor-reported immutable audit trails',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://www.crewai.com',
            label: 'CrewAI Control Plane — Govern',
            asOf: '2026-09-13',
          },
        ],
      },
      compliance: {
        value:
          'CrewAI reports SOC 2 Type 2 in its Trust Center; its pricing table lists “Fed Ramp High” for Enterprise. The public pages do not establish FedRAMP authorization status or scope.',
        detail:
          'The Trust Center lists a June 2026 SOC 2 Type 2 report and a February 2026 HIPAA audit report behind access requests. Report contents and ISO 27001, PCI DSS, and FedRAMP authorization scope were not verified.',
        shortValue: 'Vendor-reported SOC 2 Type 2; audit scope unverified',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://crewai.com/pricing',
      ...
      credentialGovernance: {
        value:
          'Partial: entity-level RBAC restricts access to specific environment variables and LLM configurations; runtime credential-use restrictions are not established.',
        detail:
          'Secret-provider features have role permissions for referencing and managing credentials. Availability depends on enabled features; the docs do not establish per-credential restrictions on a deployed run.',
        shortValue: 'Credential access RBAC; runtime use unconfirmed',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs-platform.crewai.com/platform/en/features/rbac',
    ...
    observability: {
      ...
      partialFailureHandling: {
        value:
          'Partial: task guardrails retry validation failures, and tool-failure policies can continue or abort execution.',
        detail:
          'The default warn policy records tool failures and continues; raise aborts execution. Python can handle other errors, and continuation after every unhandled failure is not guaranteed.',
        shortValue: 'Guardrail retries and tool-failure continuation policies',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.crewai.com/en/concepts/tasks',
          ...
          {
            url: 'https://docs.crewai.com/en/concepts/tools',
            label: 'CrewAI Docs: Tool failure policies',
            asOf: '2026-09-13',
          },
        ],
      },
