...
export const workatoProfile: CompetitorProfile = {
  ...
  standoutFeatures: [
    {
      ...
      shortDescription:
        'Promote and roll back project assets across environments on eligible plans.',
      source: {
    ...
    },
    {
      ...
      description:
        'On eligible plans, on-prem agents connect private systems to Workato through outbound encrypted connections, with agent groups for high availability.',
      shortDescription:
        'Connect private systems through outbound on-prem agents on eligible plans.',
      source: {
  ...
  limitations: [
    {
      title: 'Additional Python snippet packages are unsupported',
      description:
  ...
  facts: {
    platform: {
      ...
      selfHostOption: {
        ...
        detail:
          'On-prem agents connect private systems. API Edge Gateway provides a local data plane for API proxy collections, with a cloud control plane; recipe collections are not supported on the edge gateway.',
      },
      deploymentOptions: {
        value:
      ...
      templates: {
        value:
          'The Community Library provides reusable recipes, connectors, and skills outside the China data center.',
        shortValue: 'Community recipes, connectors, skills; excludes China data center',
        confidence: 'verified',
        sources: [
          {
      ...
      nativeFileStorage: {
        ...
        detail:
          'The documented limits include 10 GB per file and 100 GB storage per environment; access must be enabled for eligible plans.',
      },
      dataTables: {
        value:
    ...
    aiCapabilities: {
      ...
      mcpSupport: {
        value:
          'Outside the China data center, Enterprise MCP exposes governed tools to external clients with discovery, identity, and access controls.',
        shortValue: 'Enterprise MCP; excludes China data center',
        confidence: 'verified',
        sources: [
          {
      ...
      evaluationGuardrails: {
        value:
          'Agent Studio documents skill test cases and a beta Guardrails API applying content policies to each chat turn.',
      ...
      nativeChatDeployment: {
        ...
        shortValue: 'Partial: Slack, Teams, and Workato GO chat',
        confidence: 'unknown',
        sources: [
          {
        ...
        detail:
          'Custom chat interfaces support API-key or OAuth authentication; a native public web-chat deployment was not confirmed.',
      },
      kbChunkVisibility: {
        value:
          'Conversation details list that a knowledge-base lookup occurred; the raw lookup inputs and outputs require recipe Job history, a separate view. An indexed chunk browser was not confirmed.',
        shortValue: 'Partial: lookup I/O inspection; chunk-index UI unconfirmed',
        confidence: 'unknown',
        sources: [
          {
            url: 'https://docs.workato.com/en/agentic/agent-studio/knowledge-bases/data-ingestion.html',
          ...
          {
            url: 'https://docs.workato.com/en/agentic/agent-studio/conversations',
            label: 'Workato: Conversations page',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      loopIteration: {
        value:
          'Recipes support list iteration, batched iteration, and condition-based do-while loops.',
    ...
    integrations: {
      ...
      apiPublishing: {
        value:
          'On eligible plans, API Management publishes recipes as endpoints and manages API proxies, access policies, and usage.',
        shortValue: 'Recipe APIs and API management (plan-dependent)',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/api-management.html',
      ...
      mcpPublishing: {
        value:
          'Outside the China data center, Enterprise MCP publishes recipe-backed tools and skills with client access controls.',
        shortValue: 'Governed MCP publishing; excludes China data center',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/mcp.html',
          ...
          {
            url: 'https://docs.workato.com/mcp/mcp-servers.html',
            label: 'Workato: MCP server creation',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    pricing: {
      pricingModel: {
        value:
          'For direct customers on usage-based pricing, subscriptions combine platform edition and usage fees. Self-service plans use credit allowances.',
        shortValue: 'Usage-based platform/usage fees; self-service credits',
        confidence: 'verified',
        sources: [
          {
        ...
        detail:
          'Customers who joined before February 2024 may have a separate pricing model; the contract determines their terms.',
      },
      entryPaidPlan: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.workato.com/en/pricing',
            label: 'Pricing | Workato docs',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'Contact Workato for Enterprise pricing; additional capabilities depend on the contract and plan.',
      },
      freeTier: {
    ...
    security: {
      ...
      auditLogging: {
        ...
        shortValue: 'Activity audit logs; streaming is plan-dependent',
        confidence: 'verified',
        sources: [
          {
      ...
      modelAndToolGovernance: {
        ...
        shortValue: 'Plan-dependent AI Gateway routes/keys; MCP access',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/en/ai-gateway',
      ...
      dataRetention: {
        value:
          'On usage-based plans, job data retention is 30 days for Standard/Business and up to 90 days for Enterprise; Enterprise retention windows are configurable.',
        shortValue: '30 days Standard/Business; configurable Enterprise retention',
        confidence: 'verified',
        sources: [
          {
        ...
        detail:
          'Enterprise retention can be reduced to one hour. Recipe settings can disable stored job data; legacy-plan customization depends on the workspace and purchased capabilities.',
      },
      piiRedaction: {
        value:
        ...
        detail:
          'Step masking is plan-dependent. These controls have different scopes and do not establish automatic redaction of all platform data.',
      },
      sso: {
        value:
    ...
    observability: {
      tracingDepth: {
        value:
          'Job debug tracing exposes HTTP request/response details for test and repeated jobs; the Logging Service collects configured recipe logs.',
        shortValue: 'Test/rerun tracing and configured recipe logs',
        confidence: 'verified',
        sources: [
          {
        ...
        detail:
          'Tracing requires enablement for eligible users. Configured recipe logging uses explicit Logger steps and is plan-dependent.',
      },
      durabilityModel: {
        value:
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'Recipe jobs | Workato docs',
            asOf: '2026-09-13',
          },
        ],
      ...
      dataDrains: {
        ...
        shortValue: 'External activity/job log streaming (plan-dependent)',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/features/activity-audit-log-streaming.html',
      ...
      executionLimits: {
        ...
        shortValue: '90 active min default; recipe concurrency 1–30',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/recipes/jobs.html',
      ...
      unattendedExecution: {
        ...
        sources: [
          ...
          {
            url: 'https://docs.workato.com/cloud-hosting-editions/hosting-editions.html',
            label: 'Virtual Private Workato | Workato docs',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    support: {
      ...
      community: {
        value:
          'Outside the China data center, the Community Library enables sharing and reuse of recipes, skills, and connectors.',
        shortValue: 'Community recipes, skills, connectors; excludes China data center',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.workato.com/community-library.html',
  ...
  oneLinerSources: [
    ...
    {
      url: 'https://docs.workato.com/en/pricing/self-service/self-service',
      label: 'Self-service pricing | Workato docs',
      asOf: '2026-09-13',
    },
  ],
}
