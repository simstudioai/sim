...
export const langflowProfile: CompetitorProfile = {
  ...
  facts: {
    ...
    aiCapabilities: {
      ...
      generativeMedia: {
        value:
          'Partial: the optional EmpirioLabs AI bundle provides text-to-image generation with a provider API key. The Playground microphone supports transcription; full voice mode was deprecated in 1.10, although voice WebSocket endpoints remain available. Native video generation was not verified.',
        shortValue: 'Optional image generation and transcription; video generation unverified',
        confidence: 'estimated',
        sources: [
          {
          ...
          {
            url: 'https://docs.langflow.org/bundles-empiriolabs',
            label: 'Langflow: EmpirioLabs AI image generation',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      modelFallback: {
        value:
          'Partial: LLM Selector can use the first connected model when model selection or routing fails, with fallback enabled by default. Automatic failover for every model/provider error or rate limit was not verified.',
        shortValue: 'LLM Selector fallback; general provider failover unverified',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.langflow.org/llm-selector',
            label: 'Langflow: LLM Selector fallback settings',
            asOf: '2026-09-13',
          },
        ],
      },
      ...
      nativeChatDeployment: {
        value:
          'Yes: the official Embedded Chat widget adds chat to applications. Server deployments also offer a Shareable Playground for testing only; it is unavailable in Langflow Desktop.',
        shortValue: 'Chat embed; testing-only Shareable Playground unavailable on Desktop',
        confidence: 'verified',
        sources: [
          {
      ...
      parallelExecution: {
        value:
          'The Build flows guide describes sequential dependency execution. The optional File Processing bundle documents Merge Flows for synchronizing parallel upstream pipelines. General concurrent branch-and-join behavior remains unverified.',
        shortValue: 'Optional pipeline merge documented; general concurrency unverified',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://docs.langflow.org/concepts-flows',
          ...
          {
            url: 'https://docs.langflow.org/bundles-files-ingestion',
            label: 'Langflow: File Processing and Merge Flows',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    observability: {
      ...
      unattendedExecution: {
        value:
          'Yes for server deployments: opt-in beta background jobs return immediately and can be checked later. The Langflow server must stay running; a local Desktop installation depends on that local process and machine.',
        shortValue: 'Opt-in beta background jobs; server must remain running',
        confidence: 'verified',
        sources: [
          {
            url: 'https://docs.langflow.org/workflow-api',
      ...
      academy: {
        ...
        sources: [
          ...
          },
          {
            ...
            label: 'Langflow: Create a vector RAG chatbot tutorial',
            asOf: '2026-09-13',
          },
        ],
      },
