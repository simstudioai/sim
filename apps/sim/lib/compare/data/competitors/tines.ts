...
/** Reviewed against public primary sources on 2026-09-13; unverified capabilities are labeled. */
export const tinesProfile: CompetitorProfile = {
  ...
  standoutFeatures: [
    {
      ...
      description:
        'Tines offers Stories and its newer 3B platform for apps, agents, and automation. Its launch announcement says Stories will continue to receive support and development.',
      shortDescription: 'Stories remains supported alongside the newer 3B platform.',
      source: {
  ...
  limitations: [
    ...
    },
    {
      ...
      description:
        'Stories and 3B are distinct products. Evaluate requirements against the product being purchased.',
  ...
  facts: {
    platform: {
      builderType: {
        ...
        sources: [
          {
            url: 'https://www.tines.com/stories/storyboard/',
            label: 'Stories Storyboard',
            asOf: '2026-09-13',
          },
          {
          ...
          },
          {
            ...
            label: 'Tines 3B product overview',
            asOf: '2026-09-13',
          },
          {
            url: 'https://www.tines.com/stories/docs/stories/story-runs/',
            label: 'Stories run/event model',
            asOf: '2026-09-13',
          },
        ],
      },
    ...
    security: {
      ...
      auditLogging: {
        ...
        detail:
          'Stories enhanced AI logs include model responses and tool inputs/outputs when enabled, so retention and access configuration matter.',
      },
      compliance: {
        value:
          'Tines reports SOC 2 Type II, ISO 27001, ISO 27701, and ISO 42001 for its management programs, and TX-RAMP Level 2 for Stories and 3B.',
        shortValue: 'Vendor-reported SOC 2/ISO/TX-RAMP; scope varies',
        confidence: 'verified',
        sources: [
          {
            url: 'https://www.tines.com/security/',
          ...
          {
            url: 'https://trust.tines.com/?itemUid=fa950d02-cbb3-4010-b917-7137a7c2a982&source=click',
            label: 'Tines Trust Center — SOC 2 Type II scope',
            asOf: '2026-09-13',
          },
        ],
        detail:
          'The September 3 TX-RAMP announcement explicitly covers both products and says FedRAMP authorization is being pursued. The public Trust Center lists SOC 2 Type II without stating a product scope, so per-product coverage should be confirmed with Tines. Underlying reports and certificate scopes were not independently audited.',
      },
    ...
    support: {
      ...
      community: {
        ...
        sources: [
          ...
          {
            url: 'https://community.tines.com/',
            label: 'Tines Community',
            asOf: '2026-09-13',
          },
        ],
      },
  ...
  oneLinerSources: [
    ...
    {
      url: 'https://www.tines.com/blog/whats-new-in-tines-july-2026-edition/',
      label: 'July 2026 product update',
      asOf: '2026-09-13',
    },
  ],
}
