...
export const openaiAgentkitProfile: CompetitorProfile = {
  ...
  sectionIntros: {
    platform: [
      {
        text: 'Sim offers visual building',
        source: {
      ...
      ' copy and synchronize deployed workflows between parent and child workspaces on Enterprise Cloud or self-hosted installations with the feature configured and separately licensed. ',
      {
        text: 'OpenAI is retiring Agent Builder; migration paths include the Agents SDK and ChatGPT Workspace Agents.',
        source: {
    ...
    pricing: [
      {
        text: 'Sim combines per-user subscriptions with usage credits',
        source: {
      ...
      '. ',
      {
        text: 'Bring-your-own-key usage is paid directly to providers, while Sim’s base workflow charge still applies.',
        source: {
      ...
      ' ',
      {
        text: 'OpenAI lists metered model, tool, and storage charges rather than a dedicated AgentKit subscription tier.',
        source: {
      ...
      ' Estimate run volume, token consumption, and paid tool calls when comparing costs.',
    ],
    security: [
      {
        text: 'OpenAI publishes product-specific SOC 2 and ISO coverage.',
        source: {
    ...
    aiCapabilities: [
      {
        text: 'Sim provides visual and natural-language building across multiple model providers.',
        source: {
          url: 'https://docs.sim.ai/introduction',
          label: 'Sim Docs: Introduction',
          asOf: '2026-09-13',
      ...
      ' ',
      {
        text: 'OpenAI is retiring Agent Builder.',
        source: {
      ...
      ' The ',
      {
        text: 'Agents SDK supports non-OpenAI providers through adapters',
        source: {
      ...
      '; equivalent visual-builder model selection is not established in the reviewed documentation.',
    ],
    integrations: [
      {
        text: 'Sim publishes an integration count for its automation catalog.',
        source: {
      ...
      ' ',
      {
        text: 'OpenAI documents maintained connectors and remote MCP connections; it says remote MCP servers are third-party services it has not verified.',
        source: {
    ...
    observability: [
      ...
      {
        text: 'run tracing in Sim',
        source: {
          url: 'https://docs.sim.ai/logs-debugging',
          label: 'Sim Docs: Logs',
          asOf: '2026-09-13',
        },
      },
      ...
      '. Sim documents ',
      {
        text: 'workflow-based alerts',
        source: {
          url: 'https://docs.sim.ai/logs-debugging/alerts',
          label: 'Sim Docs: Alerts',
          asOf: '2026-09-13',
        },
      },
      ' and ',
      {
        text: 'error paths',
        source: {
          url: 'https://docs.sim.ai/workflows/how-it-runs',
          label: 'Sim Docs: How workflows run',
          asOf: '2026-09-13',
        },
      },
      '. In the ',
      {
        text: 'Agents SDK, applications own deployment, storage, and approval decisions',
        source: {
    ...
    support: [
      {
        text: 'OpenAI publishes a 99.9% uptime SLA for eligible Scale Tier traffic',
        source: {
      ...
      ', while ',
      {
        text: 'Sim lists dedicated Enterprise support',
        source: {
          url: 'https://www.sim.ai/pricing',
          label: 'Sim pricing',
          asOf: '2026-09-13',
      ...
      '. Buyers should confirm the exact product coverage and contractual response-time terms with each vendor.',
    ],
  },
  standoutFeatures: [
    {
  ...
  facts: {
    platform: {
      ...
      learningCurve: {
        value: 'Qualitative integration-effort rating only: Medium for the Agents SDK',
        detail:
          'The runtime comparison table rates agent integration effort Low for the Agents API, Medium for the Agents SDK, and High for the Responses API. Learning effort is not quantified; the SDK requires application development and operational configuration.',
        shortValue: 'Qualitative effort rating; no quantified figure',
    ...
    aiCapabilities: {
      multiLlmSupport: {
        ...
        shortValue: 'Multi-provider SDK; visual selector scope unverified',
        confidence: 'verified',
        sources: [
          {
            url: 'https://developers.openai.com/api/docs/guides/agents/models',
      ...
      loopIteration: {
        value: 'Code-driven SDK loops; the visual Agent Builder While node is retiring',
        detail:
          'Agent Builder conditions use CEL, and the visual builder is scheduled to shut down November 30, 2026. SDK workflows can iterate using normal programming-language control flow.',
        shortValue: 'SDK loops; visual While node retires Nov 30, 2026',
        confidence: 'verified',
        sources: [
          {
            url: 'https://developers.openai.com/api/docs/guides/node-reference',
    ...
    integrations: {
      integrationCount: {
        ...
        shortValue: 'Maintained connectors; total integration count unverified',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://developers.openai.com/api/docs/guides/tools-connectors-mcp',
      ...
      codeSandboxRuntime: {
        ...
        shortValue: 'Beta SDK sandbox environments',
        confidence: 'verified',
        sources: [
          {
      ...
      apiPublishing: {
        value: 'Run exported code in your own application; no published canvas endpoint',
        detail:
          'The migration guide documents copying the export into your application and configuring the SDK. It does not document serving that agent over an endpoint, and automatic generation of a public REST endpoint from the canvas is unverified.',
        shortValue: 'Exported code in your app; canvas API publishing unverified',
        confidence: 'estimated',
        sources: [
          {
            url: 'https://developers.openai.com/api/docs/guides/agent-builder/migrate-from-agent-builder',
    ...
    support: {
      supportChannels: {
        ...
        detail:
          'Support starts with a virtual assistant and may be escalated to a human. Confirm any contractual support terms with OpenAI.',
      ...
      academy: {
        ...
        detail:
          'The Academy homepage lists tracks such as Apply AI at Work, Build with AI, and Lead AI Adoption, plus a Builder Bootcamp series. The course catalog article was not retrievable.',
