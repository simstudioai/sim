...
export const selectorManifest = {
  ...
  'oracle_fusion_hcm.workers': providerSelector([], {
    listMode: 'paginated',
    search: true,
    detail: true,
    unknownDetail: true,
  ...
  'oracle_fusion_hcm.assignments': providerSelector(['personId'], {
    readiness: { all: ['oauthCredential', 'personId'] },
    listMode: 'paginated',
    detail: true,
    unknownDetail: true,
    staleTime: 0,
  }),
  'oracle_fusion_hcm.absences': providerSelector(['personId'], {
    readiness: { all: ['oauthCredential', 'personId'] },
    listMode: 'paginated',
    detail: true,
    unknownDetail: true,
  ...
  'oracle_fusion_hcm.absenceTypes': providerSelector(['personId'], {
    readiness: { all: ['oauthCredential', 'personId'] },
    listMode: 'paginated',
    search: true,
    staleTime: 0,
  }),
  'oracle_fusion_hcm.payrollRelationships': providerSelector(['personNumber', 'effectiveDate'], {
  ...
  'oracle_fusion_hcm.salaries': providerSelector(['assignmentId'], {
    readiness: { all: ['oauthCredential', 'assignmentId'] },
    listMode: 'paginated',
    search: false,
    detail: true,
    unknownDetail: true,
  ...
  'oracle_fusion_hcm.salaryBases': providerSelector(['legislativeDataGroupId', 'effectiveDate'], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: false,
  ...
  'oracle_fusion_hcm.goalPlans': providerSelector(['reviewPeriodId'], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: true,
  ...
  'oracle_fusion_hcm.performanceDocuments': providerSelector(['personId', 'reviewPeriodId'], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: true,
  ...
  'oracle_fusion_hcm.talentProfiles': providerSelector(['personId'], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: true,
  ...
  'oracle_fusion_hcm.timeAttributes': providerSelector([], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: false,
