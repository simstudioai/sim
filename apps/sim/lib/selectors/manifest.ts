...
export const selectorManifest = {
  ...
  'oracle_fusion_learning.selfPacedItems': providerSelector(['effectiveDate'], {
  ...
  'oracle_fusion_learning.events': providerSelector(['effectiveDate'], {
    readiness: { all: ['oauthCredential'] },
    listMode: 'paginated',
    search: true,
    detail: true,
  ...
  'oracle_fusion_learning.eventActivities': providerSelector(['eventId', 'effectiveDate'], {
    readiness: { all: ['oauthCredential', 'eventId'] },
    listMode: 'paginated',
    search: true,
    detail: true,
    unknownDetail: true,
  ...
  'oracle_fusion_learning.learningRecords': providerSelector(['personId', 'effectiveDate'], {
