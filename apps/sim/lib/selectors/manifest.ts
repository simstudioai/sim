...
export const selectorManifest = {
  ...
  'oci_notifications.topics': providerSelector(['compartmentId', 'region'], {
    readiness: { all: ['oauthCredential', 'compartmentId'] },
    sourceFields: { compartmentId: ['topicCompartmentId'] },
    listMode: 'paginated',
    detail: true,
    unknownDetail: true,
  }),
  'oci_notifications.subscriptions': providerSelector(['compartmentId', 'topicId', 'region'], {
    readiness: { all: ['oauthCredential', 'compartmentId', 'topicId'] },
    listMode: 'paginated',
    detail: true,
    unknownDetail: true,
  }),
