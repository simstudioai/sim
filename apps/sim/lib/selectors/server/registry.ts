...
import { oracleFusionProjectManagementSelectorAttachments } from '@/lib/selectors/server/providers/oracle-fusion-project-management'
...
export const serverSelectorRegistry = {
  ...
  ...oracleFusionProjectManagementSelectorAttachments,
