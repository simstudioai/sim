...
import { oracleFusionRecruitingSelectorAttachments } from '@/lib/selectors/server/providers/oracle-fusion-recruiting'
...
export const serverSelectorRegistry = {
  ...
  ...oracleFusionRecruitingSelectorAttachments,
