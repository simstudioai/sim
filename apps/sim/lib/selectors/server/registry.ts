...
import { oracleEpmNarrativeReportingSelectorAttachments } from '@/lib/selectors/server/providers/oracle-epm-narrative-reporting'
...
export const serverSelectorRegistry = {
  ...
  ...oracleEpmNarrativeReportingSelectorAttachments,
