...
import { oracleEpmAccountReconciliationSelectorAttachments } from '@/lib/selectors/server/providers/oracle-epm-account-reconciliation'
...
export const serverSelectorRegistry = {
  ...
  ...oracleEpmAccountReconciliationSelectorAttachments,
