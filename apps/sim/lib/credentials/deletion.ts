 ...
 * QuickBooks rows reference it via `providerConfig.credentialId`; custom-bot
 * Slack rows use `routingKey` = the bot credential id. Neither is a foreign
 * key, so neither is covered by CASCADE.
 */
