...
/**
 * Declared in picker order — most-reached-for first. The `Record` key makes
 * widening `InterfaceModuleType` a compile error here rather than a type
...
/** Picker order — the declaration order of {@link INTERFACE_MODULE_META}. */
export const INTERFACE_MODULE_ORDER: readonly InterfaceModuleType[] = Object.keys(
  INTERFACE_MODULE_META
) as InterfaceModuleType[]
