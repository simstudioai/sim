...
import { invalidValue, notFound, ScimError, uniqueness } from '@/lib/scim/protocol/errors'
import { parseGroupFilter } from '@/lib/scim/protocol/filter'
import { parseGroupPatch } from '@/lib/scim/protocol/group-patch'
import {
  projectionWants,
  projectResource,
  resolvePage,
