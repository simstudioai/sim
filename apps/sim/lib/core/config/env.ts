...
export const env = createEnv({
  ...
  server: {
    ...
    USAGE_PERIOD_TOTAL_READS:              z.boolean().optional(),                 // Serve whole-period billing totals from the usage_log_period_total rollup (PK lookup) instead of aggregating usage_log
