...
export const env = createEnv({
  ...
  server: {
    ...
    E2B_PI_TEMPLATE_ID:                     z.string().optional(),                  // E2B template ID/alias with the Pi CLI + git baked in (Create PR, Review Code, and Babysit)
    ...
    DAYTONA_PI_SNAPSHOT_ID:                z.string().optional(),                  // Daytona snapshot mirroring the Pi template (Create PR, Review Code, and Babysit)
