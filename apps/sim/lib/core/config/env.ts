...
export const env = createEnv({
  ...
  server: {
    ...
    // SSO / enterprise feature switches
    ...
    SSO_PROVIDER_ID:                       z.string().optional(),                  // Non-SSO provider ID trusted for automatic account linking (see SSO_TRUSTED_PROVIDER_IDS)
