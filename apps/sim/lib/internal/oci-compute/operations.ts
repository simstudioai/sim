...
import { type OciComputeInput, type OciComputeOperation, validateOciComputeMetadata } from '@/lib/internal/oci-compute/schema'
import {
...
export const OCI_COMPUTE_OPERATIONS: Record<OciComputeOperation, ComputeOperation> = {
  list_instances: {
    method: 'GET',
    path: '/instances/',
    query: ['compartmentId', 'limit', 'page', 'sortBy', 'sortOrder', 'displayName', 'availabilityDomain', 'lifecycleState', 'capacityReservationId'],
    output: 'instances',
  ...
  launch_instance: {
    method: 'POST',
    path: '/instances/',
    body: ['compartmentId', 'availabilityDomain', 'shape', 'displayName', 'freeformTags', 'definedTags', 'shapeConfig', 'createVnicDetails', 'faultDomain', 'metadata', 'extendedMetadata', 'agentConfig', 'availabilityConfig', 'instanceOptions', 'capacityReservationId', 'dedicatedVmHostId'],
    output: 'instance',
    projection: INSTANCE_OUTPUT_PROPERTIES,
    token: true,
    work: true,
  ...
  update_instance: {
    method: 'PUT',
    path: '/instances/{instanceId}',
    body: ['displayName', 'freeformTags', 'definedTags', 'shape', 'shapeConfig', 'faultDomain', 'metadata', 'extendedMetadata', 'agentConfig', 'availabilityConfig', 'instanceOptions', 'capacityReservationId', 'dedicatedVmHostId', 'timeMaintenanceRebootDue', 'updateOperationConstraint'],
    output: 'instance',
    projection: INSTANCE_OUTPUT_PROPERTIES,
    work: true,
    etag: true,
  ...
  list_images: {
    method: 'GET',
    path: '/images',
    query: ['compartmentId', 'limit', 'page', 'sortBy', 'sortOrder', 'displayName', 'operatingSystem', 'operatingSystemVersion', 'shape', 'lifecycleState'],
    output: 'images',
  ...
  create_instance_configuration: {
    method: 'POST',
    path: '/instanceConfigurations',
    body: ['compartmentId', 'displayName', 'freeformTags', 'definedTags', 'instanceId', 'instanceDetails'],
    output: 'instanceConfiguration',
    projection: INSTANCE_CONFIGURATION_OUTPUT_PROPERTIES,
    token: true,
  },
  ...
  list_instance_pools: {
    method: 'GET',
    path: '/instancePools',
    query: ['compartmentId', 'limit', 'page', 'sortBy', 'sortOrder', 'displayName', 'lifecycleState'],
  ...
  create_instance_pool: {
    method: 'POST',
    path: '/instancePools',
    body: ['instanceConfigurationId', 'compartmentId', 'displayName', 'freeformTags', 'definedTags', 'size', 'placementConfigurations', 'instanceDisplayNameFormatter', 'instanceHostnameFormatter'],
    output: 'instancePool',
    projection: INSTANCE_POOL_OUTPUT_PROPERTIES,
    token: true,
  },
  update_instance_pool: {
    method: 'PUT',
    path: '/instancePools/{instancePoolId}',
    body: ['displayName', 'freeformTags', 'definedTags', 'instanceConfigurationId', 'size', 'placementConfigurations', 'instanceDisplayNameFormatter', 'instanceHostnameFormatter'],
    output: 'instancePool',
    projection: INSTANCE_POOL_OUTPUT_PROPERTIES,
    etag: true,
  },
...
export async function executeOciComputeOperation(
  ...
  try {
    ...
    const output: OciComputeResponse['output'] = {
      ...
      ...(definition.list ? { nextPage: response.headers['opc-next-page'] ?? null } : {}),
