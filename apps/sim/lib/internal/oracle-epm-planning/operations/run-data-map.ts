    ...
    await submitPlanningJob(
      {
        ...
        parameters: {
          ...
          ...(input.overrideMembersMap === undefined
            ? {}
            : { overrideMembersMap: input.overrideMembersMap }),
          ...(input.overrideExclusionMembersMap === undefined
            ? {}
            : { overrideExclusionMembersMap: input.overrideExclusionMembersMap }),
        },
      },
      context
    )
