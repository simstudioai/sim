...
import { type PlanningOperationContext, parsePlanningResponse, insightsSchema } from '@/lib/internal/oracle-epm-planning/schema'
import type { OracleEpmPlanningGetInsightsParams, OracleEpmPlanningResponse } from '@/tools/oracle_epm_planning/types'
...
export async function executeOracleEpmPlanningGetInsights(
  ...
  const parsed = parsePlanningResponse(insightsSchema,
