...
const ORACLE_FUSION_RISK_MANAGEMENT_TOOL_IDS = [
...
registerFamily(handlerLoaders, ORACLE_FUSION_RISK_MANAGEMENT_TOOL_IDS, async () => {
  return (await import('@/lib/internal/oracle-fusion-risk-management/execute-tool'))
    .executeOracleFusionRiskManagementTool
})
