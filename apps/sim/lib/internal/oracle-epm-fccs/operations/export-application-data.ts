...
import type { FccsExportApplicationDataParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsExportApplicationDataOperation: InternalToolOperationImplementation<
...
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'EXPORT_DATA', input.jobName, input.parameters)
}
