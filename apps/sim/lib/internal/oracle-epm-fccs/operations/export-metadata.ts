...
import type { FccsExportMetadataParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsExportMetadataOperation: InternalToolOperationImplementation<
...
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'EXPORT_METADATA', input.jobName, input.parameters)
}
