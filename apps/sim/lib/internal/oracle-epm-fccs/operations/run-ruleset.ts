...
import type { FccsRunRulesetParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsRunRulesetOperation: InternalToolOperationImplementation<
  FccsRunRulesetParams
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'RULESET', input.ruleset, input.parameters)
}
