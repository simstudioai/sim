...
import type { FccsClearDataProfileParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsClearDataProfileOperation: InternalToolOperationImplementation<
...
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'Clear_Data', 'Execute Profile', {
