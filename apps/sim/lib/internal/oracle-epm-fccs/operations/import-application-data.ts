...
import type { FccsImportApplicationDataParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsImportApplicationDataOperation: InternalToolOperationImplementation<
...
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'IMPORT_DATA', input.jobName, input.parameters)
}
