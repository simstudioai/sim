...
import type { FccsImportMetadataParams } from '@/tools/oracle_epm_fccs/types'
...
export const executeFccsImportMetadataOperation: InternalToolOperationImplementation<
...
> = async (params, signal, context) => {
  ...
  return submitFccsJob(ctx, input.application, 'IMPORT_METADATA', input.jobName, input.parameters)
}
