...
describe('Oracle Fusion HCM projection contracts', () => {
  const cases = [
    ...
    },
    {
      ...
      fixture: {'SalaryBasisId':'43','SalaryBasisName':'Annual','SalaryBasisType':'U','SalaryAmountScale':2,'GradeRateId':null},
    },
    {
      ...
      fixture: {'SalaryComponentId':'44','SalaryId':'42','AdjustmentAmount':100,'AdjustmentPercentage':2.5},
    },
    {
      ...
      fixture: {'SimpleSalaryCompntId':'45','SalaryId':'42','Amount':100,'UserSelectedComponent':'Y','OverallSalaryAffect':'Y'},
    },
    {
      ...
      fixture: {'SalaryPayComponentId':'46','SalaryId':'42','RateAmount':100,'RateOverallSalaryFlag':true},
    },
    {
      name: 'GradeRateValue',
      ...
      fixture: {'RateValueId':'47','GradeId':'48','MinimumAmount':1000,'MidValueAmount':2000,'MaximumAmount':null},
    },
    {
      name: 'GoalPlan',
      ...
      fixture: {'GoalPlanId':'49','ReviewPeriodId':'50','GoalPlanName':'2026 Goals','EnableWeightingFlag':true},
    },
    {
    ...
    },
    {
      ...
      fixture: {'EvaluationId':'53','PersonId':'7','ReviewPeriodId':'50','PerformanceDocumentName':'Annual Review','EvalStatus':'INPROGRESS'},
    },
    {
      ...
      fixture: {'EvalRoleId':'54','RoleTypeCode':'MANAGER','MinimumNumberPcpns':1,'MatrixParticipantFlag':false},
    },
    {
      ...
      fixture: {'EvalParticipantId':'55','EvalRoleId':'54','PersonId':'7','ParticipationStatusCode':'OPEN'},
    },
    {
      ...
      fixture: {'EvalStepId':'56','StepCode':'MGREVAL','TaskName':'Manager Evaluation','TaskStatus':'Not started'},
    },
    {
      name: 'TalentProfile',
    ...
    },
    {
      ...
      fixture: {'ProfileSectionId':'58','SectionId':'59','SectionName':'Skills','SectionContext':'SKILL'},
    },
    {
