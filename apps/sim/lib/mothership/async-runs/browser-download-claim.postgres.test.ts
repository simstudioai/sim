 ...
 * schema. BROWSER_FILE_TRANSFER_TEST_DATABASE_URL enables this suite in the database CI jobs.
 */
...
const databaseUrl = process.env.BROWSER_FILE_TRANSFER_TEST_DATABASE_URL
