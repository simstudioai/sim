...
export const TraceSpan = {
  ...
  CopilotCliCurate: 'copilot.cli.curate',
  CopilotCliHttpHeaders: 'copilot.cli.http_headers',
  CopilotCliIdentity: 'copilot.cli.identity',
  CopilotCliInvoke: 'copilot.cli.invoke',
  CopilotCliSink: 'copilot.cli.sink',
  CopilotConfirmToolResult: 'copilot.confirm.tool_result',
  CopilotDbQuery: 'copilot.db.query',
  CopilotDbTransaction: 'copilot.db.transaction',
  ...
  CopilotToolResultCommit: 'copilot.tool.result_commit',
  CopilotToolRuntime: 'copilot.tool.runtime',
...
export const TraceSpanValues: readonly TraceSpanValue[] = [
  ...
  'copilot.cli.curate',
  'copilot.cli.http_headers',
  'copilot.cli.identity',
  'copilot.cli.invoke',
  'copilot.cli.sink',
  'copilot.confirm.tool_result',
  'copilot.db.query',
  'copilot.db.transaction',
  ...
  'copilot.tool.result_commit',
  'copilot.tool.runtime',
