...
import { fileReadCommand } from '@/lib/mothership/agent-cli/engines/file-read'
...
import { workflowToolsCommand } from '@/lib/mothership/agent-cli/engines/workflow-tools'
import {
  type AgentCliEngine,
  type AgentCliFlags,
  type AgentCliResult,
...
export const AUGMENTATION_ENGINES: Readonly<Record<string, AgentCliEngine>> = {
  ...
  'workflows tools': workflowToolsCommand,
}
