...
vi.mock('@/lib/table/constants', () => ({
  ...tableConstantsMock,
  TABLE_LIMITS: {
    ...tableConstantsMock.TABLE_LIMITS,
    DELETE_SNAPSHOT_BATCH_MAX_BYTES: 100,
...
const mockGetDeleteSnapshotBatchSize = tableConstantsMockFns.mockGetDeleteSnapshotBatchSize
