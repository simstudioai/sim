...
export const tableOperations = {
  ...
  update: toolWriteOperation('tables.update', 'tables.use'),
  ...
  listFolders: toolReadOperation('tables.folders.list'),
  createFolder: toolWriteOperation('tables.folders.create', 'tables.use'),
  updateFolder: toolWriteOperation('tables.folders.update', 'tables.use'),
  deleteFolder: toolWriteOperation('tables.folders.delete', 'tables.use'),
  restoreFolder: toolWriteOperation('tables.folders.restore', 'tables.use'),
