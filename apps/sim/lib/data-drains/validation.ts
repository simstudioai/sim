...
export const s3ConfigBodySchema = z.object({
  bucket: z
    .string()
...
export const gcsConfigBodySchema = z.object({
  bucket: z
    .string()
...
export const azureBlobConfigBodySchema = z.object({
  accountName: z
    .string()
...
export const datadogConfigBodySchema = z.object({
...
export const bigqueryConfigBodySchema = z.object({
  projectId: z
    .string()
...
export const snowflakeConfigBodySchema = z.object({
  account: z
    .string()
 ...
 * not be forced to also send `destinationType`. The application use case validates the
 ...
 * structural shape is still enforced — just at the application layer rather than at
...
export type CreateDataDrainInput = z.input<typeof createDataDrainBodySchema>
export type UpdateDataDrainInput = z.input<typeof updateDataDrainBodySchema>
