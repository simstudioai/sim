...
import {
  OracleFusionServiceBlock,
  OracleFusionServiceBlockMeta,
} from '@/blocks/blocks/oracle_fusion_service'
...
export const BLOCK_REGISTRY: Record<string, BlockConfig> = {
  ...
  openai: OpenAIBlock,
  oracle_fusion_service: OracleFusionServiceBlock,
...
export const BLOCK_META_REGISTRY: Record<string, BlockMeta> = {
  ...
  oracle_fusion_service: OracleFusionServiceBlockMeta,
