...
import { OracleEpmDataBlock, OracleEpmDataBlockMeta } from '@/blocks/blocks/oracle_epm_data'
...
export const BLOCK_REGISTRY: Record<string, BlockConfig> = {
  ...
  openai: OpenAIBlock,
  oracle_epm_data: OracleEpmDataBlock,
...
export const BLOCK_META_REGISTRY: Record<string, BlockMeta> = {
  ...
  oracle_epm_data: OracleEpmDataBlockMeta,
