...
import { OciNotificationsBlock, OciNotificationsBlockMeta } from '@/blocks/blocks/oci_notifications'
...
export const BLOCK_REGISTRY: Record<string, BlockConfig> = {
  ...
  oci_notifications: OciNotificationsBlock,
  okta: OktaBlock,
...
export const BLOCK_META_REGISTRY: Record<string, BlockMeta> = {
  ...
  oci_notifications: OciNotificationsBlockMeta,
  okta: OktaBlockMeta,
