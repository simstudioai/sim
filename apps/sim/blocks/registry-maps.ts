...
import {
  OracleFusionRecruitingBlock,
  OracleFusionRecruitingBlockMeta,
} from '@/blocks/blocks/oracle_fusion_recruiting'
...
export const BLOCK_REGISTRY: Record<string, BlockConfig> = {
  ...
  openai: OpenAIBlock,
  oracle_fusion_recruiting: OracleFusionRecruitingBlock,
...
export const BLOCK_META_REGISTRY: Record<string, BlockMeta> = {
  ...
  oracle_fusion_recruiting: OracleFusionRecruitingBlockMeta,
