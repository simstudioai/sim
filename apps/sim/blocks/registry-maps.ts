...
import { OciMonitoringBlock, OciMonitoringBlockMeta } from '@/blocks/blocks/oci_monitoring'
...
export const BLOCK_REGISTRY: Record<string, BlockConfig> = {
  ...
  oci_monitoring: OciMonitoringBlock,
  okta: OktaBlock,
...
export const BLOCK_META_REGISTRY: Record<string, BlockMeta> = {
  ...
  oci_monitoring: OciMonitoringBlockMeta,
  okta: OktaBlockMeta,
