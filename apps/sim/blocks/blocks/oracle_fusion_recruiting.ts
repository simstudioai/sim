...
export const OracleFusionRecruitingBlock: BlockConfig = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'],
      },
      required: {
        field: 'operation',
        value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'],
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['create_candidate_phone', 'update_candidate_phone'],
      },
    ...
    },
    {
      ...
      condition: {
        ...
        value: [
          ...
          'list_requisition_templates',
          'list_recruiting_representatives',
        ],
      },
