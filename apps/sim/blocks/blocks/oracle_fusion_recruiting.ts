...
export const OracleFusionRecruitingBlock: BlockConfig = {
  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        ...
        get_interview_schedule: [{ text: 'Get interview schedule for', field: ['scheduleIdPicker', 'scheduleIdInput'], core: true }],
  ...
  subBlocks: [
    ...
    {
      id: 'credential', title: 'Oracle Fusion Credential', type: 'oauth-input',
    ...
    {
      id: 'candidateNumberPicker', title: 'Candidate', type: 'file-selector',
      canonicalParamId: 'candidateNumber', mode: 'basic',
      condition: { field: 'operation', value: ['get_candidate', 'update_candidate', 'delete_candidate', 'list_candidate_phones', 'get_candidate_phone', 'create_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone', 'list_candidate_education', 'list_candidate_experience', 'list_candidate_skills', 'list_candidate_attachments'] },
      required: { field: 'operation', value: ['get_candidate', 'update_candidate', 'delete_candidate', 'list_candidate_phones', 'get_candidate_phone', 'create_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone', 'list_candidate_education', 'list_candidate_experience', 'list_candidate_skills', 'list_candidate_attachments'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.candidates',
      dependsOn: ['credential'],
      placeholder: 'Select candidate',
    },
    {
      id: 'candidateNumberInput', title: 'Candidate', type: 'short-input',
      canonicalParamId: 'candidateNumber', mode: 'advanced',
      condition: { field: 'operation', value: ['get_candidate', 'update_candidate', 'delete_candidate', 'list_candidate_phones', 'get_candidate_phone', 'create_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone', 'list_candidate_education', 'list_candidate_experience', 'list_candidate_skills', 'list_candidate_attachments'] },
      required: { field: 'operation', value: ['get_candidate', 'update_candidate', 'delete_candidate', 'list_candidate_phones', 'get_candidate_phone', 'create_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone', 'list_candidate_education', 'list_candidate_experience', 'list_candidate_skills', 'list_candidate_attachments'] },
      placeholder: 'Enter candidate identifier',
    },
    {
      id: 'phoneIdPicker', title: 'Candidate Phone', type: 'file-selector',
      canonicalParamId: 'phoneId', mode: 'basic',
      condition: { field: 'operation', value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'] },
      required: { field: 'operation', value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.phones',
      dependsOn: ['credential', 'candidateNumberPicker'],
      placeholder: 'Select candidate phone',
    },
    {
      id: 'phoneIdInput', title: 'Candidate Phone', type: 'short-input',
      canonicalParamId: 'phoneId', mode: 'advanced',
      condition: { field: 'operation', value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'] },
      required: { field: 'operation', value: ['get_candidate_phone', 'update_candidate_phone', 'delete_candidate_phone'] },
      placeholder: 'Enter candidate phone identifier',
    },
    {
      id: 'requisitionIdPicker', title: 'Requisition', type: 'file-selector',
      canonicalParamId: 'requisitionId', mode: 'basic',
      condition: { field: 'operation', value: ['get_requisition', 'update_requisition', 'delete_requisition', 'list_requisition_postings', 'list_applications', 'list_offers'] },
      required: { field: 'operation', value: ['get_requisition', 'update_requisition', 'delete_requisition', 'list_requisition_postings'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.requisitions',
      dependsOn: ['credential'],
      placeholder: 'Select requisition',
    },
    {
      id: 'requisitionIdInput', title: 'Requisition', type: 'short-input',
      canonicalParamId: 'requisitionId', mode: 'advanced',
      condition: { field: 'operation', value: ['get_requisition', 'update_requisition', 'delete_requisition', 'list_requisition_postings', 'list_applications', 'list_offers'] },
      required: { field: 'operation', value: ['get_requisition', 'update_requisition', 'delete_requisition', 'list_requisition_postings'] },
      placeholder: 'Enter requisition identifier',
    },
    {
      id: 'applicationIdPicker', title: 'Application', type: 'file-selector',
      canonicalParamId: 'applicationId', mode: 'basic',
      condition: { field: 'operation', value: ['get_application'] },
      required: { field: 'operation', value: ['get_application'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.applications',
      dependsOn: ['credential'],
      placeholder: 'Select application',
    },
    {
      id: 'applicationIdInput', title: 'Application', type: 'short-input',
      canonicalParamId: 'applicationId', mode: 'advanced',
      condition: { field: 'operation', value: ['get_application'] },
      required: { field: 'operation', value: ['get_application'] },
      placeholder: 'Enter application identifier',
    },
    {
      id: 'offerIdPicker', title: 'Offer', type: 'file-selector',
      canonicalParamId: 'offerId', mode: 'basic',
      condition: { field: 'operation', value: ['get_offer'] },
      required: { field: 'operation', value: ['get_offer'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.offers',
      dependsOn: ['credential'],
      placeholder: 'Select offer',
    },
    {
      id: 'offerIdInput', title: 'Offer', type: 'short-input',
      canonicalParamId: 'offerId', mode: 'advanced',
      condition: { field: 'operation', value: ['get_offer'] },
      required: { field: 'operation', value: ['get_offer'] },
      placeholder: 'Enter offer identifier',
    },
    {
      id: 'scheduleIdPicker', title: 'Interview Schedule', type: 'file-selector',
      canonicalParamId: 'scheduleId', mode: 'basic',
      condition: { field: 'operation', value: ['get_interview_schedule'] },
      required: { field: 'operation', value: ['get_interview_schedule'] },
      serviceId: 'oracle_fusion_recruiting', selectorKey: 'oracle_fusion_recruiting.interviewSchedules',
      dependsOn: ['credential'],
      placeholder: 'Select interview schedule',
    },
    {
      id: 'scheduleIdInput', title: 'Interview Schedule', type: 'short-input',
      canonicalParamId: 'scheduleId', mode: 'advanced',
      condition: { field: 'operation', value: ['get_interview_schedule'] },
      required: { field: 'operation', value: ['get_interview_schedule'] },
      placeholder: 'Enter interview schedule identifier',
    },
    {
      id: 'candidateBody', title: 'Candidate Fields', type: 'code', language: 'json',
    ...
    {
      id: 'phoneBody', title: 'Phone Fields', type: 'code', language: 'json',
      condition: { field: 'operation', value: ['create_candidate_phone', 'update_candidate_phone'] },
      required: { field: 'operation', value: ['create_candidate_phone', 'update_candidate_phone'] },
      placeholder: '{\n  "PhoneNumber": "5550100",\n  "CountryCodeNumber": "1"\n}',
      wandConfig: {
        enabled: true, generationType: 'json-object',
        prompt: 'Generate Oracle Recruiting phone fields using only: PhoneNumber, CountryCodeNumber, AreaCode, LegislationCode. Preserve int64 IDs as decimal strings. For updates include only intended changes. Return ONLY the JSON object.',
        placeholder: 'Describe the fields to create or update',
      },
    },
    {
      id: 'requisitionBody', title: 'Requisition Fields', type: 'code', language: 'json',
    ...
    config: {
      ...
      params: (params) => {
        ...
        for (const key of ['limit', 'offset']) {
          result[key] = params[key] === '' || params[key] == null ? undefined : typeof params[key] === 'string' ? Number(params[key]) : params[key]
        }
        for (const key of ['search', 'requisitionId']) {
          if (params[key] == null || typeof params[key] === 'string' && !params[key].trim()) result[key] = undefined
        }
  ...
  outputs: {
    candidates: { type: 'json', description: 'Candidate records (candidateNumber, personId, displayName, fullName, firstName, lastName, middleNames, email, candidateType, preferredLanguage, preferredTimezone, creationDate, lastUpdateDate)' },
    candidate: { type: 'json', description: 'One candidate (candidateNumber, personId, displayName, fullName, firstName, lastName, middleNames, email, candidateType, preferredLanguage, preferredTimezone, creationDate, lastUpdateDate)' },
    phones: { type: 'json', description: 'Phone records (phoneId, phoneNumber, countryCodeNumber, areaCode, legislationCode, phoneType)' },
    phone: { type: 'json', description: 'One phone (phoneId, phoneNumber, countryCodeNumber, areaCode, legislationCode, phoneType)' },
    education: { type: 'json', description: 'Education records (educationId, degreeName, major, minor, educationalEstablishment, startDate, endDate, graduatedFlag)' },
    experience: { type: 'json', description: 'Experience records (previousEmploymentId, employerName, jobTitle, startDate, endDate, currentJobFlag, department)' },
    skills: { type: 'json', description: 'Skill records (skillId, skill, description, yearsOfExperience, dateAchieved, speciality)' },
    attachments: { type: 'json', description: 'Attachment records (attachedDocumentId, fileName, title, description, uploadedFileContentType, uploadedFileLength, categoryName, creationDate, lastUpdateDate)' },
    requisitions: { type: 'json', description: 'Requisition records (requisitionId, requisitionNumber, title, recruitingType, phaseId, phaseName, stateId, stateName, hiringManagerId, recruiterId, primaryLocationId, businessUnitId, departmentId, jobId, numberOfOpenings, unlimitedOpenings, creationDate, lastUpdateDate)' },
    requisition: { type: 'json', description: 'One requisition (requisitionId, requisitionNumber, title, recruitingType, phaseId, phaseName, stateId, stateName, hiringManagerId, recruiterId, primaryLocationId, businessUnitId, departmentId, jobId, numberOfOpenings, unlimitedOpenings, creationDate, lastUpdateDate)' },
    postings: { type: 'json', description: 'Posting records (publishedJobId, postingStatus, visibility, startDate, endDate, timeZone)' },
    applications: { type: 'json', description: 'Application records (jobApplicationId, candidateName, candidatePersonId, requisitionId, requisitionNumber, phaseId, phaseName, stateId, stateName, confirmedFlag, disqualifiedFlag, internalFlag, jobApplicationDate, lastUpdateDate)' },
    application: { type: 'json', description: 'One application (jobApplicationId, candidateName, candidatePersonId, requisitionId, requisitionNumber, phaseId, phaseName, stateId, stateName, confirmedFlag, disqualifiedFlag, internalFlag, jobApplicationDate, lastUpdateDate)' },
    offers: { type: 'json', description: 'Offer records (offerId, offerName, jobApplicationId, candidatePersonId, requisitionId, phaseId, phaseName, stateId, stateName, hireDate, expirationDate, lastUpdateDate)' },
    offer: { type: 'json', description: 'One offer (offerId, offerName, jobApplicationId, candidatePersonId, requisitionId, phaseId, phaseName, stateId, stateName, hireDate, expirationDate, lastUpdateDate)' },
    interviewSchedules: { type: 'json', description: 'Interview Schedule records (scheduleId, scheduleCode, scheduleTitle, scheduleType, interviewType, interviewTypeMeaning, status)' },
    interviewSchedule: { type: 'json', description: 'One interview schedule (scheduleId, scheduleCode, scheduleTitle, scheduleType, interviewType, interviewTypeMeaning, status)' },
    requisitionTemplates: { type: 'json', description: 'Requisition Template records (requisitionId, requisitionNumber, name, title, requisitionNameWithNumber)' },
    representatives: { type: 'json', description: 'Representative records (personId, personNumber, displayName, assignmentId, assignmentNumber, workEmailAddress)' },
...
export const OracleFusionRecruitingBlockMeta = {
  ...
  templates: [
    { icon: NetSuiteIcon, title: 'Review candidate profiles', prompt: 'When a candidate number is provided, read the candidate, education, experience, and skills, then return a factual profile summary without ranking candidates.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Track requisition status', prompt: 'On a scheduled run, list one page of requisitions and summarize titles, phases, states, and openings with continuation metadata.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Track application progress', prompt: 'When a requisition ID is provided, list its applications and summarize their current phases and states.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Review offer deadlines', prompt: 'On a scheduled run, list one page of offers and report expiration dates and current states without changing offers.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Inspect interview schedules', prompt: 'When asked about available interview schedules, list schedule lookup records and report their titles, types, and status. Do not claim appointment availability.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Review published jobs', prompt: 'When a requisition is selected, list its published jobs and summarize posting visibility, status, and dates.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
    { icon: NetSuiteIcon, title: 'Prepare requisition creation', prompt: 'When a hiring request provides the required Oracle IDs, inspect requisition templates and representatives, create the specified requisition, and return its identifier and status.', modules: ['workflows'], category: 'operations', tags: ['automation'] },
  ],
  skills: [
    { name: 'review-candidate-profiles', description: 'When a candidate number is provided, read the candidate, education, experience, and skills, then return a factual profile summary without ranking candidates.', content: '# Review candidate profiles\n\nWhen a candidate number is provided, read the candidate, education, experience, and skills, then return a factual profile summary without ranking candidates.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. When a candidate number is provided, read the candidate, education, experience, and skills, then return a factual profile summary without ranking candidates.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
    { name: 'track-requisition-status', description: 'On a scheduled run, list one page of requisitions and summarize titles, phases, states, and openings with continuation metadata.', content: '# Track requisition status\n\nOn a scheduled run, list one page of requisitions and summarize titles, phases, states, and openings with continuation metadata.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. On a scheduled run, list one page of requisitions and summarize titles, phases, states, and openings with continuation metadata.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
    { name: 'track-application-progress', description: 'When a requisition ID is provided, list its applications and summarize their current phases and states.', content: '# Track application progress\n\nWhen a requisition ID is provided, list its applications and summarize their current phases and states.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. When a requisition ID is provided, list its applications and summarize their current phases and states.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
    { name: 'review-offer-deadlines', description: 'On a scheduled run, list one page of offers and report expiration dates and current states without changing offers.', content: '# Review offer deadlines\n\nOn a scheduled run, list one page of offers and report expiration dates and current states without changing offers.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. On a scheduled run, list one page of offers and report expiration dates and current states without changing offers.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
    { name: 'inspect-interview-schedules', description: 'When asked about available interview schedules, list schedule lookup records and report their titles, types, and status. Do not claim appointment availability.', content: '# Inspect interview schedules\n\nWhen asked about available interview schedules, list schedule lookup records and report their titles, types, and status. Do not claim appointment availability.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. When asked about available interview schedules, list schedule lookup records and report their titles, types, and status. Do not claim appointment availability.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
    { name: 'review-published-jobs', description: 'When a requisition is selected, list its published jobs and summarize posting visibility, status, and dates.', content: '# Review published jobs\n\nWhen a requisition is selected, list its published jobs and summarize posting visibility, status, and dates.\n\n## Steps\n1. Select the saved Oracle Fusion integration-user credential.\n2. When a requisition is selected, list its published jobs and summarize posting visibility, status, and dates.\n3. Return only supported fields and identify any remaining pages.\n\n## Output\nProvide a factual summary with resource identifiers and pagination state. Respect Oracle access errors; do not infer missing information.\n\nSource: https://www.oracle.com/human-capital-management/recruiting/' },
  ],
