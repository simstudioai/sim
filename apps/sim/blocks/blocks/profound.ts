  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        ...
        list_models: ['Lists all tracked AI models'],
        list_domains: ['Lists all domains'],
        list_assets: ['Lists all assets across categories'],
        list_personas: ['Lists all personas across categories'],
        category_topics: [{ text: 'Lists topics in category', field: 'categoryId', core: true }],
        category_tags: [{ text: 'Lists tags in category', field: 'categoryId', core: true }],
        category_prompts: [
          { text: 'Lists prompts in category', field: 'categoryId', core: true },
          { text: ', of type', field: 'promptType' },
          { text: ', up to', field: 'limit', after: 'prompts' },
        ],
        category_assets: [{ text: 'Lists assets in category', field: 'categoryId', core: true }],
        category_personas: [
          { text: 'Lists personas in category', field: 'categoryId', core: true },
        ],
        visibility_report: [
          { text: 'Reports AI visibility for category', field: 'categoryId', core: true },
          { text: ', measuring', field: 'visibilityMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        sentiment_report: [
          { text: 'Reports sentiment for category', field: 'categoryId', core: true },
          { text: ', measuring', field: 'sentimentMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        citations_report: [
          { text: 'Reports citations for category', field: 'categoryId', core: true },
          { text: ', measuring', field: 'citationsMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        query_fanouts: [
          { text: 'Reports prompt fanouts for category', field: 'categoryId', core: true },
          { text: ', measuring', field: 'fanoutsMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        prompt_answers: [
          { text: 'Fetches raw prompt answers for category', field: 'categoryId', core: true },
          { text: ', since', field: 'startDate' },
          { text: ', where', field: 'filters' },
        ],
        bots_report: [
          { text: 'Reports bot traffic for', field: 'domain', core: true },
          { text: ', measuring', field: 'botsMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        referrals_report: [
          { text: 'Reports human referral traffic for', field: 'domain', core: true },
          { text: ', measuring', field: 'referralsMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        raw_logs: [
          { text: 'Fetches raw traffic logs for', field: 'domain', core: true },
          { text: ', since', field: 'startDate' },
          { text: ', where', field: 'filters' },
        ],
        bot_logs: [
          { text: 'Fetches bot visit logs for', field: 'domain', core: true },
          { text: ', since', field: 'startDate' },
          { text: ', where', field: 'filters' },
        ],
        list_optimizations: [
          { text: 'Lists content optimizations for asset', field: 'assetId', core: true },
          { text: ', up to', field: 'limit', after: 'entries' },
        ],
        optimization_analysis: [
          { text: 'Reads optimization analysis for content', field: 'contentId', core: true },
        ],
        prompt_volume: [
          'Reports prompt volume',
          { text: ', measuring', field: 'volumeMetrics' },
          { text: ', since', field: 'startDate' },
        ],
        citation_prompts: [{ text: 'Lists prompts citing', field: 'inputDomain', core: true }],
      },
    },
  },
