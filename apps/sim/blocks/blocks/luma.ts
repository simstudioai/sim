...
export const LumaBlock: BlockConfig = {
  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        get_event: [{ text: 'Fetches event', field: 'eventId', core: true }],
        create_event: [
          { text: 'Creates event', field: 'name', core: true },
        ...
        lookup_event: [{ text: 'Resolves the ID of event', field: ['url', 'eventId'], core: true }],
        cancel_event: [{ text: 'Cancels event', field: 'eventId', core: true }],
        get_guests: [
          { text: 'Lists guests of event', field: 'eventId', core: true },
          { text: ', with status', field: 'approvalStatus' },
          { text: ', up to', field: 'paginationLimit', after: 'results' },
        ],
        get_guest: [
          { text: 'Fetches guest', field: 'guestIdentifier', core: true },
          { text: 'on event', field: 'eventId' },
        ],
        add_guests: [
          { text: 'Registers', field: 'guests', core: true },
          { text: 'for event', field: 'eventId', core: true },
        ],
        send_invites: [
          { text: 'Emails invites to', field: 'guests', core: true },
          { text: 'for event', field: 'eventId', core: true },
          { text: ', saying', field: 'message' },
        ],
        update_guest_status: [
          { text: 'Sets guest', field: 'guestIdentifier', core: true },
