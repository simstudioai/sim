    ...
    sentences: {
      byOperation: {
        rootly_create_incident: [
          { text: 'Creates incident', field: 'title', core: true },
          { text: ', at severity', field: 'createSeverityId' },
          { text: ', on services', field: 'createServiceIds' },
        ],
        rootly_get_incident: [{ text: 'Fetches incident', field: 'getIncidentId', core: true }],
        ...
        rootly_delete_incident: [
          { text: 'Deletes incident', field: 'deleteIncidentId', core: true },
        ],
        ...
        rootly_list_services: ['Lists services', { text: ', matching', field: 'servicesSearch' }],
        rootly_list_severities: [
          'Lists severity levels',
          { text: ', matching', field: 'severitiesSearch' },
        ],
        rootly_list_teams: ['Lists teams', { text: ', matching', field: 'teamsSearch' }],
        ...
        rootly_list_causes: ['Lists causes', { text: ', matching', field: 'causesSearch' }],
        rootly_list_playbooks: ['Lists playbooks'],
      },
    },
  },
  triggers: {
