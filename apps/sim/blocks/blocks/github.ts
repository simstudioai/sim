...
export const GitHubBlock: BlockConfig<GitHubResponse> = {
  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        github_pr: [
          { text: 'Reads pull request', field: 'pullNumber', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_comment: [
          { text: 'Comments', field: 'body', core: true },
          { text: 'on pull request', field: 'pullNumber', core: true },
        ],
        github_repo_info: [{ text: 'Reads details of repository', field: 'repo', core: true }],
        github_latest_commit: [
          { text: 'Reads the latest commit in', field: 'repo', core: true },
        ...
        github_list_issue_comments: [
          { text: 'Lists comments on issue', field: 'issue_number', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_update_comment: [
          { text: 'Rewrites comment', field: 'comment_id', core: true },
          { text: 'to say', field: 'body' },
        ],
        github_delete_comment: [
          { text: 'Deletes comment', field: 'comment_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_list_pr_comments: [
          { text: 'Lists comments on pull request', field: 'pullNumber', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_create_pr: [
          { text: 'Opens pull request', field: 'title', core: true },
          { text: 'from', field: 'head' },
          { text: 'into', field: 'base' },
        ],
        github_update_pr: [
          { text: 'Updates pull request', field: 'pullNumber', core: true },
          { text: ', setting title to', field: 'title' },
          { text: ', setting state to', field: 'state' },
        ],
        github_merge_pr: [
          { text: 'Merges pull request', field: 'pullNumber', core: true },
          { text: 'using', field: 'merge_method' },
          { text: ', titled', field: 'commit_title' },
        ],
        github_list_prs: [
          { text: 'Lists pull requests in', field: 'repo', core: true },
          { text: ', filtered to', field: 'state' },
        ],
        github_get_pr_files: [
          { text: 'Lists files changed in pull request', field: 'pullNumber', core: true },
        ],
        github_close_pr: [
          { text: 'Closes pull request', field: 'pullNumber', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_request_reviewers: [
          { text: 'Requests review of pull request', field: 'pullNumber', core: true },
          { text: 'from', field: REVIEWER_FIELD },
        ],
        github_create_pr_review: [
          { text: 'Reviews pull request', field: 'pullNumber', core: true },
          { text: 'with action', field: 'event' },
        ],
        github_get_file_content: [
          { text: 'Reads file', field: 'path', core: true },
          { text: 'at', field: 'ref' },
        ],
        github_create_file: [
          { text: 'Creates file', field: 'path', core: true },
          { text: 'on branch', field: 'branch' },
        ],
        github_update_file: [
          { text: 'Rewrites file', field: 'path', core: true },
          { text: 'on branch', field: 'branch' },
        ],
        github_delete_file: [
          { text: 'Deletes file', field: 'path', core: true },
          { text: 'on branch', field: 'branch' },
        ],
        github_get_tree: [
          'Lists the file tree',
        ...
        github_get_readme: [
          { text: 'Reads the README of', field: 'repo', core: true },
          { text: 'at', field: 'ref' },
        ],
        github_list_tags: [{ text: 'Lists tags in', field: 'repo', core: true }],
        github_list_branches: [
          { text: 'Lists branches in', field: 'repo', core: true },
          { text: ', where protection is', field: 'protected' },
        ],
        github_get_branch: [
          { text: 'Reads branch', field: 'branch', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_create_branch: [
          { text: 'Creates branch', field: 'branch', core: true },
          { text: 'from', field: 'sha' },
        ],
        github_delete_branch: [
          { text: 'Deletes branch', field: 'branch', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_get_branch_protection: [
          { text: 'Reads protection rules for branch', field: 'branch', core: true },
        ],
        github_update_branch_protection: [
          { text: 'Updates protection rules for branch', field: 'branch', core: true },
          { text: ', requiring checks', field: 'required_status_checks' },
        ],
        github_create_issue: [
          { text: 'Opens issue', field: 'title', core: true },
          { text: 'in', field: 'repo' },
          { text: ', assigned to', field: 'assignees' },
        ],
        github_update_issue: [
          { text: 'Updates issue', field: 'issue_number', core: true },
          { text: ', setting title to', field: 'title' },
          { text: ', setting state to', field: 'state' },
        ],
        github_list_issues: [
          { text: 'Lists issues in', field: 'repo', core: true },
          { text: ', filtered to', field: 'state' },
        ],
        github_get_issue: [
          { text: 'Reads issue', field: 'issue_number', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_close_issue: [
          { text: 'Closes issue', field: 'issue_number', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_add_labels: [
          { text: 'Adds labels', field: 'labels', core: true },
          { text: 'to issue', field: 'issue_number', core: true },
        ],
        github_remove_label: [
          { text: 'Removes label', field: 'name', core: true },
          { text: 'from issue', field: 'issue_number' },
        ],
        github_add_assignees: [
          { text: 'Assigns', field: 'assignees', core: true },
          { text: 'to issue', field: 'issue_number', core: true },
        ],
        github_create_release: [
          { text: 'Creates release', field: 'tag_name', core: true },
          { text: ', titled', field: 'name' },
        ],
        github_update_release: [
          { text: 'Updates release', field: 'release_id', core: true },
          { text: ', renaming it to', field: 'name' },
        ],
        github_list_releases: [{ text: 'Lists releases in', field: 'repo', core: true }],
        github_get_release: [
          { text: 'Reads release', field: 'release_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_get_latest_release: [
          { text: 'Reads the latest release in', field: 'repo', core: true },
        ],
        github_delete_release: [
          { text: 'Deletes release', field: 'release_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_list_workflows: [{ text: 'Lists workflows in', field: 'repo', core: true }],
        github_get_workflow: [
          { text: 'Reads workflow', field: 'workflow_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_trigger_workflow: [
          { text: 'Runs workflow', field: 'workflow_id', core: true },
          { text: 'on', field: 'ref' },
          { text: ', with inputs', field: 'inputs' },
        ],
        github_list_workflow_runs: [
          { text: 'Lists workflow runs in', field: 'repo', core: true },
          { text: ', for workflow', field: 'workflow_id' },
          { text: ', where status is', field: 'status' },
        ],
        github_get_workflow_run: [
          { text: 'Reads workflow run', field: 'run_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_cancel_workflow_run: [
          { text: 'Cancels workflow run', field: 'run_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_rerun_workflow: [
          { text: 'Reruns workflow run', field: 'run_id', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_list_projects: [
          { text: 'Lists projects owned by', field: 'owner_login', core: true },
        ],
        github_get_project: [
          { text: 'Reads project', field: 'project_number', core: true },
          { text: 'owned by', field: 'owner_login' },
        ],
        github_create_project: [
          { text: 'Creates project', field: 'title', core: true },
          { text: 'under owner', field: 'owner_id' },
        ],
        github_update_project: [
          { text: 'Updates project', field: 'project_id', core: true },
          { text: ', renaming it to', field: 'title' },
          { text: ', setting visibility to', field: 'project_public' },
        ],
        github_delete_project: [{ text: 'Deletes project', field: 'project_id', core: true }],
        github_search_code: [{ text: 'Searches code for', field: 'q', core: true }],
        github_search_commits: [{ text: 'Searches commits for', field: 'q', core: true }],
        github_search_issues: [{ text: 'Searches issues for', field: 'q', core: true }],
        github_search_repos: [
          { text: 'Searches repositories for', field: 'q', core: true },
          { text: ', sorted by', field: 'sort' },
        ],
        github_search_users: [{ text: 'Searches users for', field: 'q', core: true }],
        github_list_commits: [
          { text: 'Lists commits in', field: 'repo', core: true },
          { text: 'on', field: 'sha' },
          { text: ', by', field: 'author' },
        ],
        github_get_commit: [
          { text: 'Reads commit', field: 'ref', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_compare_commits: [
          { text: 'Compares', field: 'base', core: true },
          { text: 'with', field: 'head' },
        ],
        github_create_gist: ['Creates a gist', { text: 'described as', field: 'description' }],
        github_get_gist: [{ text: 'Reads gist', field: 'gist_id', core: true }],
        github_list_gists: [
          'Lists gists',
        ...
        github_update_gist: [
          { text: 'Updates gist', field: 'gist_id', core: true },
          { text: ', described as', field: 'description' },
        ],
        github_delete_gist: [{ text: 'Deletes gist', field: 'gist_id', core: true }],
        github_fork_gist: [{ text: 'Forks gist', field: 'gist_id', core: true }],
        github_star_gist: [{ text: 'Stars gist', field: 'gist_id', core: true }],
        github_unstar_gist: [{ text: 'Unstars gist', field: 'gist_id', core: true }],
        github_fork_repo: [
          { text: 'Forks repository', field: 'repo', core: true },
          { text: 'into', field: 'organization' },
          { text: ', named', field: 'fork_name' },
        ],
        github_list_forks: [
          { text: 'Lists forks of', field: 'repo', core: true },
          { text: ', sorted by', field: 'fork_sort' },
        ],
        github_create_milestone: [
          { text: 'Creates milestone', field: 'milestone_title', core: true },
          { text: ', due', field: 'due_on' },
        ],
        github_get_milestone: [
          { text: 'Reads milestone', field: 'milestone_number', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_list_milestones: [
          { text: 'Lists milestones in', field: 'repo', core: true },
          { text: ', filtered to', field: 'milestone_state' },
        ],
        github_update_milestone: [
          { text: 'Updates milestone', field: 'milestone_number', core: true },
          { text: ', renaming it to', field: 'milestone_title' },
          { text: ', due', field: 'due_on' },
        ],
        github_delete_milestone: [
          { text: 'Deletes milestone', field: 'milestone_number', core: true },
          { text: 'in', field: 'repo' },
        ],
        github_create_issue_reaction: [
          { text: 'Reacts with', field: 'reaction_content', core: true },
          { text: 'to issue', field: 'issue_number', core: true },
        ],
        github_delete_issue_reaction: [
          { text: 'Removes reaction', field: 'reaction_id', core: true },
        ...
        github_star_repo: [{ text: 'Stars repository', field: 'repo', core: true }],
        github_unstar_repo: [{ text: 'Unstars repository', field: 'repo', core: true }],
        github_check_star: [
          { text: 'Checks whether', field: 'repo', after: 'is starred', core: true },
        ],
        github_list_stargazers: [{ text: 'Lists users who starred', field: 'repo', core: true }],
      },
    },
  },
  triggerAllowed: true,
