  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        ...
        get_monitor: [{ text: 'Fetches monitor', field: 'monitorId', core: true }],
        create_monitor: [
          { text: 'Creates', field: 'type', after: 'monitor', core: true },
          { text: 'named', field: 'friendlyName', core: true },
          { text: 'for', field: 'url' },
        ],
        update_monitor: [
          { text: 'Updates monitor', field: 'monitorId', core: true },
          { text: ', renaming it to', field: 'friendlyName' },
          { text: ', pointing it at', field: 'url' },
        ],
        delete_monitor: [{ text: 'Deletes monitor', field: 'monitorId', core: true }],
        pause_monitor: [{ text: 'Pauses checks on monitor', field: 'monitorId', core: true }],
        start_monitor: [{ text: 'Resumes checks on monitor', field: 'monitorId', core: true }],
        list_incidents: [
          'Lists incidents',
        ...
        get_incident: [{ text: 'Fetches incident', field: 'incidentId', core: true }],
        list_maintenance_windows: ['Lists all maintenance windows'],
        get_maintenance_window: [
          { text: 'Fetches maintenance window', field: 'maintenanceWindowId', core: true },
        ],
        create_maintenance_window: [
          { text: 'Schedules maintenance window', field: 'name', core: true },
          { text: ', starting', field: 'date' },
          { text: ', for', field: 'duration', after: 'minutes' },
        ],
        update_maintenance_window: [
          { text: 'Updates maintenance window', field: 'maintenanceWindowId', core: true },
          { text: ', renaming it to', field: 'name' },
          { text: ', with status', field: 'maintenanceStatus' },
        ],
        delete_maintenance_window: [
          { text: 'Deletes maintenance window', field: 'maintenanceWindowId', core: true },
        ],
        list_alert_contacts: ['Lists all alert contacts'],
        get_alert_contact: [{ text: 'Fetches alert contact', field: 'alertContactId', core: true }],
        create_alert_contact: [
          { text: 'Creates an email alert contact for', field: 'value', core: true },
          { text: ', named', field: 'friendlyName' },
        ],
        delete_alert_contact: [
          { text: 'Deletes alert contact', field: 'alertContactId', core: true },
        ],
        list_psps: ['Lists all status pages'],
        get_psp: [{ text: 'Fetches status page', field: 'pspId', core: true }],
        create_psp: [
          { text: 'Creates status page', field: 'friendlyName', core: true },
          { text: ', covering monitors', field: 'monitorIds' },
          { text: ', at', field: 'customDomain' },
        ],
        update_psp: [
          { text: 'Updates status page', field: 'pspId', core: true },
          { text: ', renaming it to', field: 'friendlyName' },
          { text: ', with status', field: 'pspStatus' },
        ],
        delete_psp: [{ text: 'Deletes status page', field: 'pspId', core: true }],
        get_account: ['Reads the account plan and limits'],
      },
    },
  },
