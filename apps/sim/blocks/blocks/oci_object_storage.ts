  ...
  tools: {
    ...
    config: {
      ...
      params: (params) => ({
        ...
        contentType: params.contentType === '' ? undefined : (params.contentType ?? undefined),
        prefix: params.prefix ?? undefined,
        delimiter: params.delimiter === '' ? undefined : (params.delimiter ?? undefined),
        maxKeys: parseOptionalNumberInput(params.maxKeys, 'Maximum results', {
          integer: true,
          min: 1,
          max: 1_000,
        }),
        startAfter: params.startAfter === '' ? undefined : (params.startAfter ?? undefined),
        continuationToken:
          params.continuationToken === '' ? undefined : (params.continuationToken ?? undefined),
      }),
    },
  },
  inputs: {
