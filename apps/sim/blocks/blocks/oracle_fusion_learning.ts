...
export const OracleFusionLearningBlock: BlockConfig = {
  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        ...
        get_self_paced_item: [
          {
            text: 'Get Self Paced Item for',
            field: ['learningItemIdPicker', 'learningItemIdInput'],
            core: true,
          },
        ],
        ...
        update_self_paced_item: [
          {
            text: 'Update Self Paced Item for',
            field: ['learningItemIdPicker', 'learningItemIdInput'],
            core: true,
          },
        ],
        delete_self_paced_item: [
          {
            text: 'Delete Self Paced Item for',
            field: ['learningItemIdPicker', 'learningItemIdInput'],
            core: true,
          },
        ],
        ...
        get_learning_event: [
          { text: 'Get Learning Event for', field: ['eventIdPicker', 'eventIdInput'], core: true },
        ],
        create_learning_event: [{ text: 'Create Learning Event', field: 'body', core: true }],
        update_learning_event: [
          {
            text: 'Update Learning Event for',
            field: ['eventIdPicker', 'eventIdInput'],
            core: true,
          },
        ],
        list_event_activities: [
          {
            text: 'List Event Activities for',
            field: ['eventIdPicker', 'eventIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        create_event_activity: [
          {
            text: 'Create Event Activity for',
            field: ['eventIdPicker', 'eventIdInput'],
            core: true,
          },
        ],
        update_event_activity: [
          {
            text: 'Update Event Activity for',
            field: ['activityIdPicker', 'activityIdInput'],
            core: true,
          },
        ],
        delete_event_activity: [
          {
            text: 'Delete Event Activity for',
            field: ['activityIdPicker', 'activityIdInput'],
            core: true,
          },
        ],
        list_learning_records: [
          { text: 'List Learning Records for', field: 'personId', core: true },
          { text: ', up to', field: 'limit', after: 'per page' },
        ],
        get_learning_record: [
          {
            text: 'Get Learning Record for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
        ],
        create_learning_record: [
          { text: 'Create Learning Record for', field: 'personId', core: true },
        ],
        update_learning_record: [
          {
            text: 'Update Learning Record for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
        ],
        list_selected_course_offerings: [
          {
            text: 'List Selected Course Offerings for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        select_course_offering: [
          {
            text: 'Select Course Offering for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
        ],
        update_selected_course_offering: [
          {
            text: 'Update Selected Course Offering for',
            field: ['offeringRecordIdPicker', 'offeringRecordIdInput'],
            core: true,
          },
        ],
        list_completion_details: [
          {
            text: 'List Completion Details for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        update_completion_detail: [
          {
            text: 'Update Completion Detail for',
            field: ['completionDetailIdPicker', 'completionDetailIdInput'],
            core: true,
          },
        ],
        list_completion_summaries: [
          {
            text: 'List Completion Summaries for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        list_learning_record_action_hints: [
          {
            text: 'List Learning Record Action Hints for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        list_enrollment_history: [
          {
            text: 'List Enrollment History for',
            field: ['recordIdPicker', 'recordIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        get_assignment_profile: [
          {
            text: 'Get Assignment Profile for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
        ],
        create_assignment_profile: [
          { text: 'Create Assignment Profile', field: 'body', core: true },
        ],
        update_assignment_profile: [
          {
            text: 'Update Assignment Profile for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
        ],
        process_assignment_profile: [
          {
            text: 'Process Assignment Profile for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
        ],
        list_assignment_profile_records: [
          {
            text: 'List Assignment Profile Records for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        list_assignment_profile_criteria: [
          {
            text: 'List Assignment Profile Criteria for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        add_assignment_profile_criterion: [
          {
            text: 'Add Assignment Profile Criterion for',
            field: ['profileIdPicker', 'profileIdInput'],
            core: true,
          },
        ],
        remove_assignment_profile_criterion: [
          { text: 'Remove Assignment Profile Criterion for', field: 'criterionId', core: true },
        ],
        list_learning_item_audiences: [
          {
            text: 'List Learning Item Audiences for',
            field: ['learningItemIdPicker', 'learningItemIdInput'],
            core: true,
          },
          { text: ', up to', field: 'limit', after: 'per page' },
        ...
        add_learning_item_audience: [
          {
            text: 'Add Learning Item Audience for',
            field: ['learningItemIdPicker', 'learningItemIdInput'],
            core: true,
          },
        ],
        remove_learning_item_audience: [
          { text: 'Remove Learning Item Audience for', field: 'audienceId', core: true },
        ],
  ...
  subBlocks: [
    ...
    },
    {
      ...
      type: 'oauth-input',
      serviceId: 'oracle_fusion_learning',
      requiredScopes: getScopesForService('oracle_fusion_learning'),
    ...
    },
    {
      ...
      wandConfig: {
        ...
        prompt:
          'Return only a valid YYYY-MM-DD effective date for the requested Oracle Learning read.',
      },
    },
    {
      id: 'learningItemIdPicker',
      title: 'Learning Item Id',
      type: 'file-selector',
      canonicalParamId: 'learningItemId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.selfPacedItems',
      dependsOn: ['credential', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
        value: [
      ...
      placeholder: 'Select learning item id',
    },
    {
      id: 'learningItemIdInput',
      title: 'Learning Item Id',
      type: 'short-input',
      canonicalParamId: 'learningItemId',
      mode: 'advanced',
    ...
    },
    {
      ...
      title: 'Event Id',
      type: 'file-selector',
      canonicalParamId: 'eventId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.events',
      dependsOn: ['credential', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
    ...
    },
    {
      ...
      title: 'Activity Id',
      type: 'file-selector',
      canonicalParamId: 'activityId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.eventActivities',
      dependsOn: ['credential', 'eventIdPicker', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
        value: ['update_event_activity', 'delete_event_activity'],
      },
      required: {
        field: 'operation',
        value: ['update_event_activity', 'delete_event_activity'],
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['list_learning_records', 'list_selected_course_offerings'],
      },
      required: false,
    ...
    },
    {
      ...
      title: 'Record Id',
      type: 'file-selector',
      canonicalParamId: 'recordId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.learningRecords',
      dependsOn: ['credential', 'personId', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
        value: [
    ...
    {
      id: 'offeringRecordIdPicker',
      title: 'Offering Record Id',
      type: 'file-selector',
      canonicalParamId: 'offeringRecordId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.selectedCourseOfferings',
      dependsOn: ['credential', 'personId', 'recordIdPicker', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
        value: [
      ...
      required: {
        field: 'operation',
        value: ['update_selected_course_offering'],
      },
      placeholder: 'Select offering record id',
    },
    {
      id: 'offeringRecordIdInput',
      title: 'Offering Record Id',
      type: 'short-input',
      canonicalParamId: 'offeringRecordId',
      mode: 'advanced',
    ...
    {
      id: 'completionDetailIdPicker',
      title: 'Completion Detail Id',
      type: 'file-selector',
      canonicalParamId: 'completionDetailId',
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.completionDetails',
      dependsOn: ['credential', 'personId', 'recordIdPicker', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
        value: ['update_completion_detail'],
      },
      required: {
        field: 'operation',
        value: ['update_completion_detail'],
      },
      placeholder: 'Select completion detail id',
    },
    {
      id: 'completionDetailIdInput',
      title: 'Completion Detail Id',
      type: 'short-input',
      canonicalParamId: 'completionDetailId',
      mode: 'advanced',
    ...
    },
    {
      ...
      serviceId: 'oracle_fusion_learning',
      selectorKey: 'oracle_fusion_learning.assignmentProfiles',
      dependsOn: ['credential', 'effectiveDate'],
      mode: 'basic',
      condition: {
        field: 'operation',
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['remove_assignment_profile_criterion'],
      },
      required: {
        field: 'operation',
        value: ['remove_assignment_profile_criterion'],
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['remove_learning_item_audience'],
      },
      required: {
        field: 'operation',
        value: ['remove_learning_item_audience'],
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['get_content_item', 'update_content_item'],
      },
      required: {
        field: 'operation',
        value: ['get_content_item', 'update_content_item'],
    ...
    {
      id: 'body',
      title: 'Writable Fields (JSON)',
      type: 'code',
      language: 'json',
      condition: {
        field: 'operation',
        value: BODY_OPERATIONS,
      },
      required: {
        field: 'operation',
        value: BODY_OPERATIONS,
      ...
      description:
        'Use the documented fields for the selected operation. Keep IDs as strings. Omit unchanged fields; use null only for nullable fields. Completion detail updates accept activityAttemptStatus and activityAttemptCompletionReasonCode only.',
      placeholder: '{"learningItemDescription":"Updated course description"}',
      wandConfig: {
        enabled: true,
        generationType: 'json-object',
        prompt:
          'Generate only the documented writable JSON fields for the selected Oracle Fusion Learning operation. Use decimal strings for IDs. Do not invent status or lookup codes, inject PATCH defaults, or include upload material. Return only JSON.',
      },
    },
  ],
  tools: {
    ...
    config: {
      ...
      params: (params) => {
        ...
        if (typeof rest.body === 'string' && rest.body.trim()) {
          if (
            rest.body.length > MAX_INLINE_MATERIALIZATION_BYTES ||
            new TextEncoder().encode(rest.body).byteLength > MAX_INLINE_MATERIALIZATION_BYTES
          ) {
          ...
          try {
            ...
            throw new Error('Writable fields must be valid JSON')
          }
        }
        ...
        if (
          ...
          rest.offeringRecordId = undefined
        return rest
      },
    },
  },
  ...
  outputs: {
    ...
    items: {
      type: 'json',
      description: 'One page of projected Learning records',
      condition: { field: 'operation', value: LIST_OPERATIONS },
    },
    deleted: {
      type: 'boolean',
      description: 'Oracle accepted the deletion',
      condition: { field: 'operation', value: DELETE_OPERATIONS },
    },
    result: {
      type: 'number',
      description: 'Numeric processing acknowledgement; not a verified job ID',
      condition: { field: 'operation', value: 'process_assignment_profile' },
    },
    count: {
      type: 'number',
      description: 'count',
...
export const OracleFusionLearningBlockMeta = {
  ...
  templates: [
    {
      icon: NetSuiteIcon,
      title: 'Review learner completion',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Review selected course offerings',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Prepare self-paced catalog drafts',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Schedule Learning event activities',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Process administrator assignment profiles',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Maintain learning audiences',
      prompt:
    ...
    {
      icon: NetSuiteIcon,
      title: 'Maintain web-link content metadata',
      prompt:
