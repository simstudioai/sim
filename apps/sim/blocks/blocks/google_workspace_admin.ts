  ...
  subBlocks: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'allIncludingParent', label: 'All descendants and the parent' },
      ],
...
Return ONLY the query string - no explanations, no quotes, no extra text.`,
    ...
    },
    {
      ...
      type: 'short-input',
      mode: 'advanced',
      placeholder: 'email, lastSync, serialNumber, ...',
      condition: {
        field: 'operation',
        value: ['list_users', 'list_mobile_devices', 'list_chromeos_devices'],
      },
    ...
    },
    {
      ...
      type: 'short-input',
      mode: 'advanced',
      placeholder: 'basic, custom, or full (BASIC or FULL for devices)',
      condition: {
        field: 'operation',
        value: [
          'list_users',
