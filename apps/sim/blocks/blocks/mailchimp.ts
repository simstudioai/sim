...
Return ONLY the JSON array - no explanations or markdown.`,
  ...
  inputs: {
    ...
    contact: { type: 'json', description: 'Contact information JSON object' },
    campaignDefaults: { type: 'json', description: 'Campaign defaults JSON object' },
    campaignSettings: { type: 'json', description: 'Campaign settings JSON object' },
    recipients: { type: 'json', description: 'Recipients JSON object' },
    mergeFields: { type: 'json', description: 'Merge fields JSON object' },
    interests: { type: 'json', description: 'Interests JSON object' },
    tags: { type: 'json', description: 'Tags JSON array' },
    segmentOptions: { type: 'json', description: 'Segment options JSON object' },
    operations: { type: 'json', description: 'Batch operations JSON array' },
  },
  outputs: {
