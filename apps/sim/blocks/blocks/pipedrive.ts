  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        ...
        get_deal: [{ text: 'Reads deal', field: 'deal_id', core: true }],
        create_deal: [
          { text: 'Creates deal', field: 'title', core: true },
          { text: 'in', field: PIPELINE_FIELD },
          { text: ', worth', field: 'value' },
        ],
        update_deal: [
          { text: 'Updates deal', field: 'deal_id', core: true },
          { text: ', setting status to', field: 'status' },
          { text: ', moving it to stage', field: 'stage_id' },
        ],
        get_files: ['Lists files', { text: ', up to', field: 'limit' }],
        get_mail_messages: [
          'Lists mail threads',
        ...
        get_mail_thread: [
          { text: 'Reads every message in mail thread', field: 'thread_id', core: true },
        ],
        get_pipelines: ['Lists pipelines', { text: ', up to', field: 'limit' }],
        get_pipeline_deals: [
          { text: 'Lists deals in pipeline', field: PIPELINE_FIELD, core: true },
          { text: ', at stage', field: 'stage_id' },
          { text: ', up to', field: 'limit' },
        ],
        get_projects: [
          { text: 'Reads project', field: 'project_id', core: true },
          { text: ', with status', field: 'status' },
        ],
        create_project: [
        ...
        create_activity: [
          { text: 'Creates activity', field: 'subject', core: true },
          { text: ', due', field: 'due_date' },
          { text: ', on deal', field: 'deal_id' },
        ],
        update_activity: [
          { text: 'Updates activity', field: 'activity_id', core: true },
          { text: ', renaming it to', field: 'subject' },
          { text: ', due', field: 'due_date' },
        ],
        get_leads: [
          { text: 'Reads lead', field: 'lead_id', core: true },
          { text: ', owned by', field: 'owner_id' },
        ],
        create_lead: [
          { text: 'Creates lead', field: 'title', core: true },
          { text: ', worth', field: 'value_amount' },
          { text: ', owned by', field: 'owner_id' },
        ],
        update_lead: [
          { text: 'Updates lead', field: 'lead_id', core: true },
          { text: ', renaming it to', field: 'title' },
          { text: ', worth', field: 'value_amount' },
        ],
        delete_lead: [{ text: 'Deletes lead', field: 'lead_id', core: true }],
      },
    },
  },
  subBlocks: [
