...
export const PagerDutyBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Build a workflow triggered by a new PagerDuty incident that pulls the affected service details, queries recent logs and the latest deploy, and posts an enriched triage summary with likely cause back as an incident note for the responder.',
      modules: ['agent', 'workflows'],
      category: 'engineering',
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that watches PagerDuty for incidents on customer-facing services, looks up affected accounts in the CRM, and drafts a status-page update plus a Slack alert to the customer success team for high-impact outages.',
      modules: ['agent', 'workflows'],
      category: 'support',
      tags: ['support', 'incident', 'communication'],
    ...
    },
    {
      ...
      category: 'engineering',
      tags: ['devops', 'incident', 'ticketing'],
