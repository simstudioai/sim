...
export const IntercomBlock: BlockConfig = {
  ...
  canvasPresentation: {
    ...
    sentences: {
      byOperation: {
        create_contact: [
          { text: 'Creates contact', field: CONTACT_IDENTITY_FIELD, core: true },
          { text: 'as', field: 'role' },
        ],
        ...
        list_contacts: ['Lists contacts', { text: ', in pages of', field: 'per_page' }],
        search_contacts: [
        ...
        create_company: [
          {
            text: 'Creates or updates company',
            field: ['company_name', 'company_id'],
            core: true,
          },
          { text: ', on plan', field: 'plan' },
        ],
        get_company: [{ text: 'Fetches company', field: 'companyId', core: true }],
        list_companies: ['Lists companies', { text: ', in pages of', field: 'per_page' }],
        get_conversation: [{ text: 'Fetches conversation', field: 'conversationId', core: true }],
        list_conversations: ['Lists conversations', { text: ', sorted by', field: 'sort' }],
        reply_conversation: [
          { text: 'Replies', field: 'body', core: true },
          { text: 'to conversation', field: 'conversationId', core: true },
        ],
        search_conversations: [
          { text: 'Searches conversations for', field: 'query', core: true },
          { text: ', sorted by', field: 'sort_field' },
        ],
        create_ticket: [{ text: 'Creates a ticket of type', field: 'ticket_type_id', core: true }],
        ...
        create_message: [
          { text: 'Sends', field: MESSAGE_PREVIEW_FIELD, core: true },
          { text: 'to', field: 'to_id', core: true },
        ],
        list_admins: ['Lists all admins'],
        close_conversation: [
          { text: 'Closes conversation', field: 'conversationId', core: true },
          { text: ', with', field: 'close_body' },
        ],
        open_conversation: [{ text: 'Reopens conversation', field: 'conversationId', core: true }],
        snooze_conversation: [
          { text: 'Snoozes conversation', field: 'conversationId', core: true },
          { text: 'until', field: 'snoozed_until' },
        ],
        assign_conversation: [
          { text: 'Assigns conversation', field: 'conversationId', core: true },
          { text: 'to', field: 'assignee_id' },
        ],
        list_tags: ['Lists all tags'],
        create_tag: [{ text: 'Creates or renames tag', field: 'tag_name', core: true }],
        tag_contact: [
        ...
        create_note: [
          { text: 'Adds note', field: 'note_body', core: true },
          { text: 'to contact', field: 'tag_contact_id', core: true },
        ],
        create_event: [
          { text: 'Tracks event', field: 'event_name', core: true },
          { text: 'for', field: EVENT_ACTOR_FIELD },
        ],
        attach_contact_to_company: [
          { text: 'Adds contact', field: 'tag_contact_id', core: true },
          { text: 'to company', field: 'attach_company_id', core: true },
        ],
        detach_contact_from_company: [
          { text: 'Removes contact', field: 'tag_contact_id', core: true },
