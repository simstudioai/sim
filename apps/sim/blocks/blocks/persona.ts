...
export const PersonaBlock: BlockConfig<PersonaResponse> = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: 'operation',
        value: ['create_inquiry', 'get_account', 'list_inquiries', 'list_cases', 'create_report'],
      },
      required: { field: 'operation', value: 'get_account' },
    },
    {
      id: 'referenceId',
      title: 'Reference ID',
    ...
    },
    {
      ...
      condition: { field: 'operation', value: ['create_inquiry', 'create_account'] },
      wandConfig: {
        enabled: true,
        prompt:
    ...
    },
    {
      ...
      placeholder: '10',
      mode: 'advanced',
      condition: { field: 'operation', value: ['list_inquiries', 'list_accounts', 'list_cases'] },
    },
    {
      id: 'pageAfter',
    ...
    },
    {
      ...
      placeholder: 'US',
      mode: 'advanced',
      condition: { field: 'operation', value: ['create_account', 'create_report'] },
    },
    {
      id: 'reportId',
      title: 'Report ID',
  ...
  inputs: {
    ...
    tags: { type: 'json', description: 'Tag names to associate with the account' },
