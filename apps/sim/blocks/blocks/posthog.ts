...
Return ONLY the timestamp string - no explanations, no quotes, no extra text.`,
  ...
  inputs: {
    ...
    properties: { type: 'json', description: 'Event properties as JSON' },
    personProperties: { type: 'json', description: 'Person properties as JSON' },
    groupProperties: { type: 'json', description: 'Group properties as JSON' },
    timestamp: { type: 'string', description: 'Event timestamp (ISO 8601)' },
    batch: { type: 'json', description: 'Batch events as JSON array' },
    query: { type: 'string', description: 'HogQL query or JSON object' },
    values: { type: 'json', description: 'Query parameters' },
    // IDs
    ...
    parameters: { type: 'json', description: 'Experiment parameters as JSON' },
    variants: { type: 'json', description: 'Experiment variants as JSON' },
    questions: { type: 'json', description: 'Survey questions as JSON array' },
    appearance: { type: 'json', description: 'Survey appearance as JSON' },
    conditions: { type: 'json', description: 'Survey conditions as JSON' },
    targetingFlagFilters: { type: 'json', description: 'Targeting flag filters as JSON' },
