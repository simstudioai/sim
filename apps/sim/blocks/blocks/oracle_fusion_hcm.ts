...
export const OracleFusionHcmBlock: BlockConfig = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      mode: 'basic',
      condition: { field: 'operation', value: ['get_salary', 'correct_salary', 'list_salary_components'] },
      required: { field: 'operation', value: ['get_salary', 'correct_salary', 'list_salary_components'] },
    ...
    },
    {
      ...
      type: 'dropdown',
      options: [{ id: 'standard', label: 'standard' }, { id: 'simple', label: 'simple' }, { id: 'rate', label: 'rate' }],
      value: () => 'standard',
    ...
    },
    {
      ...
      type: 'short-input',
      condition: { field: 'operation', value: ['list_goal_plans', 'list_performance_goals', 'list_performance_documents', 'get_goal_plan', 'get_performance_document', 'list_performance_document_roles', 'list_performance_document_participants', 'list_performance_document_tasks'] },
      required: { field: 'operation', value: [] },
    ...
    },
    {
      ...
      mode: 'basic',
      condition: { field: 'operation', value: ['get_performance_document', 'list_performance_document_roles', 'list_performance_document_participants', 'list_performance_document_tasks'] },
      required: { field: 'operation', value: ['get_performance_document', 'list_performance_document_roles', 'list_performance_document_participants', 'list_performance_document_tasks'] },
    ...
    },
    {
      ...
      title: 'Eval Role Id',
      type: 'short-input',
      condition: { field: 'operation', value: ['list_performance_document_participants', 'list_performance_document_tasks'] },
      required: { field: 'operation', value: ['list_performance_document_participants', 'list_performance_document_tasks'] },
