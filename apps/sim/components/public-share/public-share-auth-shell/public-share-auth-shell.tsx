...
interface PublicShareAuthShellProps {
  title: string
  subtitle: string
  children: ReactNode
}
...
/**
 * Light, logo-only shell shared by every public-share auth gate (password,
 * email OTP, SSO), matching the deployed-chat auth screens. Renders no resource
 * metadata — the name/provenance are withheld until the visitor authenticates.
 */
export function PublicShareAuthShell({ title, subtitle, children }: PublicShareAuthShellProps) {
  return (
