...
import { EditorContextMenu } from '@/components/resources/file-view/components/editor-context-menu/editor-context-menu'
import {
  PreviewPanel,
  resolvePreviewType,
...
export const TextEditor = memo(function TextEditor({
  ...
  const isAgentEditing = streaming?.isAgentEditing
  const disableStreamingAutoScroll = streaming?.disableAutoScroll ?? false
