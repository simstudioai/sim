...
import { MermaidDiagram } from '@/components/resources/file-view/components/mermaid-diagram/mermaid-diagram'
import { ZoomablePreview } from '@/components/resources/file-view/components/zoomable-preview/zoomable-preview'
import {
  type CsvImportFileDescriptor,
  useCsvTruncationImport,
} from '@/components/resources/file-view/hooks/csv-import'
...
import { fileWorkspaceId } from '@/resources/file-source'
...
export const PreviewPanel = memo(function PreviewPanel({
  ...
  if (previewType === 'csv')
    return (
      <CsvPreview content={content} file={{ key: fileKey, name: filename }} readOnly={readOnly} />
    )
...
const CsvPreview = memo(function CsvPreview({
  ...
  // No workspace to import into on a share, so the offer is withheld there too.
  useCsvTruncationImport(workspaceId ?? '', file, truncated, readOnly || !workspaceId)
