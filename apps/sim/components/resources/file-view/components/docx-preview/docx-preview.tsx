...
import { PreviewToolbar } from '@/components/resources/file-view/components/preview-toolbar/preview-toolbar'
...
export const DocxPreview = memo(function DocxPreview({ file }: { file: FileViewRecord }) {
