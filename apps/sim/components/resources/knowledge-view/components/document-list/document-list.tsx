 ...
 */
export interface DocumentListInteraction {
...
export interface DocumentListProps {
  ...
  interaction?: DocumentListInteraction
}
 ...
 */
export function DocumentList({ source, grants, list, interaction }: DocumentListProps) {
  const {
    documents,
    tagDefinitions,
    connectors,
