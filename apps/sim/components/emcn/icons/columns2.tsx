...
/**
 * Columns2 icon (Hugeicons stroke-rounded: LayoutTwoColumnIcon)
 * @param props - SVG properties including className, size, fill, etc.
 */
export function Columns2({ size = 24, width, height, ...props }: IconProps) {
  return (
    <svg
    ...
    >
      <path
        ...
        strokeWidth='1.5'
      />
      <path d='M12 2.5V21.5' stroke='currentColor' strokeLinecap='round' strokeWidth='1.5' />
    </svg>
  )
}
