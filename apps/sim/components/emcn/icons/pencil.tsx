...
/**
 * Pencil icon (Hugeicons stroke-rounded: PencilEdit01Icon)
 * @param props - SVG properties including className, size, fill, etc.
 */
export function Pencil({ size = 24, width, height, ...props }: IconProps) {
  return (
    <svg
    ...
    >
      <path
        ...
        strokeWidth='1.5'
      />
      <path d='M11 20H17' stroke='currentColor' strokeLinecap='round' strokeWidth='1.5' />
    </svg>
  )
}
