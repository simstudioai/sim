...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, SliderProps>(
  ({ className, ...props }, ref) => (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className='relative h-[6px] w-full grow overflow-hidden rounded-[20px] bg-[var(--surface-6)] transition-colors'>
        <SliderPrimitive.Range className='absolute h-full bg-[var(--surface-6)]' />
