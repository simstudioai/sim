...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, SliderProps>(
  ({ className, disabled, ...props }, ref) => (
    ...
    >
      ...
      <SliderPrimitive.Thumb className='relative block h-[14px] w-[14px] cursor-pointer rounded-full bg-[var(--text-primary)] shadow-sm transition-colors before:absolute before:inset-[-15px] before:content-[""] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--text-muted)]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface-2)]' />
    </SliderPrimitive.Root>
  )
)
