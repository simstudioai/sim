              ...
              {editable ? (
                <div className='group relative'>
                  <Input
                    ref={inputRef}
                    className={cn(
                      'w-full pr-[40px] font-medium transition-colors hover:border-[var(--surface-6)] hover:bg-[var(--surface-5)] dark:hover:border-[var(--surface-6)] dark:hover:bg-[var(--border-1)]',
