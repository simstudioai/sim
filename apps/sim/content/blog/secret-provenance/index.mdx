...
faq:
  ...
  - q: "What happens if Sim cannot determine whether content contains a secret?"
    a: "Incomplete provenance at a run's own egress boundaries withholds the payload while preserving safe diagnostic structure. Durable reads follow the surface's enforcement policy: legacy content remains readable, and unknown stored provenance can be observed before enforcement is enabled."
