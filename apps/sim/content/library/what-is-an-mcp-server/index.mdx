...
## [How an MCP server works](#how-an-mcp-server-works)
...
## [MCP server examples: GitHub, filesystems, and databases](#mcp-server-examples-github-filesystems-and-databases)
...
### [Database query MCP server](#database-query-mcp-server)
...
## [MCP server vs. traditional API integration vs. a Sim workflow as an MCP tool](#mcp-server-vs-traditional-api-integration-vs-a-sim-workflow-as-an-mcp-tool)
...
## [Using Sim as an MCP client and MCP server](#using-sim-as-an-mcp-client-and-mcp-server)
...
## [Getting started with MCP and Sim](#getting-started-with-mcp-and-sim)
