...
- **n8n:** n8n uses the source-available [Sustainable Use License, Version 1.0](https://docs.n8n.io/privacy-and-security/sustainable-use-license/), and its [hosted plans](https://n8n.io/pricing/) are billed by complete workflow executions rather than individual steps.
...
- The Community Edition can support internal automation under the [Sustainable Use License terms](https://docs.n8n.io/privacy-and-security/sustainable-use-license/).
...
- [Sustainable Use License v1.0](https://docs.n8n.io/privacy-and-security/sustainable-use-license/) is source-available but not OSI-approved open source.
- [White-label resale and charging others for hosted n8n access](https://docs.n8n.io/privacy-and-security/sustainable-use-license/) require a separate commercial agreement.
