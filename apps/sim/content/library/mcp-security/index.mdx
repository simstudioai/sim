...
Adoption is currently outpacing the maturity of MCP servers as a business tool, so the potential for security issues is significant. [Anthropic introduced MCP](https://www.anthropic.com/news/model-context-protocol) in late 2024, and within roughly a year, more than 18,000 servers were listed on [MCP Market](https://mcpmarket.com/). Many ship faster than they're secured. Platforms like Sim use MCP for custom integrations, which makes MCP security a significant product concern.
