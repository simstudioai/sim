...
- **Windsurf** pricing is no longer independently verifiable on a vendor-owned Windsurf price page. [Cognition’s Devin pricing](https://cognition.com/blog/new-self-serve-plans-for-devin), where the product now sits, lists Free, Pro ($20 per month), Max ($200 per month), and Team ($80 per month plus $40 per seat) tiers.
...
| Windsurf / Cognition | In-IDE coding agent | Local + cloud agents in one IDE | Proprietary, local app | Local IDE | See [Cognition’s Devin pricing](https://cognition.com/blog/new-self-serve-plans-for-devin) |
