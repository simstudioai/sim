...
- **Sim:** As of September 2026, Sim uses the OSI-approved Apache License 2.0 and supports free self-hosting; Sim Cloud’s exact current billing unit was not independently verified for this article and should be checked on Sim’s official pricing page before publication.
