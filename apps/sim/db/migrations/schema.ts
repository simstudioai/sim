...
export const document = pgTable(
  ...
  (table) => [
    ...
    index('doc_kb_uploaded_at_idx').using(
      'btree',
      table.knowledgeBaseId.asc().nullsLast().op('timestamp_ops'),
...
export const workspaceMember = pgTable(
  ...
  (table) => [
    uniqueIndex('user_workspace_idx').using(
      'btree',
...
export const embedding = pgTable(
  ...
  (table) => [
    ...
    index('emb_kb_access_idx').using(
      'btree',
      table.knowledgeBaseId.asc().nullsLast().op('text_ops'),
      table.lastAccessedAt.asc().nullsLast().op('timestamp_ops')
    ),
    ...
    index('emb_kb_rank_idx').using(
      'btree',
      table.knowledgeBaseId.asc().nullsLast().op('text_ops'),
      table.searchRank.asc().nullsLast().op('text_ops')
    ),
