import { pgTable, text, timestamp, foreignKey, unique, json, integer, boolean, uniqueIndex, index, jsonb, numeric, check, uuid, vector, pgEnum } from "drizzle-orm/pg-core"
...
export const subscription = pgTable("subscription", {
	...
	check("check_enterprise_metadata", sql`(plan <> 'enterprise'::text) OR ((metadata IS NOT NULL) AND (((metadata ->> 'perSeatAllowance'::text) IS NOT NULL) OR ((metadata ->> 'totalAllowance'::text) IS NOT NULL)))`),
]);

export const workflowExecutionBlocks = pgTable("workflow_execution_blocks", {
	id: text().primaryKey().notNull(),
	...
	index("execution_blocks_block_id_idx").using("btree", table.blockId.asc().nullsLast().op("text_ops")),
	index("execution_blocks_cost_idx").using("btree", table.costTotal.asc().nullsLast().op("numeric_ops")),
	index("execution_blocks_duration_idx").using("btree", table.durationMs.asc().nullsLast().op("int4_ops")),
	index("execution_blocks_execution_id_idx").using("btree", table.executionId.asc().nullsLast().op("text_ops")),
	index("execution_blocks_execution_status_idx").using("btree", table.executionId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("execution_blocks_started_at_idx").using("btree", table.startedAt.asc().nullsLast().op("timestamp_ops")),
	index("execution_blocks_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	index("execution_blocks_workflow_execution_idx").using("btree", table.workflowId.asc().nullsLast().op("text_ops"), table.executionId.asc().nullsLast().op("text_ops")),
	index("execution_blocks_workflow_id_idx").using("btree", table.workflowId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.workflowId],
			foreignColumns: [workflow.id],
...
export const workflowExecutionLogs = pgTable("workflow_execution_logs", {
	...
	index("workflow_execution_logs_cost_idx").using("btree", table.totalCost.asc().nullsLast().op("numeric_ops")),
	index("workflow_execution_logs_duration_idx").using("btree", table.totalDurationMs.asc().nullsLast().op("int4_ops")),
	index("workflow_execution_logs_execution_id_idx").using("btree", table.executionId.asc().nullsLast().op("text_ops")),
...
export const docsEmbeddings = pgTable("docs_embeddings", {
	...
	index("docs_emb_source_header_idx").using("btree", table.sourceDocument.asc().nullsLast().op("text_ops"), table.headerLevel.asc().nullsLast().op("int4_ops")),
...
export const document = pgTable("document", {
	...
	index("doc_kb_uploaded_at_idx").using("btree", table.knowledgeBaseId.asc().nullsLast().op("text_ops"), table.uploadedAt.asc().nullsLast().op("timestamp_ops")),
...
export const embedding = pgTable("embedding", {
	...
	uniqueIndex("emb_doc_chunk_idx").using("btree", table.documentId.asc().nullsLast().op("int4_ops"), table.chunkIndex.asc().nullsLast().op("text_ops")),
	...
	index("emb_kb_enabled_idx").using("btree", table.knowledgeBaseId.asc().nullsLast().op("text_ops"), table.enabled.asc().nullsLast().op("text_ops")),
...
export const templates = pgTable("templates", {
	...
	index("templates_category_stars_idx").using("btree", table.category.asc().nullsLast().op("int4_ops"), table.stars.asc().nullsLast().op("text_ops")),
	index("templates_category_views_idx").using("btree", table.category.asc().nullsLast().op("int4_ops"), table.views.asc().nullsLast().op("text_ops")),
	...
	index("templates_user_category_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.category.asc().nullsLast().op("text_ops")),
	...
	index("templates_workflow_id_idx").using("btree", table.workflowId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.workflowId],
			foreignColumns: [workflow.id],
...
export const copilotCheckpoints = pgTable("copilot_checkpoints", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: text("user_id").notNull(),
	workflowId: text("workflow_id").notNull(),
	...
	index("copilot_checkpoints_chat_created_at_idx").using("btree", table.chatId.asc().nullsLast().op("uuid_ops"), table.createdAt.asc().nullsLast().op("uuid_ops")),
	index("copilot_checkpoints_chat_id_idx").using("btree", table.chatId.asc().nullsLast().op("uuid_ops")),
	index("copilot_checkpoints_created_at_idx").using("btree", table.createdAt.asc().nullsLast().op("timestamp_ops")),
	index("copilot_checkpoints_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("copilot_checkpoints_user_workflow_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.workflowId.asc().nullsLast().op("text_ops")),
	index("copilot_checkpoints_workflow_chat_idx").using("btree", table.workflowId.asc().nullsLast().op("text_ops"), table.chatId.asc().nullsLast().op("uuid_ops")),
	index("copilot_checkpoints_workflow_id_idx").using("btree", table.workflowId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
