CREATE TYPE "public"."permission_type" AS ENUM('admin', 'read', 'edit', 'deploy');--> statement-breakpoint
...
ALTER TABLE "workspace_invitation" ADD COLUMN "permissions" "permission_type"[] DEFAULT ARRAY['admin', 'read', 'edit', 'deploy']::"permission_type"[] NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "permissions_unique_constraint" ON "permissions" USING btree ("user_id","entity_type","entity_id","permission_type");