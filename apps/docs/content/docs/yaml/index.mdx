...
<Steps>
  ...
  <Step>
    <strong>Block References</strong>: Use block names in lowercase with spaces removed (e.g., `<agent1.content>`)
  </Step>
  <Step>
...
next-block:
  ...
  inputs:
    userPrompt: |
      Process this email: <emailprocessor.content>
      Use this formatted data: <dataformatter.output>
