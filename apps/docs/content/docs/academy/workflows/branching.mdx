...
<VideoPlaceholder eyebrow="Workflows" title="Branching" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy/workflows-branching.mp4"
  captionsSrc="/captions/academy/workflows-branching.en.vtt" className="mt-2" />
