...
<VideoPlaceholder eyebrow="Workflows" title="Workflows" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy/workflows-intro.mp4"
  captionsSrc="/captions/academy/workflows-intro.en.vtt" className="mt-2" />
