...
<VideoPlaceholder eyebrow="Workflows" title="Subworkflows" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy/workflows-subworkflows.mp4"
  captionsSrc="/captions/academy/workflows-subworkflows.en.vtt" className="mt-2" />
