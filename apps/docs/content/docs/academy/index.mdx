...
<VideoPlaceholder eyebrow="Get Started" title="What is Sim?" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy/what-is-sim.mp4"
  captionsSrc="/captions/academy/what-is-sim.en.vtt" className="mt-2" />
...
<FAQ items={[
  ...
  { question: "How long are the lessons?", answer: "Most lessons pair a short video with a written explanation. Some include an interactive workflow preview; use-case exercises combine the concepts into a task." },
]} />
