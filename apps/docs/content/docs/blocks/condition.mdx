...
<Tabs items={['Numeric Comparison', 'String Evaluation', 'Multiple Conditions', 'Complex Logic']}>
  <Tab>
    ```yaml
    number-check:
      type: condition
      ...
      inputs:
        conditions:
          if: <start.input> > 5
          else-if: <start.input> > 10
          else-if-2: <start.input> > 15
      connections:
        conditions:
          if: low-tier-agent
          else-if: mid-tier-agent
          else-if-2: high-tier-agent
          else: default-agent
    ```
  </Tab>
  <Tab>
    ...
    user-type-check:
      ...
      inputs:
        conditions:
          if: <agent.user_type> === 'premium'
          else-if: <agent.user_type> === 'basic'
      connections:
        conditions:
          if: premium-workflow
          else-if: basic-workflow
  ...
  <Tab>
    ...
    multi-condition:
      ...
      inputs:
        conditions:
          if: <agent.score> >= 80 && <agent.verified> === true
          else-if: <agent.score> >= 60
      connections:
        conditions:
          if: high-priority-path
          else-if: medium-priority-path
          else: low-priority-path
    ```
  </Tab>
  <Tab>
    ```yaml
    business-logic:
      ...
      inputs:
        conditions:
          if: <agent.total> > 100 && <agent.member_tier> === 'gold'
          else-if: <agent.total> > 50
      connections:
        conditions:
          if: free-shipping-flow
          else-if: standard-shipping-flow
          else: basic-checkout-flow
    ```
  </Tab>
</Tabs>
