...
<FAQ items={[
  { question: "Is there a row limit per table?", answer: "Yes. Row and table counts depend on the plan and deployment configuration. By default, a row may contain up to 400 KB of data and a table up to 1,000 columns. Use pagination for large reads; query responses have a 5 MB row-data budget." },
