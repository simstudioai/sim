...
<div className="mb-4 rounded-md border p-4">
  <h4 className="font-medium">シナリオ：複数のバリエーションを生成</h4>
  <ol className="list-decimal pl-5 text-sm">
...
<div className="mb-4 rounded-md border p-4">
  <h4 className="font-medium">シナリオ：カウンターベースのループでアイテムを処理</h4>
  <ol className="list-decimal pl-5 text-sm">
...
<Callout type="info">
  ループは並列ではなく、順次実行されます。並行実行が必要な場合は、代わりに並列ブロックを使用してください。
</Callout>
