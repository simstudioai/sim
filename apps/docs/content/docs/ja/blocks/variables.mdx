...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    <li>ワークフローでの初期化：`itemsProcessed = 0`、`lastResult = ""`</li>
    <li>ループがアイテムを反復処理</li>
...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    <li>ワークフローでの初期化：`retryCount = 0`</li>
    <li>APIブロックがリクエストを試行</li>
    <li>失敗した場合、変数がインクリメント：`retryCount = <variable.retryCount> + 1`</li>
...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    ...
    <li>エージェントが`<variable.userTier>`を使用して応答をパーソナライズ</li>
