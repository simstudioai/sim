...
Запустите рабочий процесс с автоматической повторной попыткой при возникновении ошибок, связанных с ограничением скорости, используя экспоненциальное уменьшение задержки.
...
Выполняйте рабочие процессы асинхронно для задач, требующих длительного времени выполнения:
