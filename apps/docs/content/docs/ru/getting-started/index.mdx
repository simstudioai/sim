---
title: Начало работы
description: Создайте своего первого агента всего за 10 минут: исследователя, использующего инструменты веб-поиска и структурированный вывод данных.
pageType: guide
---
...
Создайте агента для сбора информации о людях за 10 минут. Он принимает имя через интерфейс чата, ищет в интернете с помощью инструментов поиска на основе ИИ и возвращает структурированный JSON с информацией о местоположении, профессии и образовании человека.
