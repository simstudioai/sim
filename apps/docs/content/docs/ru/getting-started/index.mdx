...
Создайте агента для сбора информации о людях всего за 10 минут. Он принимает имя через интерфейс чата, ищет информацию в интернете с помощью инструментов поиска на основе искусственного интеллекта и возвращает структурированный JSON с информацией о местоположении, профессии и образовании человека.
