---
title: Начало работы
description: Создайте своего первого агента всего за 10 минут – это будет исследователь, использующий инструменты для веб-поиска и выдающий структурированные результаты.
pageType: guide
---
...
Создайте агента для сбора информации о людях всего за 10 минут. Он принимает имя через интерфейс чата, ищет информацию в интернете с помощью инструментов поиска на основе искусственного интеллекта и возвращает структурированные данные в формате JSON, содержащие местоположение, профессию и образование человека.
