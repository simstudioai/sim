---
title: Greenhouse
description: Управление кандидатами, вакансиями и заявками в Greenhouse
---
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `per_page` | number | Нет | Number of results per page \(1-500, default 100\) |
| `page` | number | Нет | Page number for pagination |
| `created_after` | string | Нет | Return only candidates created at or after this ISO 8601 timestamp |
| `created_before` | string | Нет | Return only candidates created before this ISO 8601 timestamp |
| `updated_after` | string | Нет | Return only candidates updated at or after this ISO 8601 timestamp |
| `updated_before` | string | Нет | Return only candidates updated before this ISO 8601 timestamp |
| `job_id` | string | Нет | Filter to candidates who applied to this job ID \(excludes prospects\) |
| `email` | string | Нет | Filter to candidates with this email address |
| `candidate_ids` | string | Нет | Comma-separated candidate IDs to retrieve \(max 50\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `candidateId` | string | Да | The ID of the candidate to retrieve |
...
| `per_page` | number | Нет | Number of results per page \(1-500, default 100\) |
| `page` | number | Нет | Page number for pagination |
| `status` | string | Нет | Filter by job status \(open, closed, draft\) |
| `created_after` | string | Нет | Return only jobs created at or after this ISO 8601 timestamp |
| `created_before` | string | Нет | Return only jobs created before this ISO 8601 timestamp |
| `updated_after` | string | Нет | Return only jobs updated at or after this ISO 8601 timestamp |
| `updated_before` | string | Нет | Return only jobs updated before this ISO 8601 timestamp |
| `department_id` | string | Нет | Filter to jobs in this department ID |
| `office_id` | string | Нет | Filter to jobs in this office ID |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `jobId` | string | Да | The ID of the job to retrieve |
...
| `per_page` | number | Нет | Number of results per page \(1-500, default 100\) |
| `page` | number | Нет | Page number for pagination |
| `job_id` | string | Нет | Filter applications by job ID |
| `status` | string | Нет | Filter by status \(active, converted, hired, rejected\) |
| `created_after` | string | Нет | Return only applications created at or after this ISO 8601 timestamp |
| `created_before` | string | Нет | Return only applications created before this ISO 8601 timestamp |
| `last_activity_after` | string | Нет | Return only applications with activity at or after this ISO 8601 timestamp |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `applicationId` | string | Да | The ID of the application to retrieve |
...
| `per_page` | number | Нет | Number of results per page \(1-500, default 100\) |
| `page` | number | Нет | Page number for pagination |
| `created_after` | string | Нет | Return only users created at or after this ISO 8601 timestamp |
| `created_before` | string | Нет | Return only users created before this ISO 8601 timestamp |
| `updated_after` | string | Нет | Return only users updated at or after this ISO 8601 timestamp |
| `updated_before` | string | Нет | Return only users updated before this ISO 8601 timestamp |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `userId` | string | Да | The ID of the user to retrieve |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Greenhouse Harvest API key |
| `jobId` | string | Да | The job ID to list stages for |
| `per_page` | number | Нет | Number of results per page \(1-500, default 100\) |
| `page` | number | Нет | Page number for pagination |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `secretKey` | string | Нет | When set, requests must include a valid Signature header \(HMAC-SHA256\). If left empty, the endpoint does not verify signatures—only use on a private URL you fully control. |
