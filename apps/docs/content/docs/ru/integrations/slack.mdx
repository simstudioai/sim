---
title: Slack
description: Отправка, обновление и удаление сообщений, управление представлениями и модальными окнами, добавление или удаление реакций, управление холстами, получение информации о канале и статусе пользователя в Slack.
---
