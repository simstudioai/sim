...
description: Управление задачами, планами и бакетами в Microsoft Planner
---
...
| --------- | ---- | -------- | ----------- |
| `planId` | string | Нет | The ID of the plan to get tasks from, if not provided gets all user tasks \(e.g., "xqQg5FS2LkCe54tAMV_v2ZgADW2J"\) |
| `taskId` | string | Нет | The ID of the task to get \(e.g., "pbT5K2OVkkO1M7r5bfsJ6JgAGD5m"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `planId` | string | Да | The ID of the plan where the task will be created \(e.g., "xqQg5FS2LkCe54tAMV_v2ZgADW2J"\) |
| `title` | string | Да | The title of the task \(e.g., "Review quarterly report"\) |
| `description` | string | Нет | The description of the task |
| `dueDateTime` | string | Нет | The due date and time for the task in ISO 8601 format \(e.g., "2025-03-15T17:00:00Z"\) |
| `assigneeUserId` | string | Нет | The user ID to assign the task to \(e.g., "e82f74c3-4d8a-4b5c-9f1e-2a6b8c9d0e3f"\) |
| `bucketId` | string | Нет | The bucket ID to place the task in \(e.g., "hsOf2dhOJkC6Fey9VjDg1JgAC9Rq"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `taskId` | string | Да | The ID of the task to update \(e.g., "pbT5K2OVkkO1M7r5bfsJ6JgAGD5m"\) |
| `etag` | string | Да | The ETag value from the task to update \(If-Match header\) |
| `title` | string | Нет | The new title of the task \(e.g., "Review quarterly report"\) |
| `bucketId` | string | Нет | The bucket ID to move the task to \(e.g., "hsOf2dhOJkC6Fey9VjDg1JgAC9Rq"\) |
| `dueDateTime` | string | Нет | The due date and time for the task in ISO 8601 format \(e.g., "2025-03-15T17:00:00Z"\) |
| `startDateTime` | string | Нет | The start date and time for the task \(ISO 8601 format\) |
| `percentComplete` | number | Нет | The percentage of task completion \(0-100\) |
| `priority` | number | Нет | The priority of the task \(0-10\) |
| `assigneeUserId` | string | Нет | The user ID to assign the task to \(e.g., "e82f74c3-4d8a-4b5c-9f1e-2a6b8c9d0e3f"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `taskId` | string | Да | The ID of the task to delete \(e.g., "pbT5K2OVkkO1M7r5bfsJ6JgAGD5m"\) |
| `etag` | string | Да | The ETag value from the task to delete \(If-Match header\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `planId` | string | Да | The ID of the plan to retrieve \(e.g., "xqQg5FS2LkCe54tAMV_v2ZgADW2J"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `planId` | string | Да | The ID of the plan \(e.g., "xqQg5FS2LkCe54tAMV_v2ZgADW2J"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `bucketId` | string | Да | The ID of the bucket to retrieve \(e.g., "hsOf2dhOJkC6Fey9VjDg1JgAC9Rq"\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `planId` | string | Да | The ID of the plan where the bucket will be created \(e.g., "xqQg5FS2LkCe54tAMV_v2ZgADW2J"\) |
| `name` | string | Да | The name of the bucket |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `bucketId` | string | Да | The ID of the bucket to update \(e.g., "hsOf2dhOJkC6Fey9VjDg1JgAC9Rq"\) |
| `name` | string | Нет | The new name of the bucket |
| `etag` | string | Да | The ETag value from the bucket to update \(If-Match header\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `bucketId` | string | Да | The ID of the bucket to delete \(e.g., "hsOf2dhOJkC6Fey9VjDg1JgAC9Rq"\) |
| `etag` | string | Да | The ETag value from the bucket to delete \(If-Match header\) |
...
| Параметр | Тип | Обязательный | Описание |
| --------- | ---- | -------- | ----------- |
| `taskId` | string | Да | The ID of the task \(e.g., "pbT5K2OVkkO1M7r5bfsJ6JgAGD5m"\) |
...
| --------- | ---- | -------- | ----------- |
| `taskId` | string | Да | The ID of the task \(e.g., "pbT5K2OVkkO1M7r5bfsJ6JgAGD5m"\) |
| `etag` | string | Да | The ETag value from the task details to update \(If-Match header\) |
| `description` | string | Нет | The description of the task |
| `checklist` | object | Нет | Checklist items as a JSON object |
| `references` | object | Нет | References as a JSON object |
| `previewType` | string | Нет | Preview type: automatic, noPreview, checklist, description, or reference |
