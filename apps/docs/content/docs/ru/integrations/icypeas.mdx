...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Icypeas API key |
| `firstname` | string | Нет | Target person's first name |
| `lastname` | string | Нет | Target person's last name |
| `domainOrCompany` | string | Да | Target company domain \(e.g. stripe.com\) or company name \(e.g. Stripe\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Icypeas API key |
| `email` | string | Да | Email address to verify \(e.g. john@stripe.com\) |
