...
description: Перевод текста с помощью Google Cloud Translation
---
...
Перевод и определение языков с помощью Google Cloud Translation API. Supports auto-detection of the source language.
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Google Cloud API key with Cloud Translation API enabled |
| `text` | string | Да | The text to translate |
| `target` | string | Да | Target language code \(e.g., "es", "fr", "de", "ja"\) |
| `source` | string | Нет | Source language code. If omitted, the API will auto-detect the source language. |
| `format` | string | Нет | Format of the text: "text" for plain text, "html" for HTML content |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Google Cloud API key with Cloud Translation API enabled |
| `text` | string | Да | The text to detect the language of |
| `pricing` | custom | Нет | No description |
| `rateLimit` | string | Нет | No description |
