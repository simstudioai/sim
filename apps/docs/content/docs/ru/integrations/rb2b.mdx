---
title: RB2B
description: Идентификация и обогащение посетителей сайта
---
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
| `ip_address` | string | Да | The IP address to resolve \(IPv4 or IPv6\) |
| `user_agent` | string | Нет | Optional user agent string to improve match accuracy |
| `include_sha256` | boolean | Нет | Whether to include SHA-256 hashes in addition to MD5 hashes |
...
|   ↳ `device_type` | string | The identifier type (например, AAID, IDFA\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
| `email` | string | Да | A plaintext email address or an MD5 hash of the email |
...
| `work_email_confirmed` | string | Указывает,  work email is confirmed |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
| `email` | string | Да | The email address to look up |
...
| `credits_exhausted` | boolean | Указывает,  account is out of credits |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
| `linkedin_slug` | string | Да | The LinkedIn profile slug or URL |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | RB2B Ключ API |
| `first_name` | string | Да | The person’s first name |
| `last_name` | string | Да | The person’s last name |
| `company_domain` | string | Да | The company domain (например, example.com\) |
