---
title: Mailchimp
description: Управление аудиториями, кампаниями и автоматизацией маркетинга в Mailchimp
---
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `count` | string | Нет | Number of results to return \(default: 10, max: 1000\) |
| `offset` | string | Нет | Number of results to skip for pagination |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `audienceName` | string | Да | The name of the audience/list \(e.g., "Newsletter Subscribers"\) |
| `contact` | string | Да | JSON object of contact information \(e.g., \{"company": "Acme", "address1": "123 Main St", "city": "NYC", "state": "NY", "zip": "10001", "country": "US"\}\) |
| `permissionReminder` | string | Да | Permission reminder text shown to subscribers \(e.g., "You signed up for updates on our website"\) |
| `campaignDefaults` | string | Да | JSON object of default campaign settings \(e.g., \{"from_name": "Acme", "from_email": "news@acme.com", "subject": "", "language": "en"\}\) |
| `emailTypeOption` | string | Да | Support multiple email formats: "true" or "false" |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `audienceName` | string | Нет | The name of the audience/list \(e.g., "Newsletter Subscribers"\) |
| `permissionReminder` | string | Нет | Permission reminder text shown to subscribers \(e.g., "You signed up for updates on our website"\) |
| `campaignDefaults` | string | Нет | JSON object of default campaign settings \(e.g., \{"from_name": "Acme", "from_email": "news@acme.com"\}\) |
| `emailTypeOption` | string | Нет | Support multiple email formats: "true" or "false" |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list to delete \(e.g., "abc123def4"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `status` | string | Нет | Filter by status: "subscribed", "unsubscribed", "cleaned", or "pending" |
| `count` | string | Нет | Number of results to return \(default: 10, max: 1000\) |
| `offset` | string | Нет | Number of results to skip for pagination |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `subscriberEmail` | string | Да | Member email address or MD5 hash of the lowercase email |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `emailAddress` | string | Да | Member email address \(e.g., "user@example.com"\) |
| `status` | string | Да | Subscriber status: "subscribed", "unsubscribed", "cleaned", "pending", or "transactional" |
| `mergeFields` | string | Нет | JSON object of merge fields \(e.g., \{"FNAME": "John", "LNAME": "Doe"\}\) |
| `interests` | string | Нет | JSON object of interest IDs and their boolean values \(e.g., \{"abc123": true\}\) |
...
| `subscriberEmail` | string | Да | Member email address or MD5 hash of the lowercase email |
| `emailAddress` | string | Да | Member email address \(e.g., "user@example.com"\) |
| `statusIfNew` | string | Да | Subscriber status if new: "subscribed", "unsubscribed", "cleaned", "pending", or "transactional" |
| `mergeFields` | string | Нет | JSON object of merge fields \(e.g., \{"FNAME": "John", "LNAME": "Doe"\}\) |
| `interests` | string | Нет | JSON object of interest IDs and their boolean values \(e.g., \{"abc123": true\}\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `subscriberEmail` | string | Да | Member email address or MD5 hash of the lowercase email |
| `emailAddress` | string | Нет | New member email address \(e.g., "user@example.com"\) |
| `status` | string | Нет | Subscriber status: "subscribed", "unsubscribed", "cleaned", "pending", or "transactional" |
| `mergeFields` | string | Нет | JSON object of merge fields \(e.g., \{"FNAME": "John", "LNAME": "Doe"\}\) |
| `interests` | string | Нет | JSON object of interest IDs and their boolean values \(e.g., \{"abc123": true\}\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignType` | string | Нет | Filter by campaign type: "regular", "plaintext", "absplit", "rss", or "variate" |
| `status` | string | Нет | Filter by status: "save", "paused", "schedule", "sending", or "sent" |
| `count` | string | Нет | Number of results to return \(default: 10, max: 1000\) |
| `offset` | string | Нет | Number of results to skip for pagination |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignType` | string | Да | Campaign type: "regular", "plaintext", "absplit", "rss", or "variate" |
| `campaignSettings` | string | Да | JSON object of campaign settings \(e.g., \{"subject_line": "Newsletter", "from_name": "Acme", "reply_to": "news@acme.com"\}\) |
| `recipients` | string | Нет | JSON object of recipients \(e.g., \{"list_id": "abc123"\}\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign \(e.g., "abc123def4"\) |
| `campaignSettings` | string | Нет | JSON object of campaign settings \(e.g., \{"subject_line": "Newsletter", "from_name": "Acme"\}\) |
| `recipients` | string | Нет | JSON object of recipients \(e.g., \{"list_id": "abc123"\}\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign to delete \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign to send \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign to schedule \(e.g., "abc123def4"\) |
| `scheduleTime` | string | Да | Schedule time in ISO 8601 format \(e.g., "2024-12-25T10:00:00Z"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign to unschedule \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign to replicate \(e.g., "abc123def4"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `campaignId` | string | Да | The unique ID for the campaign \(e.g., "abc123def4"\) |
| `html` | string | Нет | The HTML content for the campaign |
| `plainText` | string | Нет | The plain-text content for the campaign |
| `templateId` | string | Нет | The unique ID of the template to use \(e.g., "12345"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `workflowId` | string | Да | The unique ID for the automation workflow \(e.g., "abc123def4"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `workflowId` | string | Да | The unique ID for the automation workflow \(e.g., "abc123def4"\) |
| `workflowEmailId` | string | Да | The unique ID for the workflow email \(e.g., "xyz789"\) |
| `emailAddress` | string | Да | Email address of the subscriber \(e.g., "user@example.com"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `templateId` | string | Да | The unique ID for the template \(e.g., "12345"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `templateName` | string | Да | The name of the template \(e.g., "Monthly Newsletter"\) |
| `templateHtml` | string | Да | The HTML content for the template |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `templateId` | string | Да | The unique ID for the template \(e.g., "12345"\) |
| `templateName` | string | Нет | The name of the template \(e.g., "Monthly Newsletter"\) |
| `templateHtml` | string | Нет | The HTML content for the template |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `templateId` | string | Да | The unique ID for the template to delete \(e.g., "12345"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `segmentId` | string | Да | The unique ID for the segment \(e.g., "12345"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `segmentName` | string | Да | The name of the segment \(e.g., "VIP Customers"\) |
| `segmentOptions` | string | Нет | JSON object of segment options for saved segments \(e.g., \{"match": "all", "conditions": \[...\]\}\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `segmentId` | string | Да | The unique ID for the segment \(e.g., "12345"\) |
| `segmentName` | string | Нет | The name of the segment \(e.g., "VIP Customers"\) |
| `segmentOptions` | string | Нет | JSON object of segment options \(e.g., \{"match": "all", "conditions": \[...\]\}\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `segmentId` | string | Да | The unique ID for the segment to delete \(e.g., "12345"\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `segmentId` | string | Да | The unique ID for the segment \(e.g., "12345"\) |
| `emailAddress` | string | Да | Email address of the member \(e.g., "user@example.com"\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `subscriberEmail` | string | Да | Member email address or MD5 hash of the lowercase email |
| `tags` | string | Да | JSON array of tag objects \(e.g., \[\{"name": "VIP", "status": "active"\}\]\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `subscriberEmail` | string | Да | Member email address or MD5 hash of the lowercase email |
| `tags` | string | Да | JSON array of tag objects with inactive status \(e.g., \[\{"name": "VIP", "status": "inactive"\}\]\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `mergeId` | string | Да | The unique ID for the merge field \(e.g., "1" or "FNAME"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `mergeName` | string | Да | The name of the merge field \(e.g., "First Name"\) |
| `mergeType` | string | Да | The type of the merge field: "text", "number", "address", "phone", "date", "url", "imageurl", "radio", "dropdown", "birthday", or "zip" |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `mergeId` | string | Да | The unique ID for the merge field \(e.g., "1" or "FNAME"\) |
| `mergeName` | string | Нет | The name of the merge field \(e.g., "First Name"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `mergeId` | string | Да | The unique ID for the merge field to delete \(e.g., "1" or "FNAME"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryTitle` | string | Да | The title of the interest category \(e.g., "Email Preferences"\) |
| `interestCategoryType` | string | Да | The type of interest category: "checkboxes", "dropdown", "radio", or "hidden" |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
| `interestCategoryTitle` | string | Нет | The title of the interest category \(e.g., "Email Preferences"\) |
...
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category to delete \(e.g., "xyz789"\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
| `interestId` | string | Да | The unique ID for the interest \(e.g., "def456"\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
| `interestName` | string | Да | The name of the interest \(e.g., "Weekly Updates"\) |
...
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
| `interestId` | string | Да | The unique ID for the interest \(e.g., "def456"\) |
| `interestName` | string | Нет | The name of the interest \(e.g., "Weekly Updates"\) |
...
| `listId` | string | Да | The unique ID for the audience/list \(e.g., "abc123def4"\) |
| `interestCategoryId` | string | Да | The unique ID for the interest category \(e.g., "xyz789"\) |
| `interestId` | string | Да | The unique ID for the interest to delete \(e.g., "def456"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `pageId` | string | Да | The unique ID for the landing page \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `landingPageType` | string | Да | The type of landing page: "signup" |
| `landingPageTitle` | string | Нет | The title of the landing page \(e.g., "Join Our Newsletter"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `pageId` | string | Да | The unique ID for the landing page to delete \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `batchId` | string | Да | The unique ID for the batch operation \(e.g., "abc123def4"\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `operations` | string | Да | JSON array of batch operations \(e.g., \[\{"method": "POST", "path": "/lists/\{list_id\}/members", "body": "..."\}\]\) |
...
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Да | Mailchimp API key with server prefix |
| `batchId` | string | Да | The unique ID for the batch operation to delete \(e.g., "abc123def4"\) |
