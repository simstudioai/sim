...
变量块在执行过程中更新工作流变量。变量必须首先在工作流的变量部分中初始化，然后您可以使用此块在工作流运行时更新其值。
...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    ...
    <li>循环遍历项目</li>
    <li>在循环内：代理处理当前项目</li>
    <li>在循环内：变量更新 `itemsProcessed = <variable.itemsProcessed> + 1`</li>
    <li>在循环内：变量更新 `lastResult = <agent.content>`</li>
