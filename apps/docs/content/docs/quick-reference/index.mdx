...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowSpan={2}><ActionImage src="/static/quick-reference/workspace-context-menu.png" alt="Workspace context menu" /></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowSpan={5}><ActionImage src="/static/quick-reference/workflow-context-menu.png" alt="Workflow context menu" /></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Left-drag on empty canvas (or Shift-drag in hand mode). `Mod`/`Shift` + click adds to the selection.</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Open the workflow test chat (the Chat overlay with the output dropdown), not the Chat tab in the panel.</td>
    ...
    <tr>
      ...
      <td>Open the terminal panel at the bottom (`Mod+L` opens the Logs page).</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Check status indicator (Live/Update/Deploy) in Deploy modal</td>
      <td><ActionImage src="/static/quick-reference/view-deployment.png" alt="View deployment status" /></td>
    </tr>
    <tr>
      <td>Revert deployment</td>
      <td>Access previous versions in Deploy modal → **Promote to live**</td>
    ...
    <tr>
      ...
      <td>Deploy modal → Click description icon → Add or generate description</td>
    ...
    <tr>
      ...
      <td>Deploy modal → **API** → Copy API cURL</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>⋯ menu → **Variables** → **Add Variable**, click to edit, or delete icon</td>
    ...
    <tr>
      ...
      <td>Use `<variable.name>` syntax in block inputs</td>
