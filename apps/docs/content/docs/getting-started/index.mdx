...
<Steps>
  ...
  <Step title="Test it">
    Open the **Chat panel**, select `agent.content` as the output to display, and send: *"John is a software engineer from San Francisco who studied Computer Science at Stanford University."*
