...
<ThemeImage
  lightSrc="/static/getting-started/started-1.png"
...
<Steps>
  <Step title="Create workflow and add AI agent">
    ...
    <div className="mx-auto w-full overflow-hidden rounded-lg">
      <Video src="getting-started/started-2.mp4" />
    </div>
  </Step>
  ...
  <Step title="Add tools to the agent">
    ...
    <div className="mx-auto w-3/5 overflow-hidden rounded-lg">
      <Video src="getting-started/started-3.mp4" />
    </div>
  </Step>
  ...
  <Step title="Test the basic workflow">
    ...
    <div className="mx-auto w-full overflow-hidden rounded-lg">
      <Video src="getting-started/started-4.mp4" />
    </div>
  </Step>
  ...
  <Step title="Add structured output">
    ...
    <div className="mx-auto w-full overflow-hidden rounded-lg">
      <Video src="getting-started/started-5.mp4" />
    </div>
  </Step>
  ...
  <Step title="Test the structured output">
    ...
    <div className="mx-auto w-full overflow-hidden rounded-lg">
      <Video src="getting-started/started-6.mp4" />
    </div>
  </Step>
</Steps>
