...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Sim uses the permission group governing the workflow's workspace. Disallowed blocks are filtered from the block picker. Generated workflows can still reference a restricted tool type; execution rejects it with an error naming the restriction."
  },
  {
