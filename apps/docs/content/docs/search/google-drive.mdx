...
Join the Sim organization, then open **Integrations** and select **Connect** for Google Drive. Use the Google account matching your verified Sim email. Its row shows your connection and indexing status.
...
<Image className="mx-auto h-auto w-full max-w-md" src="/static/search/google-drive-setup.png" alt="Google Drive setup with member and service-account methods, account selection, and folders" width={500} height={450} />
