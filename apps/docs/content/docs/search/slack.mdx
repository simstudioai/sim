...
<Image className="mx-auto h-auto w-full max-w-md" src="/static/search/slack-setup.jpg" alt="Sim Search in Slack setup asking for Client ID, Client Secret, and Signing Secret" width={615} height={410} />
