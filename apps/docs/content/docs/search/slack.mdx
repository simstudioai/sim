...
- Use **/sim-search [question]** to start a private DM thread. Channel invocations keep personalized answers and account details in DMs.
- Use **/sim-connect [provider]**, or **Home → Connect sources**, to open your personal Integrations in Sim. OAuth begins only after you click Connect there.
