...
<Image className="mx-auto h-auto w-full max-w-xl" src="/static/search/integration-provider.png" alt="Gmail connections with the Connect service account action" width={1037} height={264} />
