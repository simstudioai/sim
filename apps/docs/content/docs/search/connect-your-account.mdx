...
Return to Integrations when the connection completes, or use **Return to Search** on the connection page. If the popup was blocked or closed, allow popups and select **Connect account** again. While authorization is pending, use **Open again**.
