...
Each teammate completes this identity connection. Existing authorized accounts may already be connected. Its row shows your connection and indexing status.
...
After an admin configures Confluence, select **Integrations → Confluence → Connect**. Authorize your account; you do not choose its spaces again.

If Confluence is allowed but no source exists, select **Connect** beside Confluence. To add another site later, use **More → Add Confluence site**:
