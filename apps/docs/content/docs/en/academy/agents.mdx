...
<VideoChapters
  chapters={[
    { title: 'An agent is a workflow', time: '0:00' },
    { title: 'Inside the Agent block', time: '0:45' },
    { title: 'Tools and skills', time: '1:40' },
    { title: 'Make a workflow agentic', time: '2:30' },
    { title: 'Composing intelligence', time: '3:20' },
  ]}
/>
