...
<VideoChapters
  chapters={[
    { title: 'The shape of a table', time: '0:00' },
    { title: 'Operations over data', time: '0:50' },
    { title: 'Workflow columns at scale', time: '1:50' },
    { title: 'A surface for automation', time: '2:40' },
  ]}
/>
