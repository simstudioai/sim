...
<VideoChapters
  chapters={[
    ...
    { title: 'The table', time: '0:26' },
    { title: 'Rows and fields', time: '0:35' },
    { title: 'The workflow', time: '0:42' },
    { title: 'The read', time: '0:51' },
    { title: 'The write', time: '1:01' },
    { title: 'The record', time: '1:12' },
    { title: 'Queue and record', time: '1:21' },
  ]}
/>
