...
<VideoPlaceholder eyebrow="Tables" title="Workflow Columns" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy-preview/tables-workflow-columns-light-with-intro.mp4" className="mt-2" />
