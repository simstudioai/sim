...
<VideoPlaceholder eyebrow="Foundations" title="What is Sim?" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy-preview/01-intro.mp4" className="mt-2" />
