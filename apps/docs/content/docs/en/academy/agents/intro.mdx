...
<VideoChapters
  chapters={[
    ...
    { title: 'A rules workflow', time: '0:31' },
    { title: 'Swap in the agent', time: '0:41' },
    { title: 'The new chat', time: '0:49' },
    { title: 'Agents compose', time: '1:07' },
    { title: 'The machine', time: '1:16' },
    { title: 'It scales', time: '1:24' },
  ]}
/>
