...
<VideoChapters
  chapters={[
    ...
    { title: 'A working workflow', time: '0:23' },
    { title: 'Deploy', time: '0:36' },
    { title: 'A call from outside', time: '0:50' },
    { title: 'The chat surface', time: '1:08' },
    { title: 'Runs when they run it', time: '1:33' },
  ]}
/>
