...
<VideoChapters
  chapters={[
    { title: 'A working workflow', time: '0:00' },
    { title: 'Deploy gives it an address', time: '0:45' },
    { title: 'A call from outside', time: '1:30' },
    { title: 'The chat surface', time: '2:20' },
    { title: 'Runs when they run it', time: '3:10' },
  ]}
/>
