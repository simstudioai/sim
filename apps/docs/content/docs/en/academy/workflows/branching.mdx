...
<VideoChapters
  chapters={[
    { title: 'A fork in the flow', time: '0:00' },
    { title: 'The rule decides', time: '0:45' },
    { title: 'The other path', time: '1:25' },
    { title: 'The model decides', time: '2:10' },
    { title: 'Still one workflow', time: '3:05' },
  ]}
/>
