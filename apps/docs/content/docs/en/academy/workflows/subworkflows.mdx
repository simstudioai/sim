...
<VideoChapters
  chapters={[
    { title: 'The workflow you know', time: '0:00' },
    { title: 'It becomes a block', time: '0:40' },
    { title: 'The call begins', time: '1:20' },
    { title: 'Inside the call', time: '2:05' },
    { title: 'Back with the result', time: '2:55' },
  ]}
/>
