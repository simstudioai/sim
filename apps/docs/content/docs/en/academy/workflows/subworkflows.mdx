...
<VideoChapters
  chapters={[
    ...
    { title: 'The workflow you know', time: '0:22' },
    { title: 'It becomes a block', time: '0:30' },
    { title: 'The call begins', time: '0:41' },
    { title: 'Inside the call', time: '0:48' },
    { title: 'Back with the result', time: '1:02' },
    { title: 'Workflows all the way up', time: '1:12' },
  ]}
/>
