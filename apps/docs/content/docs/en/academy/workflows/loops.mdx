...
<VideoChapters
  chapters={[
    { title: 'A block that holds blocks', time: '0:00' },
    { title: 'What each run knows', time: '0:45' },
    { title: 'One at a time', time: '1:30' },
    { title: 'All at once', time: '2:20' },
    { title: 'Swapping the container', time: '3:10' },
  ]}
/>
