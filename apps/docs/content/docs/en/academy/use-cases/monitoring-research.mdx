...
import { WorkflowPreview, API_FETCH_WORKFLOW } from '@/components/workflow-preview'
...
Here's the shape of it — a scheduled trigger, an agent that fetches and researches, and a delivered result:
