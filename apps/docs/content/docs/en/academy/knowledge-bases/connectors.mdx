...
<VideoPlaceholder eyebrow="Knowledge Bases" title="Connectors" src="https://nnjgp7vypgx4myuq.public.blob.vercel-storage.com/academy-preview/kb-connectors-light-with-intro.mp4" className="mt-2" />
