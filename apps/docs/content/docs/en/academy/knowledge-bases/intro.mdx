...
<VideoChapters
  chapters={[
    { title: 'The context problem', time: '0:00' },
    { title: 'Inside a knowledge base', time: '0:40' },
    { title: 'Indexing and chunks', time: '1:20' },
    { title: 'Searching by meaning', time: '2:05' },
    { title: 'Grounding an answer', time: '2:55' },
  ]}
/>
