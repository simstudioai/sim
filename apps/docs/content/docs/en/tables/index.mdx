...
<TryInChat title="Try in Chat — creating" prompts={[
  "Create a leads table with columns for name, email, company, status, and created date",
  "Create a table that matches the structure of this CSV (attach the file)",
...
<TryInChat title="Try in Chat — querying" prompts={[
...
<TryInChat title="Try in Chat — updating" prompts={[
...
<TryInChat title="Try in Chat — exporting" prompts={[
