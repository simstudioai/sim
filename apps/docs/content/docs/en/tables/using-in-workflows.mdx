...
<OutputBundle
  ...
  blockColor="#10B981"
  values={[
    { key: 'rows', value: '[ { id, company, status }, … ]', highlight: true },
    { key: 'rowCount', value: '5' },
    { key: 'totalCount', value: '42' },
  ]}
  read="table1.rows"
/>
...
<Cards>
  <Card title="Table block reference" href="/tools/table" description="Every operation, field, and filter operator in full." />
