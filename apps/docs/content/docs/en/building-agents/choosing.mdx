...
{/* VISUAL: comparison grid. Rows: block / agent tool / custom tool / MCP / workflow-as-tool / skill. Columns: Who decides (path / agent) · Where it lives (workflow / workspace / external) · How you author it (drag-drop / code / protocol / instructions). */}
