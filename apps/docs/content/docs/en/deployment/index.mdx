...
Send an object in the request body matching the workflow's [Input Format](/triggers/start). The response is an object holding the [block outputs](/blocks) and execution metadata.
