...
- Format: `"blockName.attribute"` (e.g., `"agent1.content"`)
...
Streaming responses use Server-Sent Events (SSE) format, matching the industry standard used by OpenAI and Anthropic:
