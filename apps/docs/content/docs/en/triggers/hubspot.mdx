...
| ----- | ---- | -------- | ----------- |
| `clientId` | short-input | Yes | Found in your HubSpot app settings under Auth tab |
| `clientSecret` | short-input | Yes | Found in your HubSpot app settings under Auth tab |
| `appId` | short-input | Yes | Found in your HubSpot app settings. Used to identify your app. |
| `developerApiKey` | short-input | Yes | Used for making API calls to HubSpot. Found in your HubSpot app settings. |
...
| `appId` | short-input | Yes | Found in your HubSpot app settings. Used to identify your app. |
| `developerApiKey` | short-input | Yes | Used for making API calls to HubSpot. Found in your HubSpot app settings. |
| `propertyName` | short-input | No | Optional: Filter to only trigger when a specific property changes. Leave empty to trigger on any property change. |
