...
- **Model**: The model that scores grounding. Use a strong reasoning model; the default is `claude-sonnet-4-6`
...
- **Use strong models for hallucination detection**: a strong reasoning model gives more accurate confidence scores
