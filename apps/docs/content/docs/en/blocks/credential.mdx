...
import { BlockPreview, WorkflowPreview, CREDENTIAL_SHARE_WORKFLOW } from '@/components/workflow-preview'
...
Pick the credential at runtime — for example a production or staging account based on a workflow variable.
