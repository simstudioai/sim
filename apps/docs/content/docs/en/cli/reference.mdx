...
```bash
sim workflows operations apply <id> [options]
```
...
```bash
sim workflows state replace <id> [options]
```
...
```bash
sim workflows revert create <id> <version> [options]
```
