...
<FAQ items={[
  { question: "How long does this take?", answer: "About ten minutes, most of it waiting for step 11's scheduled run. Run the infrastructure checks first — they take seconds and catch the majority of failed installs before you open a browser."},
  { question: "Do I need to run all of this after every upgrade?", answer: "No. Steps 1, 3, 5, 6, and 11 cover the app, realtime, execution, storage, and background jobs. Run the full list after a restore or a significant infrastructure change."},
]} />
