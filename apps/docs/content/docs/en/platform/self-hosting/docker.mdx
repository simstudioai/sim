...
# Pin the release. app, realtime and migrations share a schema and move together.
# The cron service is version-independent and tracks latest.
SIM_VERSION=v0.7.44
