...
| `rerankerScore` | An optional relevance score, present only when [Cohere reranking](/tools/knowledge) is on. |
...
<Cards>
  ...
  <Card title="Knowledge block" href="/tools/knowledge" description="Every operation the block supports." />
</Cards>
