...
<TryInChat title="Try in Chat — adding documents" prompts={[
  "Add this PDF to the Product Docs knowledge base (attach the file)",
...
<TryInChat title="Try in Chat — managing" prompts={[
