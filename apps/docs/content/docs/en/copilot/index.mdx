...
**Available Models:**
- **Anthropic**: Claude Opus 4.6 (default), Claude Opus 4.5, Claude Sonnet 4.5, Claude Haiku 4.5
- **OpenAI**: GPT-5.4, GPT-5.2, GPT-5.1, GPT-5, GPT-4o, GPT-4.1, o3, o4-mini
- **Google**: Gemini 2.5 Pro, Gemini 2.5 Flash, Gemini 2.0 Flash
- **Other Providers**: Groq, Cerebras, DeepSeek, Mistral, xAI, Azure OpenAI, OpenRouter
