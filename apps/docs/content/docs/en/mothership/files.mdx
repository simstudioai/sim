...
Uploaded files appear in the Files panel in the sidebar and are accessible to all workflows in the workspace.
...
Mothership can run JavaScript and TypeScript in an isolated sandbox — useful for data processing, calculations, and transformations without building a workflow:
...
Results are returned directly in the chat. No file is created unless you ask for one.

## Downloading Files from URLs

Mothership can fetch a file from a URL and save it to your workspace:

- "Download the JSON at [URL] and save it as a workspace file"
- "Fetch the latest release artifact from [URL] and store it"
...
<FAQ items={[
  ...
  { question: "What languages can Mothership execute?", answer: "JavaScript and TypeScript. Code runs in an isolated sandbox — no file system or network access." },
