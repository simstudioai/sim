...
| `attachments` | json | No | JSON array of attachment objects with content \(base64\), filename, type, and disposition |
...
| `customFields` | json | No | JSON object of custom field key-value pairs |
