...
| `summary` | object | Query execution summary with timing and counters |
...
| --------- | ---- | ----------- |
| `message` | string | Operation status message |
| `summary` | object | Creation summary with counters for nodes and relationships created |
...
| --------- | ---- | ----------- |
| `message` | string | Operation status message |
| `summary` | object | Merge summary with counters for nodes/relationships created or matched |
...
| --------- | ---- | ----------- |
| `message` | string | Operation status message |
| `summary` | object | Update summary with counters for properties set |
...
| --------- | ---- | ----------- |
| `message` | string | Operation status message |
| `summary` | object | Delete summary with counters for nodes and relationships deleted |
...
| `records` | array | Array of records returned from the query |
| `recordCount` | number | Number of records returned |
| `summary` | object | Execution summary with timing and counters |
