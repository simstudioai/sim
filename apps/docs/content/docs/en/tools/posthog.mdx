...
| `projectId` | string | Yes | The PostHog project ID |
| `region` | string | No | PostHog cloud region: "us" or "eu" \(default: "us"\) |
| `name` | string | Yes | Name for the insight |
...
| `projectId` | string | Yes | The PostHog project ID |
| `region` | string | No | PostHog cloud region: "us" or "eu" \(default: "us"\) |
| `name` | string | Yes | Name for the cohort |
...
| `region` | string | Yes | PostHog cloud region: us or eu |
| `apiKey` | string | Yes | PostHog Personal API Key |
| `name` | string | Yes | Feature flag name |
...
List all early access features in a PostHog project
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `results` | array | List of early access features |

### `posthog_create_early_access_feature`

Create a new early access feature in PostHog
...
| `stage` | string | No | Feature stage \(e.g., alpha, beta, general-availability\) |
| `documentationUrl` | string | No | URL to feature documentation |
| `featureFlagId` | number | No | Associated feature flag ID |

#### Output

| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `feature` | object | Created early access feature |
...
| `offset` | number | No | Number of results to skip for pagination |
| `dateFrom` | string | No | Filter recordings from this date \(ISO 8601 format\) |
| `dateTo` | string | No | Filter recordings to this date \(ISO 8601 format\) |
| `personId` | string | No | Filter recordings by person ID |
| `events` | string | No | JSON array of event filters to apply |
| `properties` | string | No | JSON array of property filters to apply |
...
| `shortId` | string | No | Filter by playlist short ID |
...
| `projectId` | string | Yes | PostHog Project ID |
| `region` | string | No | PostHog cloud region: us or eu \(default: us\) |
| `name` | string | No | Playlist name \(optional, can be auto-generated from filters\) |
| `description` | string | No | Playlist description |
| `filters` | string | No | JSON string of filter configuration to automatically include recordings \(date ranges, events, properties, etc.\) |
| `derivedName` | string | No | Auto-generated name based on filters |

#### Output

| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `playlist` | object | Created playlist details |
