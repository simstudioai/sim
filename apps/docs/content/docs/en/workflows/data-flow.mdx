...
<OutputBundle
  ...
  blockColor="#6f3dfa"
  values={[
    { key: 'content', value: '"Billing · high urgency"', highlight: true },
    { key: 'model', value: '"gpt-4o"' },
    { key: 'tokens', value: '{ input, output, total }' },
  ]}
  read="classify.content"
/>
...
<Cards>
  ...
  <Card title="Blocks" href="/blocks" description="What each block outputs." />
