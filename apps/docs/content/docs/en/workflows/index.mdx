...
<Cards>
  ...
  <Card title="Blocks" href="/blocks" description="The full catalog of block types." />
  <Card title="Triggers" href="/triggers" description="Start a workflow from chat, webhooks, schedules, or an API." />
