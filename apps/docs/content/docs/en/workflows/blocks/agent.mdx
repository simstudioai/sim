...
| Anthropic | Not streamed — These model generations return thinking with omitted display by default. | `claude-fable-5`, `claude-sonnet-5`, `claude-opus-4-8`, `claude-opus-4-7` |
