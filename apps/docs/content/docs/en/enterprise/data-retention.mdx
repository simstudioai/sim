...
**Sim Cloud:** Enterprise plan. You must be a workspace admin.

**Self-hosted:** Set `NEXT_PUBLIC_DATA_RETENTION_ENABLED=true` in your environment. No plan requirement.
