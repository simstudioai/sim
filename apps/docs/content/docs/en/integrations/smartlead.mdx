...
| --------- | ---- | -------- | ----------- |
| `limit` | number | No | Rows to return \(default 100\) |
| `skip` | number | No | Rows to skip \(default 0\) |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `campaignId` | number | No | Only return activity for this campaign |
| `offset` | number | No | Pagination offset \(default 0\) |
...
| `campaignId` | number | No | Only return replies for this campaign |
| `offset` | number | No | Pagination offset \(default 0\) |
