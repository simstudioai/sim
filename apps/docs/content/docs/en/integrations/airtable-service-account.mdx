---
title: Airtable Service Accounts
...
<Steps>
  ...
  <Step>
    Search for "Airtable Service Account" and click it
  ...
  <Step>
    ...
    {/* TODO(screenshot): Add Airtable Service Account dialog with the personal access token filled in */}
  </Step>
  <Step>
    Click **Add Service Account**. Sim verifies the token by calling Airtable's `whoami` endpoint — if it fails, you'll see a specific error explaining what went wrong.
  </Step>
</Steps>
