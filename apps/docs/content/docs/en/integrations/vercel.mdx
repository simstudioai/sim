...
| `readyState` | string | Deployment ready state: BLOCKED, BUILDING, CANCELED, ERROR, INITIALIZING, QUEUED, or READY |
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `status` | string | Operation status reported by Vercel |
