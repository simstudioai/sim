...
| `tasks` | json | Change tasks belonging to a change request |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `searchText` | string | No | Text to match against the incident short description \(LIKE, case-sensitive\). |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `searchText` | string | No | Text to match against the change short description \(LIKE, case-sensitive\). |
...
| `name` | string | No | Text to match against the CI name \(LIKE, case-sensitive\). |
...
| `name` | string | No | Text to match against the display name \(LIKE, case-sensitive\). |
