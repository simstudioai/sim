...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Required to create the webhook subscription in Linq. |
| `phoneNumbers` | string | No | Comma-separated E.164 numbers to restrict which numbers deliver events. |
