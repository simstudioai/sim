...
| `maxCount` | number | No | Maximum number of results the job stores in transforming mode. Defaults to 10000. |
...
| `count` | number | No | Maximum number of result rows to return. Defaults to 100. 0 returns every available row. |
