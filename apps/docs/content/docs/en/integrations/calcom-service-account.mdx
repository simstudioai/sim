---
title: Cal.com Service Accounts
...
<Steps>
  ...
  <Step>
    Search for "Cal.com Service Account" and click it
  ...
  <Step>
    ...
    {/* TODO(screenshot): Add Cal.com Service Account dialog with the API key filled in */}
  </Step>
  <Step>
    Click **Add Service Account**. Sim verifies the key by calling Cal.com's `/v2/me` endpoint — if it fails, you'll see a specific error explaining what went wrong.
  </Step>
</Steps>
