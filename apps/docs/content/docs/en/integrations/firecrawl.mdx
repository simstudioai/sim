...
| `country` | string | No | Two-letter country code to search from \(Firecrawl default: "US"\) |
| `timeout` | number | No | Request timeout in milliseconds \(Firecrawl default: 60000\) |
