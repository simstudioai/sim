...
| `pretty` | string | Human-readable summary of the answers, as comma-separated "Question Label:Answer" pairs |
| `rawRequest` | json | Submitted answers keyed by question, in Jotform's q\{questionId\}_\{slugifiedLabel\} form. Values are strings, or objects for multi-part questions such as name and address. |
