...
Integra Airtable en el flujo de trabajo. Puede crear, obtener, listar o actualizar registros de Airtable. Se puede usar en modo de activación para iniciar un flujo de trabajo cuando se realiza una actualización en una tabla de Airtable.
