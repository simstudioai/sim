...
Integra Microsoft Teams en el flujo de trabajo. Puede leer y escribir mensajes de chat, y leer y escribir mensajes de canal. Se puede utilizar en modo de activación para iniciar un flujo de trabajo cuando se envía un mensaje a un chat o canal.
