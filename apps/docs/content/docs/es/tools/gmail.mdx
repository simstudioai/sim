...
Integra Gmail en el flujo de trabajo. Puede enviar, leer y buscar correos electrónicos. Se puede usar en modo de activación para iniciar un flujo de trabajo cuando se recibe un nuevo correo.
