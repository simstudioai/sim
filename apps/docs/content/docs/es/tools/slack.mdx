...
Integra Slack en el flujo de trabajo. Puede enviar mensajes, crear lienzos y leer mensajes. Requiere Token de Bot en lugar de OAuth en modo avanzado. Se puede usar en modo de activación para iniciar un flujo de trabajo cuando se envía un mensaje a un canal.
