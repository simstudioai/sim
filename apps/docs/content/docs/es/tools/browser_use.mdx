...
Integra el uso del navegador en el flujo de trabajo. Puede navegar por la web y realizar acciones como si un usuario real estuviera interactuando con el navegador.
