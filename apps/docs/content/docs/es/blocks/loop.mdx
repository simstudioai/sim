...
<Tabs items={['Configuration', 'Variables', 'Results']}>
  ...
  <Tab>
    ...
    <ul className="list-disc space-y-2 pl-6">
      <li>
        <strong>{"<loop.index>"}</strong>: número de iteración actual (basado en 0)
      </li>
      <li>
        <strong>{"<loop.currentItem>"}</strong>: elemento actual siendo procesado (solo forEach)
      </li>
      <li>
        <strong>{"<loop.items>"}</strong>: colección completa (solo forEach)
      </li>
    </ul>
  </Tab>
  <Tab>
    <ul className="list-disc space-y-2 pl-6">
      <li>
        <strong>{"<blockname.results>"}</strong>: array de todos los resultados de iteración (accedido mediante el nombre del bloque)
      </li>
      <li>
        <strong>Estructura</strong>: los resultados mantienen el orden de iteración
      </li>
      <li>
        <strong>Acceso</strong>: disponible en bloques después de que el bucle se complete
      </li>
    </ul>
  </Tab>
</Tabs>
