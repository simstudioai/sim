...
<Tabs items={['For Loop', 'ForEach Loop', 'While Loop', 'Do-While Loop']}>
  ...
  <Tab>
    **Bucle While (Basado en condición)** - Continúa ejecutándose mientras una condición se evalúe como verdadera:
    ...
    Úsalo cuando necesites hacer un bucle hasta que se cumpla una condición específica. La condición se verifica **antes** de cada iteración.
  ...
  <Tab>
    **Bucle Do-While (Basado en condición)** - Se ejecuta al menos una vez, luego continúa mientras una condición sea verdadera:
    ...
    Úsalo cuando necesites ejecutar al menos una vez, luego hacer un bucle hasta que se cumpla una condición. La condición se verifica **después** de cada iteración.
