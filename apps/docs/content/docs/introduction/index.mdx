---
title: Introduction
description: Build AI Agent workflows visually
---
...
Sim is a visual workflow builder for AI applications. Create powerful AI agents, automation workflows, and data processing pipelines by connecting blocks on a canvas—no coding required.
