...
Use [Vercel](https://vercel.com/) to manage deployments, projects, domains, DNS records, environment variables, aliases, and Edge Config from a workflow. Deployment, project, and domain events can trigger workflows.
{/* MANUAL-CONTENT-END */}
