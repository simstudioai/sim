...
Connecting Microsoft Word through OAuth requests these scopes.
...
| `Files.ReadWrite.All` | Read, create, and edit Word documents you have access to, including SharePoint libraries |
