...
Use [Asana](https://asana.com/) in Sim to manage tasks, projects, sections, comments, and followers. Workflows can create tasks, update their status or assignees, and read project and workspace data.
{/* MANUAL-CONTENT-END */}
