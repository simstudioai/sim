...
[Google Forms](https://www.google.com/forms/about/) collects structured responses. Use this integration to read and update forms, retrieve responses, and manage watches. Its triggers can start workflows when forms receive responses or change.
{/* MANUAL-CONTENT-END */}
