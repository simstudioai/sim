...
Use [Polymarket](https://polymarket.com) in Sim to retrieve prediction-market data: markets, events, orderbooks, prices, price history, positions, trades, and related statistics. These read operations support research, reporting, and monitoring workflows.
{/* MANUAL-CONTENT-END */}
