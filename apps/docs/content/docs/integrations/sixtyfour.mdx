...
Use [Sixtyfour AI](https://sixtyfour.ai/) in Sim to find email addresses and phone numbers and research people or companies. Enrichment actions return structured fields with source references and confidence scores; company research can include associated people and an organization chart.
{/* MANUAL-CONTENT-END */}
