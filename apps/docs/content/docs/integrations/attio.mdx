...
Use [Attio](https://www.attio.com/) in Sim to manage records for people, companies, and custom objects; work with lists, notes, tasks, and comments; and configure webhooks. Attio event triggers can start workflows when records or related resources change.
{/* MANUAL-CONTENT-END */}
