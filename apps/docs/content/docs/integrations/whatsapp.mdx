...
Use [WhatsApp](https://www.whatsapp.com/) Cloud API to send text, template, media, or interactive messages, react to messages, and manage media. Message webhooks can start workflows. See the messaging-window requirement below before choosing between a free-form message and a template.
{/* MANUAL-CONTENT-END */}
