...
Use [Pinecone](https://www.pinecone.io) in Sim to generate embeddings, store and update text records or vectors, search by text or vector, retrieve vectors, and manage indexes. Use the returned matches as input to later workflow steps.
{/* MANUAL-CONTENT-END */}
