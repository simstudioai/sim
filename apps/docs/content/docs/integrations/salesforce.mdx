...
Use [Salesforce](https://www.salesforce.com/) in Sim to manage accounts, contacts, leads, opportunities, cases, and tasks, run reports and SOQL queries, and create custom fields and objects through the Tooling API.
{/* MANUAL-CONTENT-END */}
