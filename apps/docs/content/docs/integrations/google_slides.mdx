...
Use [Google Slides](https://slides.google.com) in Sim to build and update presentations from templates or workflow data. Copy a template, replace text and images, embed Sheets charts, style text and shapes, manage tables and layouts, apply batch updates, and export to PDF or PPTX.
{/* MANUAL-CONTENT-END */}
