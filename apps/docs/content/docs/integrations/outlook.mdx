...
Use [Microsoft Outlook](https://outlook.office365.com) in Sim to send and draft emails, read and organize messages, manage attachments and folders, and create or update calendar events. Switch to trigger mode to start a workflow when a new email arrives.
{/* MANUAL-CONTENT-END */}
