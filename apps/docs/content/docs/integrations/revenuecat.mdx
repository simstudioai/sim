...
Use [RevenueCat](https://www.revenuecat.com/) in Sim to retrieve subscriber data, manage entitlements and offerings, record purchases, update subscriber attributes, and manage Google Play subscription billing.
{/* MANUAL-CONTENT-END */}
