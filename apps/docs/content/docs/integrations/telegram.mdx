...
## Start workflows from Telegram messages

This video shows webhook setup and triggering a workflow from an incoming Telegram message.

<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/9oKcJtQ0_IM"
  title="Start a Sim workflow from a Telegram message"
  loading="lazy"
  frameBorder="0"
...
## Send messages to a Telegram group

This video shows the Telegram block configuration for sending workflow updates to a group.

<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/AG55LpUreGI"
  title="Send messages to a Telegram group from Sim"
  loading="lazy"
  frameBorder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
