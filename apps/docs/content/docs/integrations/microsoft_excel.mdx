...
Use [Microsoft Excel](https://www.microsoft.com/en-us/microsoft-365/excel) in Sim to read and write workbook data. Select a worksheet and range, such as `A1:D10`, to target the cells an operation uses. Additional actions clear, format, and sort ranges, create tables, and delete worksheets.
{/* MANUAL-CONTENT-END */}
