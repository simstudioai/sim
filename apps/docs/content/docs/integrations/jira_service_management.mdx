...
Jira Service Management also accepts a credential you create yourself. Grant it the same access, since Sim can only request scopes on a connection it opens.
