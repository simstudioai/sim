...
Use [Jira Service Management](https://www.atlassian.com/software/jira/service-management) in Sim to manage service requests, customers, organizations, SLAs, and queues. The actions below document the supported service-desk operations and their required fields.
{/* MANUAL-CONTENT-END */}
