...
Use [Redis](https://redis.io/) in Sim through a direct connection to a Redis instance. Workflows can read and write keys, work with hashes and lists, increment values, set expiration times, and run commands.
{/* MANUAL-CONTENT-END */}
