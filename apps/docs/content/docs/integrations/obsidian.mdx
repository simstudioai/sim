...
[Obsidian](https://obsidian.md/) stores notes as Markdown files in a vault. Use this integration to read, create, update, and search notes, work with periodic notes, and run Obsidian commands.
