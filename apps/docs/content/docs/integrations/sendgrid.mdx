...
Use [SendGrid](https://sendgrid.com) in Sim to send transactional emails, work with dynamic templates and attachments, and manage marketing contacts and lists. The action reference also covers template and suppression-group operations.
{/* MANUAL-CONTENT-END */}
