...
Use [Neo4j](https://neo4j.com) in Sim to query graph data with Cypher and create, merge, update, or delete nodes and relationships. Pass query results to later workflow steps for processing or storage.
{/* MANUAL-CONTENT-END */}
