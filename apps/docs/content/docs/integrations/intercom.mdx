...
Use [Intercom](https://www.intercom.com/) in Sim to manage contacts and companies, read and reply to conversations, create and retrieve tickets, and send messages. Connect these operations to support triage, follow-up, and CRM synchronization workflows.
{/* MANUAL-CONTENT-END */}
