...
Use [Microsoft Planner](https://www.microsoft.com/en-us/microsoft-365/planner) to manage tasks, plans, and buckets. Task details include checklists and references; use the actions below to read or update them.
{/* MANUAL-CONTENT-END */}
