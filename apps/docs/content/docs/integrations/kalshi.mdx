...
Use [Kalshi](https://kalshi.com) in Sim to retrieve market and event data, inspect account balances and positions, read orders and trades, and place, cancel, or amend orders. The reference also covers orderbooks, candlesticks, fills, series, and exchange status.
{/* MANUAL-CONTENT-END */}
