...
<FAQ items={[
  ...
  { question: "Does this work with Atlassian Data Center / on-prem?", answer: "No. This credential supports Atlassian Cloud through api.atlassian.com. It cannot connect to an Atlassian Data Center host." },
]} />
