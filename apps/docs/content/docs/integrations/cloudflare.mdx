...
Use [Cloudflare](https://cloudflare.com/) in Sim to manage zones, DNS records, cache, zone settings, WAF rules, rate limits, and Cloudflare Access. The actions also list SSL/TLS certificates and inspect R2 buckets, Workers, and Tunnels.
{/* MANUAL-CONTENT-END */}
