...
Use [DuckDuckGo](https://duckduckgo.com/)'s Instant Answers API to retrieve answers, abstracts, and related topics for a query. No API key is required. Optional controls remove HTML or skip disambiguation results.
{/* MANUAL-CONTENT-END */}
