...
Use [incident.io](https://incident.io) in Sim to create and manage incidents, actions, follow-ups, workflows, schedules, escalations, and custom fields. The action reference below documents each operation and its inputs and outputs.
{/* MANUAL-CONTENT-END */}
