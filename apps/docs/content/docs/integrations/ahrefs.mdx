...
Use [Ahrefs](https://ahrefs.com/) in Sim to retrieve domain and backlink metrics, organic keywords, top pages, and ranking data for SEO research and reports. The integration requires an Ahrefs Enterprise subscription with API access.
{/* MANUAL-CONTENT-END */}
