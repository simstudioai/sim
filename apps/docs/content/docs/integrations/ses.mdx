...
Use [Amazon SES](https://aws.amazon.com/ses/) to send simple, templated, or bulk emails and manage templates, identities, configuration sets, and suppression lists. Account and identity actions report sending configuration and quotas.
{/* MANUAL-CONTENT-END */}
