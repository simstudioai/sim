...
Use [Mailchimp](https://mailchimp.com/) in Sim to manage audiences and members, campaigns, automations, templates, segments, tags, and reports. The actions below also cover merge fields, interest categories, landing pages, signup forms, and batch operations.
{/* MANUAL-CONTENT-END */}
