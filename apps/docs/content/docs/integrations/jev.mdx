...
| `state` | string | Yes | Content to evaluate: a text string, JSON object, or array. |
| `instructions` | string | Yes | The question to evaluate, as text, a JSON object, or an array. |
...
| `state` | string | Yes | Content to evaluate: a text string, JSON object, or array. |
| `instructions` | string | Yes | The question to evaluate, as text, a JSON object, or an array. |
| `criteria` | array | Yes | Ordered array of 2–10 rubric descriptions, from lowest to highest score. |
