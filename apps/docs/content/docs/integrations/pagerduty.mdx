...
Use [PagerDuty](https://www.pagerduty.com/) to manage incidents, add investigation notes, and find services, escalation policies, and on-call responders. The REST API uses API-key authentication; Send Event uses Events API v2.
{/* MANUAL-CONTENT-END */}
