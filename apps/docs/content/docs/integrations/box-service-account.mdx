...
Connect a Box Platform app using **Client Credentials Grant**. A Box admin authorizes the app, and Sim uses its Client ID, client secret, and Enterprise ID to obtain access tokens for the app's Service Account.
