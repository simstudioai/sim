...
Connect Zoom with a **Server-to-Server OAuth app**. Activate the app, grant the scopes your workflows need, and add its Account ID, Client ID, and client secret to Sim.
...
## Adding the Server-to-Server App to Sim
...
Add a Zoom block to your workflow. In the credential dropdown, select the saved Zoom server-to-server app. Select it and configure the block as you normally would.
