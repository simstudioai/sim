...
Use [Shopify](https://www.shopify.com/) to manage products, orders, customers, inventory, and fulfillments. The reference below covers location and collection lookups as well as store mutations.
{/* MANUAL-CONTENT-END */}
