...
For focused document and task workflows, use the [Slack Canvas](/integrations/slack_canvas) and [Slack Lists](/integrations/slack_lists) blocks. Canvas operations remain available here with their existing IDs.
