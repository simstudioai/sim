...
description: "Understanding team roles and what access each permission level provides"
icon: "Shield"
---
...
When you invite team members to your organization or workspace, you'll need to choose what level of access to give them. This guide explains what each permission level allows users to do.

## How to Invite Someone to a Workspace

<Video src="invitations.mp4" />
...
### Adding a Technical Lead
1. **Organization level**: Consider making them an **Organization Admin** if they need to manage billing or create workspaces
2. **Workspace level**: Give them **Admin** permission for full workspace management
