...
<BlockInfoCard 
  ...
  color="#000000"
  icon={true}
  iconSvg={`<svg className="block-icon"  fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
	   viewBox="0 0 98.05 98.05" xmlSpace="preserve"
	>
<g>
...
Access Wikipedia articles, search for pages, get summaries, retrieve full content, and discover random articles from the world\
