...
[Hugging Face](https://huggingface.co/) is the leading platform for open-source AI models, providing access to thousands of state-of-the-art machine learning models. This integration allows you to use Hugging Face's Inference API to generate chat completions and content using various AI providers and models.

## Key Features

- **12 Inference Providers** - Access models through Novita, Cerebras, Cohere, Together, and 8 other providers

## Getting Started

1. Get your API key from [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens)
2. Choose a provider (e.g., "novita", "cerebras", "together")
3. Specify a model that's available for your provider
4. Add your prompts and generate content

💡 **Tip**: Different providers offer different models. Make sure the model you specify is supported by your selected provider.
