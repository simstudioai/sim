...
The knowledgebase allows you to upload documents of various types, which are automatically processed, embedded, and made searchable through vector search. Your documents are intelligently chunked, and you can view, edit, and search through them using natural language queries.
...
### Processing Methods
1. **Azure Mistral OCR**: Premium OCR with highest accuracy
2. **Mistral OCR**: Standard AI-powered text extraction
3. **Standard PDF Parser**: Fast processing for text-based PDFs

## Using Knowledge in Workflows

Once your documents are processed, you can use them in your AI workflows through the Knowledge block. This allows your agents to access and reason over your document content.
...
Sim uses advanced vector search technology to understand the meaning and context of your content:
