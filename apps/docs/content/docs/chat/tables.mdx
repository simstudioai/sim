...
<FAQ items={[
  ...
  { question: "Is there a row limit?", answer: "Row limits depend on the workspace plan and deployment configuration. Use pagination for large reads; see Tables for storage and query limits." },
]} />
