...
<FAQ items={[
  ...
  { question: "What happens to a workflow's deployment when I delete it?", answer: "Deleting a workflow removes it from the active workspace and disables its deployments. Any API endpoints, chat URLs, or MCP tools that pointed to that workflow will stop working." },
]} />
