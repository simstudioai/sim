...
<FAQ items={[
  ...
  { question: "What can Sim calculate or process?", answer: "Sim can run code to parse JSON, calculate values, transform strings, deduplicate records, and convert supported formats. Results come back in the chat." },
]} />
