...
<FAQ items={[
  { question: "Does Sim have access to real-time information?", answer: "Sim can search current web sources. Check the cited source and its publication date when freshness matters." },
  { question: "Can Sim read pages that require login?", answer: "Hosted web research reads publicly accessible pages. In Sim Desktop, the built-in browser can also use websites you sign in to." },
]} />
