...
Connectors are usually configured in the knowledge base settings. Sim can also create, update, and sync them for you. Content becomes searchable after syncing and indexing, subject to the caller's access permissions.
...
<FAQ items={[
  { question: "How do I attach a knowledge base to a workflow?", answer: "Add a Knowledge search tool to the Agent block and select the knowledge base in that tool, or use a Knowledge block before the Agent and reference its results. You can also ask Chat to configure this for you." },
