...
<Steps>
  ...
  <Step>
    <strong>Ergebnisse ausgeben</strong>: Block produziert Ausgabedaten für die nächsten Blöcke im Workflow
  </Step>
</Steps>
...
- **Verzweigende Pfade**: Einige Blöcke können basierend auf Bedingungen zu verschiedenen Pfaden leiten
...
**Integrations-Blöcke** (API, Antwort):
...
<Cards>
  ...
  <Card title="Variablen-Block" href="/blocks/variables">
    Workflow-bezogene Variablen festlegen und verwalten
  </Card>
