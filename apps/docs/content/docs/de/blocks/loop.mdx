...
<Callout type="warning">
  ...
  - Sie können keinen Schleifenblock in einen anderen Schleifenblock platzieren
  - Sie können keinen Parallelblock in einen Schleifenblock platzieren
...
<Tabs items={['Configuration', 'Variables', 'Results']}>
  <Tab>
    <ul className="list-disc space-y-2 pl-6">
      ...
      <li>
        <strong>Sammlung</strong>: Array oder Objekt zum Durchlaufen (forEach-Schleifen)
      </li>
      <li>
