...
Outlook in den Workflow integrieren. Kann E-Mail-Nachrichten lesen, entwerfen und senden. Kann im Auslösemodus verwendet werden, um einen Workflow auszulösen, wenn eine neue E-Mail empfangen wird.
