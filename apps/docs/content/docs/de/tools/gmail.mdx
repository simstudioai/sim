...
Gmail in den Workflow integrieren. Kann E-Mails senden, lesen und durchsuchen. Kann im Auslösemodus verwendet werden, um einen Workflow zu starten, wenn eine neue E-Mail empfangen wird.
