...
Integration von Notion in den Arbeitsablauf. Kann Seiten lesen, Datenbanken lesen, Seiten erstellen, Datenbanken erstellen, Inhalte hinzufügen, Datenbanken abfragen und den Workspace durchsuchen.
