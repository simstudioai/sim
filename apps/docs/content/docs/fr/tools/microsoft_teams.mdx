...
Intégrer Microsoft Teams dans le flux de travail. Peut lire et écrire des messages de chat, ainsi que lire et écrire des messages de canal. Peut être utilisé en mode déclencheur pour lancer un flux de travail lorsqu'un message est envoyé à un chat ou à un canal.
