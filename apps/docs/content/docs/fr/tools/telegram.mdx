---
title: Telegram
description: Interagir avec Telegram
---
...
Intégrez Telegram dans le flux de travail. Peut envoyer et supprimer des messages. Peut être utilisé en mode déclencheur pour lancer un flux de travail lorsqu'un message est envoyé à un chat.
...
Supprimez des messages dans les canaux ou chats Telegram via l'API Bot Telegram. Nécessite l'ID du message à supprimer.
...
| `botToken` | chaîne | Oui | Votre jeton d'API Bot Telegram |
| `chatId` | chaîne | Oui | ID du chat Telegram cible |
| `photo` | chaîne | Oui | Photo à envoyer. Indiquez un file_id ou une URL HTTP |
...
| --------- | ---- | ----------- |
| `message` | chaîne | Message de succès ou d'erreur |
| `data` | objet | Données du message Telegram incluant les médias facultatifs |
...
| --------- | ---- | ----------- |
| `message` | chaîne | Message de succès ou d'erreur |
| `data` | objet | Données du message Telegram incluant les informations vocales/audio |

### `telegram_send_animation`

Envoyez des animations (GIFs) aux canaux ou utilisateurs Telegram via l'API Bot Telegram.
