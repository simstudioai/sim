...
Intégrez Gmail dans le flux de travail. Peut envoyer, lire et rechercher des e-mails. Peut être utilisé en mode déclencheur pour lancer un flux de travail lorsqu'un nouvel e-mail est reçu.
