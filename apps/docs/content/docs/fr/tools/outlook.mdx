...
Intégrez Outlook dans le flux de travail. Peut lire, rédiger et envoyer des messages électroniques. Peut être utilisé en mode déclencheur pour lancer un flux de travail lorsqu'un nouvel e-mail est reçu.
