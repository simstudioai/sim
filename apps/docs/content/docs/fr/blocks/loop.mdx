...
<Tabs items={['Configuration', 'Variables', 'Résultats']}>
  ...
  <Tab>
    ...
    <ul className="list-disc space-y-2 pl-6">
      ...
      <li>
        <strong>{"<loop.currentItem>"}</strong> : élément actuel en cours de traitement (forEach uniquement)
      </li>
      <li>
        <strong>{"<loop.items>"}</strong> : collection complète (forEach uniquement)
      </li>
    </ul>
  </Tab>
  <Tab>
    <ul className="list-disc space-y-2 pl-6">
      <li>
        <strong>{"<blockname.results>"}</strong> : tableau de tous les résultats d'itération (accessible via le nom du bloc)
      </li>
      <li>
        <strong>Structure</strong> : les résultats conservent l'ordre d'itération
      </li>
      <li>
        <strong>Accès</strong> : disponible dans les blocs après la fin de la boucle
      </li>
    </ul>
  </Tab>
</Tabs>
