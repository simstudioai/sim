...
Le bloc Guardrails valide et protège vos flux de travail IA en vérifiant le contenu selon plusieurs types de validation. Assurez la qualité des données, prévenez les hallucinations, détectez les informations personnelles identifiables (PII) et imposez des exigences de format avant que le contenu ne progresse dans votre flux de travail.
...
<div className="mb-4 rounded-md border p-4">
  <h4 className="font-medium">Scénario : valider les réponses du service client</h4>
  <ol className="list-decimal pl-5 text-sm">
