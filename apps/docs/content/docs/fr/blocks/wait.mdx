...
- **Gardez des temps d'attente raisonnables** : utilisez l'attente pour des délais jusqu'à 10 minutes. Pour des délais plus longs, envisagez des workflows programmés
