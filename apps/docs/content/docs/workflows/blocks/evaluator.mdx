...
<FAQ items={[
  ...
  { question: "Does the Evaluator use structured output?", answer: "Yes. It builds a JSON Schema from your metrics and requests strict structured output for the metric scores." },
