---
name: "source-command-validate-integration"
description: "Validate an existing Sim integration (tools, block, registry) against the service's API docs"
---

# source-command-validate-integration

Use this skill when the user asks to run the migrated source command `validate-integration`.
